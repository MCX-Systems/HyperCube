...
$(function () {
    ...
    List.prototype = {
        ...
        finishTitleEditing: function () {
            ...
            me.$title.html($input.val()).removeClass('collapse').removeAttr('data-old-title');
            if (me.isStateful()) {
        ...
        cancelTitleEditing: function () {
            ...
            me.$title.html(me.$title.attr('data-old-title')).removeClass('collapse');
            $input.remove();
            me.$header.removeClass('title-editing');
            return me;
        },
        ...
        editItem: function (id) {
            ...
            var $form = $item.closest('.lobilist').find('.lobilist-add-todo-form').removeClass('collapse');
            $item.closest('.lobilist').find('.lobilist-footer').addClass('collapse');
        ...
        _createForm: function () {
            var me = this;
            var $form = $('<form>', {
                'class': 'lobilist-add-todo-form collapse'
            });
            ...
            $('<button>', {
                'class': 'btn btn-dark btn-sm btn-add-todo btn-icon',
                html: '<i class="fas fa-check-circle"></i>'
            }).appendTo($ft);
            $('<button>', {
                type: 'button',
                'class': 'btn btn-light btn-sm btn-discard-todo btn-icon',
                html: '<i class="fas fa-times-circle"></i>'
            }).click(function () {
                $form.addClass('collapse');
                me.$footer.removeClass('collapse');
            }).appendTo($ft);
            $ft.appendTo($form);
        ...
        _createFinishTitleEditing: function () {
            ...
            var $btn = $('<button>', {
                ...
                html: '<i class="fas fa-ok-circle"></i>'
            });
            $btn.click(function () {
