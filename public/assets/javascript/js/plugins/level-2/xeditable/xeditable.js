...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
            ...
            var stdtypes = 'text,select,textarea,password,email,url,tel,number,range,time,typeahead'.split(',');
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-info editable-submit mt-1">'+
        '<i class="fas fa-check"></i>'+
      '</button>'+
      '<button type="button" class="btn btn-danger editable-cancel mt-1">'+
