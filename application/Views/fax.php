					...
					<section class="col-md-12">
						<div class="p-5">
							<div class="text-center">
								<h3 class="text-warning">Frequently Asked Questions</h3>
								<p class="text-muted">
								...
								<button type="button" class="btn btn-success mt-1">Email us your question</button>
								<button type="button" class="btn btn-primary mt-1">Send us a tweet</button>
							</div>
						</div>
					</section>

					<section class="col-md-1"></section>
					<section class="col-md-5 ml-3 p-2">
						<!-- Question/Answer -->
						<div class="ml-1">
