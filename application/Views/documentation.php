					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Version 1.1</span>
								<div class="header-elements">
									<ul class="icons-list">
										<li>
											<span class="text-muted">October 21, 2018</span>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="card-body">
								<p>
									First update is the most simplified and includes urgent
									bug fixes of core components, plugins and libraries. Also version 1.1 includes
									updates of some components to the latest stable versions. The only new thing here
									is RTL version of all 4 layouts, that support almost all available components
									and layout features. Below you can find general list of all changes and details
									about upgrading.
								</p>
