...
<!-- ============================================================== -->
<header id="top" class="fixed-top animated fadeInDown" data-step="1" data-intro="Ok, this is the main site header. Visible at all times.">
	<nav class="navbar navbar-expand">
		...
		<a href="#"
		   class="toggler text-left align-middle mr-4 d-none d-sm-none d-md-block d-lg-block d-xl-block" title="Toggle SideMenu">
...
<!-- ============================================================== -->
<aside id="left" class="sidebar animated fadeInLeft" data-step="2" data-intro="This is the left side, main menu section. Use it to navigate through examples.">
...
<!-- ============================================================== -->
<main id="main-wrapper" class="container-fluid" data-step="5" data-intro="This is the main content area. Used to show static, dynamic and ajax data.">
	<!-- ============================================================== -->
	<!-- Main Informer                                                  -->
	<!-- ============================================================== -->
	<article id="breadcrumb-bar">
		<nav class="row">
			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					<h4 class="float-left align-middle text-warning ml-3 mt-1" data-i18n="core:breadcrumb.welcome">Welcome</h4>
					<ul class="breadcrumb float-right align-middle">
						<li class="breadcrumb-item active"><i class="fas fa-home mr-2"></i>Home</li>
					</ul>
				</div>
				<!-- ============================================================== -->
		...
		<div class="main-scroller">
			<div class="row main-content-box">
				...
				<section class="col-md-12 text-center">
					<a href="#" onclick="startTour();" class="btn btn-lg btn-outline-info text-warning text-center mb-5">START SITE TOUR</a>
					<script type="text/javascript">
						function startTour()
						{
							var tour = introJs();
					...
					<div class="row bg-black mt-5">
						<div class="col-md-6 col-lg-6 p-4">
						    <p class="float-left">
							    <h3 class="display-5"><b class="text-warning">HyperCube - Web Template Project</b></h3>
							</p>
							<p class="lead">is a project of <b class="text-warning">MCX-Systems</b>,
							    showing what we can do with web based programming languages.
							</p>
							<hr />
							<p class="float-left">
								The content of this website is free to use for everyone. You can always check the site
								source, to see how it was build or ask for source code by means
								of a email message to <a href="mailto:webmaster@mcx-systems.net"><b class="text-warning">Developer</b></a>.<br />If
								you have any other questions about workings
								of the site you need to ask because it is work in progress and there is yet no documentation
								how to use it.<br /><br />
...
<!-- ============================================================== -->
<aside id="right" class="d-none d-sm-none d-md-block d-lg-block d-xl-block animated fadeInRight" data-step="3" data-intro="This is the right side. Containing news, chat, weather, FM-radio and settings.">
...
<!-- ============================================================== -->
<footer id="bottom" class="fixed-bottom animated fadeInUp" data-step="4" data-intro="This is the site footer, containing developer data and language preference.">
