			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Web Sockets Tester</h4>
								...
								<div class="form-inline mb-3">
									<div class="form-group">
										...
										<div class="controls">
											<input id="serverInput" type="text" class="form-control mx-sm-3" value="wss://echo.websocket.org" />
										</div>
									</div>

									<button id="connectButton" class="btn btn-rounded btn-primary mr-2">Connect</button>
									<button id="disconnectButton" class="btn btn-rounded btn-danger mr-2" disabled>Disconnect</button>

									<div class="form-group mr-2">
										<label for="textInput">Send text:</label>
										<div id="sendText" class="controls">
											<input id="textInput" class="form-control mx-sm-3" type="text" />
										</div>
									</div>

									<button id="sendButton" class="btn btn-rounded btn-primary mr-2" disabled>Send</button>
								</div>
