			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo base_url() ?>automation/">Automation</a>
						</li>
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">DinoHome Data Viewer</h4>
						...
						<div class="row">
							<div class="col-md-2 mb-3">
								<select id="Addr0" title="" class="select2"></select>
							</div>

							<div class="col-md-2">
								<select id="Addr1" title="" class="select2"></select>
							</div>

							<div class="col-md-2">
								<select id="Addr2" title="" class="select2"></select>
							</div>

							<div class="col-md-2">
								<select id="Addr3" title="" class="select2"></select>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-2 mb-3">
								<div class="form-group">
									<h5 id="Port Num">Port</h5>
									<div class="controls">
										<input id="port" type="number" name="port" class="form-control" required value="8089" title="" />
									</div>
								</div>
							</div>
						</div>

						<button type="button" id="startData" class="btn ripple-click-effect btn-primary">Click here to start getting data</button>
						<button type="button" id="stopData" class="btn ripple-click-effect btn-danger">Click here to stop</button>
						<button type="button" id="sendCommand1" class="btn ripple-click-effect btn-danger">Send a command 1</button>
						<button type="button" id="sendCommand2" class="btn ripple-click-effect btn-danger">Send a command 2</button>
						<button type="button" id="sendCommand3" class="btn ripple-click-effect btn-danger">Send a command 3</button>

						<div class="table-responsive mt-3 mb-3">
							<table class="table table-dark table-bordered table-hover">
								<thead>
								<tr>
									<th scope="col">Data and Ports</th>
									<th scope="col">Reading</th>
								</tr>
								</thead>
								<tbody>
								<tr>
									<th scope="row">DinoHome:</th>
									<td><div id="dinoHomeVersion"></td>
								</tr>
								<tr>
									<th scope="row">Status:</th>
									<td><div id="dinoHomeStatus"></td>
								</tr>
								<tr>
									<th scope="row">Control:</th>
									<td><div id="dinoHomeControl"></td>
								</tr>
								<tr>
									<th scope="row">Network:</th>
									<td><div id="dinoHomeNetwork"></td>
								</tr>
								<tr>
									<th scope="row">Main Relay:</th>
									<td><div id="dinoHomeRelay"></td>
								</tr>
								<tr>
									<th scope="row">A0:</th>
									<td><div class="arduino_bars" id="Analog0"></div><div class="arduino_bars" id="A0">0</div></td>
								</tr>
								<tr>
									<th scope="row">A1:</th>
									<td><div class="arduino_bars" id="Analog1"></div><div class="arduino_bars" id="A1">0</div></td>
								</tr>
								<tr>
									<th scope="row">A2:</th>
									<td><div class="arduino_bars" id="Analog2"></div><div class="arduino_bars" id="A2">0</div></td>
								</tr>
								<tr>
									<th scope="row">A3:</th>
									<td><div class="arduino_bars" id="Analog3"></div><div class="arduino_bars" id="A3">0</div></td>
								</tr>
								<tr>
									<th scope="row">A4</th>
									<td><div class="arduino_bars" id="Analog4"></div><div class="arduino_bars" id="A4">0</div></td>
								</tr>
								<tr>
									<th scope="row">A5:</th>
									<td><div class="arduino_bars" id="Analog5"></div><div class="arduino_bars" id="A5">0</div></td>
								</tr>
								</tbody>
							</table>
						</div>
					...
					<script type="text/javascript">
						...
						$(document).ready(function()
						{
							...
							$("#startData").click(function()
							{
								...
								timeOut = setInterval('getMyData()', 1000); //this will request data again in 1 second.
							});
							...
							$("#sendCommand1").click(function()
							{
								sendData('FlipSwitch', '1');
							});

							$("#sendCommand2").click(function()
							{
								sendData('FlipSwitch', '2');
							});

							$("#sendCommand3").click(function()
							{
								sendData('FlipSwitch', '3');
							});
						});


						function sendData(data, commandData)
						{
							...
							var dinoHomeUrl = 'http://' + x0 + "." + x1 + "." + x2 + "." + x3 + ":" + x4 + "/";

							var myData;
							myData = $.ajax({
								url: dinoHomeUrl, // eg.  http://192.168.255.22:8089/
								data: {tag: data, command: commandData},
							...
							myData = $.ajax({
								...
								success: function (data)
								{
									...
									$.each(data, function (index, element)
									{
										...
										{
											$('#dinoHomeVersion').html("<span>" + element.value + "</span>");
										}
										else if(element.key === "status")
										{
											$('#dinoHomeStatus').html("<span>" + element.value + "</span>");
										}
										else if(element.key === "control")
										{
											$('#dinoHomeControl').html("<span>" + element.value + "</span>");
										}
										else if(element.key === "network")
										{
											$('#dinoHomeNetwork').html("<span>" + element.value + "</span>");
										}
										else if(element.key === "relay")
										{
											$('#dinoHomeRelay').html("<span>" + element.value + "</span>");
										}
