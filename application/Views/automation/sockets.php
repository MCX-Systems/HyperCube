			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Sockets</li>
					</ul>
				</div>
				<!-- ============================================================== -->
				...
				<div class="row">
					...
					<section class="col-md-12">
						<div class="container theme-showcase" role="main">
							<div class="spinner-feeds" style="text-align: center; margin-top: 200px;"><i class="fas fa-spinner fa-spin fa-3x"></i></div>
					...
					<script>
						...
						else
						{
							...
							var chatpage=socket.of('automation/sockets')
