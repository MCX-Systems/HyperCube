			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Round Slider Plugin examples</h4>
					...
					<section class="col-md-4">
						<div class="roundSlider"></div>
					</section>

					<section class="col-md-4">
						<div class="roundRangeSlider"></div>
					</section>

					<section class="col-md-4">
						<div class="roundSlider1"></div>
					</section>
