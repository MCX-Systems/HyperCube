			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">LetterFX Animations</li>
					</ul>
				</div>
				<!-- ============================================================== -->
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<!-- <div class="btn-group"> -->
								<button class="btn btn-info" data-letterfx="custom[0]">1</button>
								<button class="btn btn-info" data-letterfx="custom[1]">2</button>
								<button class="btn btn-info" data-letterfx="custom[2]">3</button>
								<button class="btn btn-info" data-letterfx="custom[3]">4</button>
								<button class="btn btn-info" data-letterfx="custom[4]">5</button>
								<button class="btn btn-info" data-letterfx="custom[5]">6</button>
								<button class="btn btn-info" data-letterfx="custom[6]">7</button>
								<!-- </div> -->
							</div>
						</div>
