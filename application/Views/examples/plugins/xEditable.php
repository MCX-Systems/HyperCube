			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo base_url() ?>examples/blank">Plugins</a>
						</li>
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">xEditable Plugin examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> HyperCube
									<code>plugins and tools</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Editable inputs</span>
							</div>

							<div class="card-body">
								<h5>
									X-editable - library, that allows you to create editable elements on your page. It can be used with any engine
									(bootstrap, jquery-ui, jquery only) and includes both popup and inline modes. By default, x-editable supports 13
									input types, such as checkboxes, text fields, textareas, selects, dates etc. Also this library supports
									<code>Select2</code> and <code>Typeahead</code> integrations by default and some other examples with custom components built in.
								</h5>
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tr>
											...
											<td>
												<a class="editable editable-click" id="username" href="#" data-original-title="" data-title="Enter username" data-pk="1" data-type="text">Superuser</a>
											</td>
										</tr>
										<tr>
											<td>Empty text field, required</td>
											<td>
												<a class="editable editable-click" id="firstname" href="#" data-placement="right" data-original-title="" data-title="Enter your firstname" data-pk="1" data-type="text" data-placeholder="Required">Change It</a>
											</td>
										</tr>
										<tr>
											<td>Select, local array, custom display</td>
											<td>
												<a class="editable editable-click" id="sex" href="#" data-original-title="" data-title="Select sex" data-pk="1" data-type="select" data-value="">Not Selected</a>
											</td>
										</tr>
										<tr>
											<td>Select, remote array, no buttons</td>
											<td>
												<a class="editable editable-click" id="group" href="#" data-original-title="" data-title="Select group" data-pk="1" data-type="select" data-value="5" data-source="/groups">Admin</a>
											</td>
										</tr>
										<tr>
											<td>Select, error while loading</td>
											<td>
												<a class="editable editable-click" id="status" href="#" data-title="Select status" data-pk="1" data-type="select" data-value="0" data-source="/status">Active</a>
											</td>
										</tr>
										<tr>
											<td>Combodate (date)</td>
											<td>
												<a class="editable editable-click" id="dob" href="#" data-title="Select Date of birth" data-pk="1" data-type="combodate" data-value="1984-05-15" data-template="D / MMM / YYYY" data-viewformat="DD/MM/YYYY" data-format="YYYY-MM-DD">15/05/1984</a>
											</td>
										</tr>
										<tr>
											<td>Combodate (datetime)</td>
											<td>
												<a class="editable editable-click" id="event" href="#" data-title="Setup event date and time" data-pk="1" data-type="combodate" data-template="D MMM YYYY  HH:mm" data-viewformat="MMM D, YYYY, HH:mm" data-format="YYYY-MM-DD HH:mm">Empty</a>
											</td>
										</tr>
										<tr>
											<td>Textarea</td>
											<td>
												<a class="editable editable-pre-wrapped editable-click" id="comments" href="#" data-title="Enter comments" data-pk="1" data-type="textarea" data-placeholder="Your comments here...">Awesome user!</a>
											</td>
										</tr>
										<tr>
											<td>Twitter typeahead.js</td>
											<td>
												<a class="editable editable-click" id="state2" href="#" data-placement="right" data-title="Start typing State.." data-pk="1">California</a>
											</td>
										</tr>
										<tr>
											<td>Checklist</td>
											<td>
												<a class="editable editable-click" id="fruits" href="#" data-title="Select fruits" data-type="checklist" data-value="2,3">
													Peach
													<br />Apple
												</a>
											</td>
										...
										<tr>
											...
											<td>
												<a class="editable editable-click" id="tags" href="#" data-title="Enter tags" data-pk="1" data-type="select2">Html, Javascript</a>
											</td>
										</tr>
										<tr>
											<td>Select2 (dropdown mode)</td>
											<td>
												<a class="editable editable-click" id="country" href="#" data-title="Select country" data-pk="1" data-type="select2" data-value="BS">Bahamas</a>
											</td>
										</tr>
										<tr>
											<td>Custom input, several fields</td>
											<td>
												<a class="editable editable-click" id="address" data-original-title="" data-title="Please, fill address" data-pk="1" data-type="address"><b>Moscow</b>, Lenina st., bld. 12</a>
											</td>
										</tr>
										</tbody>
									</table>
						...
						$(document).ready(function()
						{
							...
							.editable({
								...
								display: function(value, sourceData)
								{
									...
									if (elem.length)
									{
										const colors = { "": "gray", 1: "green", 2: "blue" };
							...
							.editable({
								...
								display: function(value)
								{
									...
									const html = `<b>${$("<div>").text(value.city).html()}</b>, ${$("<div>").text(value.street).html()} st., bld. ${$("<div>").text(value.building).html()}`;
									$(this).html(html);
								}
							});
