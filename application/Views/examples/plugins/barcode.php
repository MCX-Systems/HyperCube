			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Bar-Codes and QR-Codes Plugin examples</h4>
					...
					<section class="col-md-2">
						<div class="card">
							<div class="card-body">
								<div id="qrcode1" class="p-3"></div>
								<script type="application/javascript">
									jQuery('#qrcode1').qrcode({
										width: 164,
										height: 164,
										background: "transparent",
										text: "https://mcx-systems.net"
									});
								</script>
							</div>
						</div>
					...
					<section class="col-md-2">
						<div class="card">
							<div class="card-body">
								<div id="qrcode2" class="p-3 w-100 h-100"></div>
								<script type="application/javascript">
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-body">
								<div id="barcode2"></div>
								<script type="application/javascript">
									$("#barcode2").barcode("1234567890128", "ean13", {color: "#1eff00"});
								</script>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-body">
								<div id="barcode3"></div>
								<script type="application/javascript">
									$("#barcode3").barcode("9780199532179", "ean8", {color: "#d41e00"});
								</script>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-body">
								<div id="barcode4"></div>
								<script type="application/javascript">
									$("#barcode4").barcode("554565", "msi", {color: "#F90"});
								</script>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-body">
								<div id="barcode5"></div>
								<script type="application/javascript">
									$("#barcode5").barcode("9780199532179", "code11");
								</script>
							</div>
						</div>
					</section>
