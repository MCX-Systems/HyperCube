			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Toolbar</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Toolbar menu Plugin example</h4>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="user-options" class="btn-toolbar mx-auto">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>

					<section class="col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Light</h4>
						<div data-toolbar="user-options" class="btn-toolbar bg-light mx-auto" data-toolbar-style="light">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>

					<section class="col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Dark</h4>
						<div data-toolbar="user-options" class="btn-toolbar bg-dark mx-auto" data-toolbar-style="dark">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="user-options" class="btn-toolbar bg-info mx-auto" data-toolbar-style="info">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Primary</h4>
						<div data-toolbar="user-options" class="btn-toolbar bg-primary mx-auto" data-toolbar-style="primary">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="user-options" class="btn-toolbar bg-danger mx-auto" data-toolbar-style="danger">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="user-options" class="btn-toolbar bg-warning mx-auto" data-toolbar-style="warning">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="user-options" class="btn-toolbar bg-success mx-auto" data-toolbar-style="success">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="set-01" class="btn-toolbar bg-info mx-auto" data-toolbar-style="info">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="set-02" class="btn-toolbar bg-success mx-auto" data-toolbar-style="success">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="set-03" class="btn-toolbar bg-warning mx-auto" data-toolbar-style="warning">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="set-04" class="btn-toolbar bg-danger mx-auto" data-toolbar-style="danger">
							<i class="fas fa-cog fa-fw"></i>
						</div>
					</section>
					...
					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						...
						<div data-toolbar="transport-options" data-toolbar-animation="standard" class="btn-toolbar bg-primary mx-auto"
						     data-toolbar-style="primary"><i class="fas fa-space-shuttle fa-fw"></i></div>
					</section>

					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Flip</h4>
						<div data-toolbar="transport-options" data-toolbar-animation="flip" class="btn-toolbar bg-danger mx-auto"
						     data-toolbar-style="danger"><i class="fas fa-space-shuttle fa-fw"></i></div>
					</section>

					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Grow</h4>
						<div data-toolbar="transport-options" data-toolbar-animation="grow" class="btn-toolbar bg-warning mx-auto"
						     data-toolbar-style="warning"><i class="fas fa-bicycle fa-fw"></i></div>
					</section>

					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Fly In</h4>
						<div data-toolbar="transport-options" data-toolbar-animation="flyin" class="btn-toolbar bg-info mx-auto"
						     data-toolbar-style="info"><i class="fas fa-subway fa-fw"></i></div>
					</section>

					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Bounce</h4>
						<div data-toolbar="transport-options" data-toolbar-animation="bounce" class="btn-toolbar bg-success mx-auto"
						     data-toolbar-style="success"><i class="fas fa-subway fa-fw"></i></div>
					</section>

					<section class="col-lg-2 col-md-3 col-sm-6 mb-3">
						<h4 class="text-center mb-2">Grow</h4>
						<div data-toolbar="transport-options" data-toolbar-animation="grow" class="btn-toolbar bg-info mx-auto"
						     data-toolbar-style="info"><i class="fas fa-ship fa-fw"></i></div>
					</section>
					...
					<div id="transport-options" class="toolbar-icons hidden">
						<a href="#"><i class="fas fa-space-shuttle"></i></a>
					...
					<div id="set-03-options" class="toolbar-icons hidden">
						...
						<a href="#"><i class="fas fa-euro-sign"></i></a>
						<a href="#"><i class="fab fa-gg-circle"></i></a>
					</div>

					<div id="set-04-options" class="toolbar-icons hidden">
