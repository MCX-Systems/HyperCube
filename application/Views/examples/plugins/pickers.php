			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Time, date, color - picker Plugins examples</h4>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="input-group">
											<input id="color-picker" type="text" class="form-control" value="rgba(136,100,103,1)" title="" />
											<div class="input-group-append">
												<span class="input-group-text input-group-addon color-p"><i class="fas fa-palette"></i></span>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="input-group">
											<input id="color-picker-1" type="text" class="form-control" title="" />
											<div class="input-group-append">
												<span class="input-group-text input-group-addon color-p-1"><i class="fas fa-palette"></i></span>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="input-group">
											<input id="color-picker-2" type="text" class="form-control" title="" />
											<div class="input-group-append">
												<span class="input-group-text input-group-addon color-p-2"><i class="fas fa-palette"></i></span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<h5 class="box-title mt-3">Date Range Pick</h5>
											<input class="form-control input-daterange-datepicker" type="text" name="daterange" value="01/01/2015 - 01/31/2015" title="" />
										</div>
									</div>

									<div class="col-md-4">
										<div class="form-group">
											<h5 class="box-title mt-3">Date Range With Time</h5>
											<input type="text" class="form-control input-daterange-timepicker" name="daterange" value="01/01/2015 1:30 PM - 01/01/2015 2:00 PM" title="" /></div>
									</div>

									<div class="col-md-4">
										<div class="form-group">
											<h5 class="box-title mt-3">Limit Selectable Dates</h5>
											<input class="form-control input-limit-datepicker" type="text" name="daterange" value="06/01/2015 - 06/07/2015" title="" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<h5 class="box-title mt-3">Default Datedpicker</h5>
											<p class="text-muted mb-2">just add class <code>.mydatepicker</code> to create it.</p>
											<div class="input-group">
												<input type="text" class="form-control mydatepicker" placeholder="mm/dd/yyyy" title="" />
												<div class="input-group-append">
										...
										<div class="form-group">
											<h5 class="box-title mt-3">Autoclose Datedpicker</h5>
											<p class="text-muted mb-2">just add class <code>.complex-colorpicker</code> to create it.</p>
											<div class="input-group">
												<input type="text" class="form-control" id="datepicker-autoclose" placeholder="mm/dd/yyyy" title="" />
												<div class="input-group-append">
													<span class="input-group-text"><i class="fas fa-calendar"></i></span>
												</div>
											</div>
										...
										<div class="form-group">
											<h5 class="box-title mt-3">Date Range picker</h5>
											<p class="text-muted mb-2">just add id <code>#date-range</code> to create it.</p>
											<div class="input-daterange input-group" id="date-range">
												<input type="text" class="form-control" name="start" title="" />
												<div class="input-group-append">
													<span class="input-group-text bg-info text-white">TO</span>
												</div>
												<input type="text" class="form-control" name="end" title="" />
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="text-center">
											<h5 class="box-title mt-3">Datepicker Inline</h5>
											<p class="text-muted mb-2">You also can set the datepicker to be inline and flat.</p>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="mt-2" for="exampleInputClock">Default Clock Picker</label>
											<div class="input-group clockpicker mb-3">
												<input type="text" class="form-control" aria-label="exampleInputClock" value="09:30" title="" />
												<div class="input-group-append">
										...
										<div class="form-group">
											<label class="mt-4" for="exampleInputClock1">Auto close Clock Picker</label>
											<div class="input-group clockpicker mb-3" data-placement="botom" data-align="top" data-autoclose="true">
												<input type="text" class="form-control" aria-label="exampleInputClock1" value="13:14" title="" />
												<div class="input-group-append">
													<span class="input-group-text"><i class="fas fa-clock"></i></span>
												</div>
											</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="mt-2" for="exampleInputClock2">Now time</label>
											<div class="input-group mb-3">
												<input id="single-input" type="text" class="form-control" placeholder="Now" aria-label="exampleInputClock2"/>
												<div class="input-group-append">
													<button type="button" id="check-minutes" class="btn btn-success ripple-click-effect">Check the minutes</button>
												</div>
											</div>
										</div>

										<div class="form-group">
											<label class="mt-4" for="exampleInputClock3">Left Placement</label>
											<div class="input-group clockpicker mb-3" data-placement="left" data-align="top" data-autoclose="true">
												<input type="text" class="form-control" aria-label="exampleInputClock3" value="13:14" title="" />
												<div class="input-group-append">
													<span class="input-group-text"><i class="fas fa-clock"></i></span>
												</div>
											</div>
