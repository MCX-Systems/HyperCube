			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo base_url() ?>examples/blank">Plugin</a>
						</li>
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Full Calendar Plugin example</h4>
					...
					<section class="col-md-3 mb-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Draggable Events
									<a href="#" class="btn btn-link btn-xs float-right" data-toggle="modal" data-target="#fcModal"><i class="fas fa-plus"></i></a>
								</span>
							</div>

							<div class="card-body">
								<div id='fc-external-events'>
									<div class='fc-external-event fc-color_warning'>
										Team Out
										<i class="fas fa-times fc-event-clear" aria-hidden="true"></i>
									</div>
									<div class='fc-external-event fc-color_primary'>
										Product Seminar
										<i class="fas fa-times fc-event-clear" aria-hidden="true"></i>
									</div>
									<div class='fc-external-event fc-color_danger'>
										Client Meeting
										<i class="fas fa-times fc-event-clear" aria-hidden="true"></i>
									</div>
									<div class='fc-external-event fc-color_info'>
										Repeating Event
										<i class="fas fa-times fc-event-clear" aria-hidden="true"></i>
									</div>
									<div class='fc-external-event fc-color_success'>
										Event Celebrations
										<i class="fas fa-times fc-event-clear" aria-hidden="true"></i>
									</div>
								</div>
							...
							<div class="card-footer">
								<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#fcModal">Create event</a>
							</div>
						</div>
						<!-- /.box -->
					</section>
			 ...
			 -----------------------------------------------------------------*/
							...
							iniEvents($("#fc-external-events div.fc-external-event"));

							/* initialize the calendar */
							//Date for the calendar events (dummy data)
							const dater = new Date();
							const d = dater.getDate();
							const m = dater.getMonth();
							const y = dater.getFullYear();
							...
							.fullCalendar({
								...
								events: [
									{
										...
										backgroundColor: "#084002"
									}, {
										title: "Product Seminar",
										start: new Date(y, m, 16),
										backgroundColor: "#0f3a81"
									}, {
								...
								{
									evtObj = calEvent;
									$("#event_title").val(evtObj.title);
									currColor = evtObj.backgroundColor;
									colorChooser.css({
										"background-color": evtObj.backgroundColor,
										"border-color": evtObj.backgroundColor
									})
									...
									.on("click",
										function()
										{
											evtObj.title = $("#event_title").val();
											evtObj.backgroundColor = currColor;
											$("#calendar").fullCalendar("updateEvent", evtObj);
											window.setTimeout(setpopover, 100);
										});
								},
								...
								drop: function(date, allDay)
								{
									...
									const $calendarBadge = $(".calendar_badge");
									...
									$calendarBadge.text(parseInt($calendarBadge.text()) + 1);
							...
							/* ADDING EVENTS */
							currColor = null; //default
							//Color chooser button
							colorChooser = $(".fc-color-chooser-btn");
							...
							.on("click",
								function(e)
								{
									...
									.addClass("fc-external-event");

									event.html(val).append(' <i class="fas fa-times fc-event-clear" aria-hidden="true"></i>');
									$("#fc-external-events").prepend(event);
							...
							$("body")
							.on("click",
								"#fc-external-events .fc-event-clear",
								function()
								{
									$(this).closest(".fc-external-event").remove();
									return false;
								});
							...
							.on("click",
								function()
								{
									$("#fc-new-event").replaceWith('<input type="text" id="fc-new-event" class="form-control" placeholder="Event">');
								});
...
<div class="modal fade" id="fcModal" tabindex="-1" role="dialog" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="input-group">
					<input type="text" id="fc-new-event" class="form-control" placeholder="Event" />
					<div class="input-group-btn">
						<button type="button" class="fc-color-chooser-btn btn btn-primary text-white dropdown-toggle" data-toggle="dropdown">
							Choose One
						</button>
						<div class="dropdown-menu dropdown-menu-right fc-color-chooser">
							<a class="fc-color_primary text-center text-white dropdown-item" href="#">
								Primary
							</a>
							<a class="fc-color_success text-center text-white dropdown-item" href="#">
								Success
							</a>
							<a class="fc-color_info text-center text-white dropdown-item" href="#">
								Info
							</a>
							<a class="fc-color_warning text-center text-white dropdown-item" href="#">
								warning
							</a>
							<a class="fc-color_danger text-center text-white dropdown-item" href="#">
								Danger
							</a>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success pull-left" id="fc-add-new-event" data-dismiss="modal">
					<i class="fas fa-plus mr-2"></i>
					Add
				</button>
			</div>
			...
			<div class="modal-body">
				<div class="input-group">
					...
					<div class="input-group-btn">
						...
						<div class="dropdown-menu dropdown-menu-right cal_modal_type color-chooser">
							<a class="color_primary text-center dropdown-item text-white" href="#">Primary</a>
							<a class="color_success text-center dropdown-item text-white" href="#">Success</a>
							<a class="color_info text-center dropdown-item text-white" href="#">Info</a>
							<a class="color_warning text-center dropdown-item text-white" href="#">warning</a>
							<a class="color_danger text-center dropdown-item text-white" href="#">Danger</a>
						</div>
					</div>
					<!-- /btn-group -->
				</div>
