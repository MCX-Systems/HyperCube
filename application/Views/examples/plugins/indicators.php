		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Different indicators Plugins examples</h4>
					...
					<script type="text/javascript">
						$(function () {
							// Dynamic examples
							var attitude = $.flightIndicator('#attitude', 'attitude', {roll: 50, pitch: -20, size: 220, showBox: false});
							var heading = $.flightIndicator('#heading', 'heading', {heading: 150, size: 220, showBox: false});
							var variometer = $.flightIndicator('#variometer', 'variometer', {vario: -5, size: 220, showBox: false});
							var airspeed = $.flightIndicator('#airspeed', 'airspeed', {size: 220, showBox: false});
							var altimeter = $.flightIndicator('#altimeter', 'altimeter', {size: 220, showBox: false});
							var turn_coordinator = $.flightIndicator('#turn_coordinator', 'turn_coordinator', {turn: 0, size: 220, showBox: false});
					...
					<section class="col-md-12">
						<button onclick="animateGauges()" class="btn btn-secondary">Animate</button>
						<button onclick="stopGaugesAnimation()" class="btn btn-secondary">Stop animation</button>
					</section>
					...
					<section class="col-md-3">
						<canvas data-type="radial-gauge"
						        ...
						        data-value="45"
						        data-animate-on-init="true"></canvas>
					</section>
            ...
            '0','20','40','60','80','100','120','140','160','180','200','220']"
		      ...
		      { from: 200, to: 220, color: 'rgba(0,0,255,.25)' }]"
						        data-color-plate="transparent"
						        data-colorMajorTicks="#f5f5f5"
						        data-colorMinorTicks="#ddd"
						        data-colorTitle="#fff"
						        data-colorUnits="#ccc"
						        data-colorNumbers="#eee"
						        data-colorNeedle="rgba(240, 128, 128, 1)"
						        data-colorNeedleEnd="rgba(255, 160, 122, .9)"
						        data-valueBox="true"
						        data-animationRule="bounce"
