			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">High Slide</li>
					</ul>
				</div>
				<!-- ============================================================== -->
		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<a href="<?php echo base_url(); ?>uploads/pictures/landscape3.jpg" class="highslide" onclick="return hs.expand(this)">
							<img src="<?php echo base_url(); ?>uploads/pictures/m3.jpg" alt="Highslide JS" title="Click to enlarge" />
						</a>

						<a href="http://www.youtube.com/embed/a0qMe7Z3EYg?rel=0&amp;wmode=transparent" class="highslide" onclick="return hs.htmlExpand(this, {objectType: 'iframe', width: 480, height: 385,
		allowSizeReduction: false, wrapperClassName: 'no-footer',
		preserveContent: false, objectLoadTime: 'after'})"><img src="<?php echo base_url(); ?>uploads/pictures/m4.jpg" alt="Highslide JS" title="Click to Enlarge" /></a>
					</section>
					...
					<section class="col-md-12">
						<div class="highslide-gallery">
							<a href="<?php echo base_url(); ?>uploads/pictures/post-7.jpg" class="highslide" onclick="return hs.expand(this)">
								<img src="<?php echo base_url(); ?>uploads/pictures/m3.jpg" alt="Highslide JS" title="Click to Enlarge" />
							</a>
							<div class="highslide-caption">Caption for the first image.</div>

							<a href="<?php echo base_url(); ?>uploads/pictures/post-8.jpg" class="highslide" onclick="return hs.expand(this)">
								<img src="<?php echo base_url(); ?>uploads/pictures/m4.jpg" alt="Highslide JS" title="Click to Enlarge" />
							</a>
							<div class="highslide-caption">Caption for the second image.</div>

							<a href="<?php echo base_url(); ?>uploads/pictures/post-9.jpg" class="highslide" onclick="return hs.expand(this)">
								<img src="<?php echo base_url(); ?>uploads/pictures/m5.jpg" alt="Highslide JS" title="Click to Enlarge" />
							</a>
					...
					<section class="col-md-12">
						...
						<div class="highslide-html-content" id="highslide-html">
							...
							<div class="highslide-body">
								...
								fames ac turpis egestas. Donec sed enim. Ut vel ipsum. Cras consequat velit et justo. Donec mollis,
								mi at tincidunt vehicula, nisl mi luctus risus, quis scelerisque arcu nibh ac nisi. Sed risus.
								Curabitur urna. Aliquam vitae nisl. Quisque imperdiet semper justo. Pellentesque nonummy pretium tellus.
							</div>
