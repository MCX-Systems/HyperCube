			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Flot Charts Plugin examples</h4>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Real Time Charts</h4>
								<div id="realtime" class="flotChart"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Spline Line Chart</h4>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<div id="bar-chart-stacked" class="flotChart"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<div id="area-chart" class="flotChart"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<div id="chart-spline" class="flotChart"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-5 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<div id="donut" class="flotChart"></div>
							</div>
						</div>
					</section>

					<section class="col-md-7 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="demo-container">
											<div id="placeholdertranslabel" class="flotChart"></div>
										</div>
									</div>
									<div class="col-md-6">
										<div id="placeholdertiltedpie" class="flotChart"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<script type="text/javascript">
						$(document).ready(function() {
							...
							//start bar chart
							d1 = [["1", 100], ["2", 80], ["3", 66], ["4", 48], ["5", 68], ["6", 48], ["7", 66], ["8", 80], ["9", 64], ["10", 48], ["11", 64], ["12", 100]];
							$.plot("#bar-chart",
								[
									{
										data: d1,
