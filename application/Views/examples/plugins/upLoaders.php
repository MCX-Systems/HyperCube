			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Uploaders</li>
					</ul>
				</div>
				<!-- ============================================================== -->
				...
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<p class="card-header mb-2">
									Plupload is a cross-browser
									<code>multi-runtime</code>file uploading API. Basically, a set of tools that will help you to build a reliable and visually appealing file uploader in minutes. This example replaced a specific div with a the jQuery uploader
									<code>queue</code>widget. It will automatically check for different runtimes in the configured order, if it fails it will not convert the specified element.
								</p>
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-body">
								<p class="card-header">
									Example of a
									<code>single</code>file uploader based on
									<code>Dropzone.js</code>library. By default, dropzone is a multiple file uploader and does not have specific option allowing us to switch to single file uploading mode, but this functionality can be achieved by adding more options to the plugin settings, such as
									<code>addedfile</code>callback and
									<code>maxFiles</code>option set to
									<code>1</code>. Now only 1 file can be selected and it will be replaced with another one instead of adding it to the preview.
								</p>
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-body">
								<p class="card-header">
									Example of dropzone file uploader with specified
									<code>file formats</code>. The default implementation of
									<code>accept</code>checks the file's mime type or extension against this list. This is a comma separated list of mime types or file extensions. Eg.:
									<code>image/*</code>,
									<code>application/pdf</code>,
									<code>.psd</code>. If the Dropzone is clickable, this option will be used as
									<code>accept</code>parameter on the hidden file input as well. Thsi example accepts
									<code>images</code>only with maximum size of
									<code>1Mb</code>.
								</p>
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-body">
								<p class="card-header">
									Example of dropzone file uploader with
									<code>remove</code>thumbnail option applied to every thumbnail in the preview by setting
									<code>addRemoveLinks</code>option to
									<code>true</code>. This will add a link to every file preview to remove or cancel (if already uploading) the file. The
									<code>dictCancelUpload</code>,
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-body">
								<p class="card-header">
									Example of dropzone uploader with different
									<code>limits</code>:
									<code>maxFilesize</code>- maximum size of files allowed, in Mb;
									<code>maxFiles</code>- if not
									<code>null</code>defines how many files this Dropzone handles, if it exceeds, the event
									<code>maxfilesexceeded</code>will be called. The dropzone element gets the class
									<code>dz-max-files-reached accordingly</code>so you can provided visual feedback;
									<code>maxThumbnailFilesize</code>- in MB. When the filename exceeds this limit, the thumbnail will not be generated.
								</p>
					...
					<script type="text/javascript">
						(function ()
						{
							$(".file-uploader").pluploadQueue({
								runtimes: "html5",
								url: global_base_url + "uploads/test/plupload.json",
								// Maximum file size
								max_file_size: "5mb",
