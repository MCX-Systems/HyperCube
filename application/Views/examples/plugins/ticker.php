			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Web Ticker</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">WebTicker Plugin examples</h4>
					...
					<script type="text/javascript">
						jQuery(document).ready(function () {
							...
							$("#images-webticker").webTicker({
								rssurl:'https://mcx-systems.net/',
								height:'100%',
								rssfrequency:5
							});

							$("#webticker-example").webTicker({
								height:'75px',
								duplicate:true,
								rssfrequency:0,
								startEmpty:false,
