			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Prism</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						...
						<pre data-src="<?php echo base_url() ?>uploads/test/javascript.js"></pre>
					</section>

					<section class="col-md-6">
						<p>CSS code, highlighted with Prism:</p>
						<pre data-src="<?php echo base_url() ?>uploads/test/style.css"></pre>
					</section>

					<section class="col-md-6">
						<p>HTML, highlighted with Prism:</p>
						<pre data-src="<?php echo base_url() ?>uploads/test/index.html"></pre>
					</section>

					<section class="col-md-12">
						<p>Logo (SVG), highlighted with Prism:</p>
						<pre data-src="<?php echo base_url() ?>uploads/test/success.svg"></pre>
					</section>
