			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Range Slider Plugin examples</h4>
								...
								<form class="form">
									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_1">Basic Slider</label>
										</div>
										<div class="col-md-10">
											<input id="example_1" type="text" name="basic_slider"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_2">Money Range</label>
										</div>
										<div class="col-md-10">
											<input id="example_2" type="text" name="money_range"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_3">Gold Range</label>
										</div>
										<div class="col-md-10">
											<input id="example_3" type="text" name="gold_range"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_4">Temperature Slider</label>
										</div>
										<div class="col-md-10">
											<input id="example_4" type="text" name="temp"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_5">Month Slider</label>
										</div>
										<div class="col-md-10">
											<input id="example_5" type="text" name="month_slider"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_6">Year Range</label>
										</div>
										<div class="col-md-10">
											<input id="example_6" type="text" name="year_range"/>
										</div>
									</div>

									<div class="form-group row mt-2">
										<div class="col-md-2 text-md-right">
											<label for="example_7">Year Slider</label>
										</div>
										<div class="col-md-10">
											<input id="example_7" type="text" name="year_slider"/>
										</div>
									</div>
								</form>
							</div>
