			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">JSTree Plugin examples</h4>
					...
					<section class="col-md-6 mb-3">
						<div class="card" data-sortable-id="tree-view-1">
							<div class="card-header">
								<span class="card-title">Default Tree</span>
							</div>
									...
									<ul>
										<li data-jstree='{"opened":true}'>
											...
											<ul>
												...
												<li data-jstree='{ "icon" : "fas fa-warning fa-lg text-danger mr-2" }'>custom icon class (fontawesome)</li>
												<li data-jstree='{ "icon" : "fas fa-link fa-lg text-primary mr-2" }'>
													<a href="#">Clickable link node</a>
												</li>
											</ul>
										</li>
										<li>Root node 2</li>
					...
					<!-- begin col-6 -->
					<section class="col-md-6 mb-3">
						<div class="card" data-sortable-id="tree-view-2">
							<div class="card-header">
								<span class="card-title">Checkable Tree</span>
							</div>
					...
					<section class="col-md-6 mb-3">
						<div class="card" data-sortable-id="tree-view-3">
							<div class="card-header">
								<span class="card-title">Contextual Menu with Drag & Drop</span>
							</div>

							<div class="card-body">
								<div class="alert alert-info">
									<i class="fas fa-info-circle fa-fw mr-2"></i>All the opened & selected nodes will be saved in the user's browser.
								</div>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							...
							<div class="card-body">
								<button class="btn btn-primary btn-sm node1 mt-1">Select node 1</button>
								<button class="btn btn-primary btn-sm node2 mt-1">Select node 2</button>
								<button class="btn btn-primary btn-sm node1_1 mt-1">Select node 1.1</button>
								<button class="btn btn-primary btn-sm node1_2 mt-1">Select node 1.2</button>
								<button class="btn btn-primary btn-sm node3_1 mt-1">Select node 3.1</button>
								<button class="btn btn-primary btn-sm node3_2 mt-1">Select node 3.2</button>
								<div id="jstree3" class="mt-2"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6 mb-3">
						<div class="card">
							...
							<div class="card-body">
								<form id="search">
									<input type="search" id="input_search" class="my-3"  title="input_search" />
									<button class="btn btn-primary btn-sm" type="submit">Search</button>
								</form>
								<div id="jstree6" class="mt-2">
									<ul>
										<li data-jstree='{"opened":true}'>
											Root node
											<ul>
					...
					<script type="text/javascript">
						jQuery(document).ready(function () {
							$("#jstree-default").jstree({
								...
								types: {
									root: {
										icon: "fas fa-folder text-primary fa-lg mr-2"
									},
									child: {
										icon : "fas fa-folder text-warning fa-lg mr-2"
									},
									default: {
										icon: "fas fa-folder text-warning fa-lg mr-2"
									},
									file: {
										icon: "fas fa-file text-inverse fa-lg mr-2"
									}
								},
								plugins: [
									"checkbox",
							...
							$("#jstree-checkable").jstree({
											...
											children: [
												{
													...
													text: "custom icon",
													icon: "fas fa-cloud fa-lg text-inverse"
												}, {
													text: "disabled node",
													state: {
														disabled: !0
								...
								types: {
									"default": {
										icon: "fas fa-folder text-primary fa-lg"
									},
									file: {
							...
							$("#jstree-drag-and-drop").jstree({
											...
											children: [
												{
													...
													text: "Initially open",
													icon: "fas fa-folder text-success fa-lg",
													state: {
														opened: !0
													},
													children: [
													...
													icon: "fas fa-cog text-inverse fa-lg"
												}, {
													text: "Disabled Node",
													state: {
														disabled: !0
													...
													text: "Sub Nodes",
													icon: "fas fa-folder text-danger fa-lg",
													children: [
														{
															text: "Item 1",
								...
								types: {
									...
									file: {
										icon: "fas fa-file text-warning fa-lg"
									}
								},
								state: {
									key: "demo2"
...
//    Working with events
							...
							$("#jstree2").on("changed.jstree",
								function(e, data)
								{
									window.console.log(data.selected);
								});
							...
							$(".node1").on("click",
								function()
								{
									const instance = $("#jstree3").jstree(true);
