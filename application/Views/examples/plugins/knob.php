			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Knob Slider</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Knob Slider Plugin example</h4>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-bgColor="#333333" data-fgColor="#009efb" data-displayInput=false value="50" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-cursor=true data-bgColor="#333333" data-fgColor="#26c6da" value="75" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-min="-100" data-bgColor="#333333" data-fgColor="#ffbc34" data-displayPrevious=true value="89" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="250" data-height="250" data-min="-100" data-bgColor="#333333" data-fgColor="#f62d51" data-displayPrevious=true data-angleOffset=-125 data-angleArc=250 value="56" />
								</div>
							</div>
						</div>
					</section>

					<section class="col-nd-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Angle offset</h4>
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="250" data-height="250" data-angleOffset="90" data-linecap="round" data-bgColor="#333333" data-fgColor="#7460ee" value="90" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-min="-15000" data-displayPrevious=true data-max="15000" data-step="1000" value="10000" data-bgColor="#333333" data-fgColor="#4c5667" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-linecap=round data-bgColor="#333333" data-fgColor="#01c0c8" value="40" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".1" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Angle offset and arc</h4>
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="150" data-height="150" data-displayPrevious=true data-bgColor="#333333" data-fgColor="#26c6da" data-skin="tron" data-cursor=true value="75" data-thickness=".2" data-angleOffset=-125 data-angleArc=250 />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Readonly</h4>
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="220" data-height="220" data-linecap=round data-bgColor="#333333" data-fgColor="#01c0c8" value="90" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".2" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Readonly</h4>
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="180" data-height="180" data-linecap=round data-bgColor="#333333" data-fgColor="#ffbc34" value="67" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".1" />
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Readonly</h4>
								<div class="text-center">
									<input title="" data-plugin="knob" data-width="120" data-height="120" data-linecap=round data-bgColor="#333333" data-fgColor="#fb9678" value="70" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".1" />
								</div>
							</div>
						</div>
					</section>
