			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Cycle Content</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Cycle2 Plugin examples</h4>
					...
					<section class="col-md-3">
						<div class="cycle-slideshow"
							...
							<img src="<?php echo base_url() ?>uploads/pictures/1.jpg" alt="Spring" />
							<img src="<?php echo base_url() ?>uploads/pictures/2.jpg" alt="Redwoods" />
							<img src="<?php echo base_url() ?>uploads/pictures/3.jpg" alt="Angle Island" />
							<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="Raquette Lake" />
						</div>
