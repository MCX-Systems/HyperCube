			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo base_url() ?>examples/widgets">Widgets</a>
						</li>
			...
			<div class="main-content-box">
				<div class="row">
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-lg-4 col-xlg-3 col-md-5">
										...
										<hr />
										<h3 class="mt-2 display-5">All reviews - 31560</h3>
										<h6 class="card-subtitle mb-3">April the product got 234 reviews</h6>
										<hr />
										<h3 class="mb-1">Users with reviews</h3>
										<a href="#" class="mr-2"><img src="<?php echo base_url() ?>assets/avatars/avatar1.png" class="rounded-circle widget-reviewAvatar" alt="" /></a>
										<a href="#" class="mr-2"><img src="<?php echo base_url() ?>assets/avatars/avatar4.png" class="rounded-circle widget-reviewAvatar" alt="" /></a>
										<a href="#" class="mr-2"><img src="<?php echo base_url() ?>assets/avatars/avatar5.png" class="rounded-circle widget-reviewAvatar" alt="" /></a>
										<a href="#" class="mr-2"><img src="<?php echo base_url() ?>assets/avatars/avatar6.png" class="rounded-circle widget-reviewAvatar" alt="" /></a>
										<div class="clearfix mb-5"></div>
										<button type="button" class="btn btn-success mt-4">Read Reviews</button>
									</div>

									<!-- Column -->
									<div class="col-lg-8 col-xlg-9 col-md-7 border-left border-warning">
										<ul class="widget-reviewContent">
											<li>
												<i class="fas fa-smile fa-3x fa-fw text-muted"></i>
												<div class="widget-reviewCount">
												   <h3 class="card-title text-warning">Positive Reviews</h3>
											...
											<li>
												<i class="fas fa-frown fa-3x fa-fw text-muted"></i>
												<div class="widget-reviewCount">
                                                    <h3 class="card-title text-warning">Negative Reviews</h3>
											...
											<li>
												<i class="fas fa-meh fa-3x fa-fw text-muted"></i>
												<div class="widget-reviewCount">
                                                    <h3 class="card-title text-warning">Neutral Reviews</h3>
					...
					<section class="col-xl-4">
						<div class="widget widget--male">
							<div class="widget-info">
								<div>
									<div class="widget-label">Heart Rate</div>
									<div class="widget-value"><span class="widget-mount">84</span> bpm</div>
								</div>
								<span class="fas fa-heart widget-icon"></span>
							</div>

							<div id="widget-male-chart" class="widget-chart"></div>

							<ul class="widget-params">
								<li class="widget-param">
									<span class="widget-param-value">165</span>
									<span class="widget-param-name">Average</span>
								</li>
								<li class="widget-param">
									<span class="widget-param-value">188</span>
									<span class="widget-param-name">Highest</span>
								</li>
								<li class="widget-param">
									<span class="widget-param-value">83</span>
									<span class="widget-param-name">Lowest</span>
								</li>
							</ul>
						</div>
					</section>
					...
					<section class="col-xl-4">
						<div class="widget widget--female">
							<div class="widget-info">
								<div>
									<div class="widget-label">Heart Rate</div>
									<div class="widget-value"><span class="widget-amount">84</span> bpm</div>
								</div>
								<span class="fas fa-heart widget-icon"></span>
							</div>

							<div id="widget-female-chart" class="widget-chart"></div>
					...
					<section class="col-xl-4">
						<div class="card mb-3 p-0">
							<div class="card-body p-0">
								<div class="widget widget--blood-pressure">
									<div class="widget-info">
										<div>
											<div class="widget-label">Blood Pressure</div>
											<div class="widget-value"><span class="widget-amount">130/80</span> mmGH</div>
										</div>
										<span class="fas fa-tint widget-icon"></span>
									</div>

									<div id="widget-blood-pressure-chart" class="widget-chart"></div>
								</div>
							</div>
						</div>
						...
						<div class="card p-0">
							<div class="card-body p-0">
								<div class="widget widget-temperature">
									<div class="widget-temperature-item">
										<div class="widget-temperature-item-label">Temperature</div>
										<div class="widget-temperature-item-value">
											<span class="widget-temperature-item-amount">36.8</span> °C
										</div>

										<div id="widget-temperature-left-side-chart" class="widget-temperature-chart"></div>
									</div>

									<div class="widget-temperature-item">
										<div class="widget-temperature-item-label">Temperature</div>
										<div class="widget-temperature-item-value">
											<span class="widget-temperature-item-amount">93</span> %
										</div>

										<div id="widget-temperature-right-side-chart" class="widget-temperature-chart"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title text-warning">Weather Report</h4>
								<div class="d-flex align-items-center flex-row mt-3">
									<div class="p-2 display-4 text-danger w-100">
										<i class="wi wi-day-showers"></i>
										<span>32<sup>°</sup>C</span>
									</div>

									<div class="p-2 flex-shrink-1">
										<h3 class="mb-0 text-warning">Saturday</h3>
								...
								<table class="table no-border">
									<tbody>
									<tr>
										<td class="text-warning"><i class="wi wi-wind mr-2"></i>Wind</td>
										<td class="text-right">ESE 17 mph</td>
									</tr>
									<tr>
										<td class="text-warning"><i class="wi wi-humidity mr-2"></i>Humidity</td>
										<td class="text-right">83%</td>
									</tr>
									<tr>
										<td class="text-warning"><i class="wi wi-barometer mr-2"></i>Pressure</td>
										<td class="text-right">28.56 in</td>
									</tr>
									<tr>
										<td class="text-warning"><i class="wi wi-cloud-up mr-2"></i>Cloud Cover</td>
										<td class="text-right">78%</td>
									</tr>
									<tr>
										<td class="text-warning"><i class="wi wi-horizon-alt mr-2"></i>Ceiling</td>
										<td class="text-right">25760 ft</td>
									</tr>
									</tbody>
								</table>
								...
								<ul class="list-unstyled row text-center">
									<li class="col">
										<i class="wi wi-day-sunny fa-2x text-warning"></i>
										<p>09:30</p>
										<hr />
										<h3 class="text-danger">27<sup>°</sup>C</h3>
									</li>
									<li class="col">
										<i class="wi wi-day-cloudy fa-2x text-warning"></i>
										<p>11:30</p>
										<hr />
										<h3 class="text-danger">20<sup>°</sup>C</h3>
									</li>
									<li class="col">
										<i class="wi wi-day-hail fa-2x text-warning"></i>
										<p>13:30</p>
										<hr />
										<h3 class="text-danger">16<sup>°</sup>C</h3>
									</li>
									<li class="col">
										<i class="wi wi-day-sprinkle fa-2x text-warning"></i>
										<p>15:30</p>
										<hr />
										<h3 class="text-danger">8<sup>°</sup>C</h3>
									</li>
								</ul>
							</div>
						</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title text-warning">Browser Stats</h4>
								<table class="table browser mt-3 no-border">
									<tbody>
									<tr>
										<td style="width:40px">
											<img src="<?php echo base_url('/') ?>assets/images/browsers/chrome-logo.png" alt="logo" />
										</td>
										<td>Google Chrome</td>
										<td align="right"><span class="badge badge-info">23%</span></td>
									</tr>
									<tr>
										<td>
											<img src="<?php echo base_url('/') ?>assets/images/browsers/firefox-logo.png" alt="logo" />
										</td>
										<td>Mozila Firefox</td>
										<td align="right"><span class="badge badge-success">15%</span></td>
									</tr>
									<tr>
										<td>
											<img src="<?php echo base_url('/') ?>assets/images/browsers/safari-logo.png" alt="logo" />
										</td>
										<td>Apple Safari</td>
										<td align="right"><span class="badge badge-primary">07%</span></td>
									</tr>
									<tr>
										<td>
											<img src="<?php echo base_url('/') ?>assets/images/browsers/internet-logo.png" alt="logo" />
										</td>
										<td>Internet Explorer</td>
										<td align="right"><span class="badge badge-warning">09%</span></td>
									</tr>
									<tr>
										<td>
											<img src="<?php echo base_url('/') ?>assets/images/browsers/opera-logo.png" alt="logo" />
										</td>
										<td>Opera mini</td>
										<td align="right"><span class="badge badge-danger">23%</span></td>
									</tr>
									<tr>
										<td>
											<img src="<?php echo base_url('/') ?>assets/images/browsers/internet-logo.png" alt="logo" />
										...
										<td align="right"><span class="badge badge-danger">09%</span></td>
									</tr>
									</tbody>
								</table>
							</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<ul class="widget-feeds-list">
									<li>
										<div class="bg-info">
											<i class="fas fa-bell"></i>
										</div> You have 4 pending tasks.
										<span class="text-warning">Just Now</span>
									</li>
									<li>
									...
									<li>
										...
										<span class="text-warning">31 May</span>
									</li>
									<li>
										<div class="bg-danger">
											<i class="fas fa-user"></i>
										</div> New user registered.
										<span class="text-warning">30 May</span>
									</li>
									<li>
										<div class="bg-dark">
											<i class="fas fa-bell"></i>
										</div> New Version just arrived.
										<span class="text-warning">27 May</span>
									</li>
									<li>
										<div class="bg-info">
											<i class="fas fa-bell"></i>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										<h3 class="mb-0">User Groups</h3>
										<h6 class="text-muted mb-0">Edit user Groups</h6>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										<h3 class="mb-0">Config</h3>
										<h6 class="text-muted mb-0">Site Config</h6>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Newsletter settings</h6>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-row">
									<div class="mr-3 mt-1">
										<i class="fas fa-network-wired fa-3x text-danger"></i>
									</div>
									<div class="ml-1">
										<h3 class="mb-0">IP Ban</h3>
										<h6 class="text-muted mb-0">Ban users by IP</h6>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-row">
									<div class="mr-3 mt-1">
										<i class="fas fa-atlas fa-3x text-danger"></i>
									</div>
									<div class="ml-1">
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Image Config</h6>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Manage Site Plugins</h6>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Manage Templates</h6>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Manage Videos</h6>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="d-flex flex-row">
									...
									<div class="ml-1">
										...
										<h6 class="text-muted mb-0">Manage Music</h6>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-md-6 col-lg-6 col-xlg-4 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center align-top m-0 p-1 pb-5">
										<img src="<?php echo base_url() ?>uploads/pictures/15.jpg" alt="user" class="img-thumbnail">
									</div>
									<div class="col-md-8 col-lg-9">
										<h4 class="card-title mb-0">John Doe</h4><small>Jazz, Metal</small>
										<div class="row mt-1">
										...
										<div class="row">
											<div class="col-md-12">
												<a href="#" class="text-purple mr-2"><i class="fab fa-facebook fa-2x"></i></a>
												<a href="#" class="text-blue mr-2"><i class="fab fa-twitter fa-2x"></i></a>
												<a href="#" class="text-danger mr-2"><i class="fab fa-soundcloud fa-2x"></i></a>
												<a href="#" class="text-success mr-2"><i class="fab fa-spotify fa-2x"></i></a>
												<a href="#" class="text-red"><i class="fab fa-youtube fa-2x"></i></a>
											</div>
										</div>
									</div>
								</div>
					...
					<section class="col-md-6 col-lg-6 col-xlg-4 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center align-top m-0 p-1 pb-5">
										<img src="<?php echo base_url() ?>uploads/pictures/3.jpg" alt="user" class="img-thumbnail">
									</div>
									<div class="col-md-8 col-lg-9">
										<h4 class="card-title mb-0">John Doe</h4><small>Jazz, Metal</small>
										<div class="row mt-1">
					...
					<section class="col-md-6 col-lg-6 col-xlg-4 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center align-top m-0 p-1 pb-5">
										<img src="<?php echo base_url() ?>uploads/pictures/5.jpg" alt="user" class="img-thumbnail">
									</div>
									<div class="col-md-8 col-lg-9">
										<h4 class="card-title mb-0">John Doe</h4><small>Jazz, Metal</small>
										<div class="row mt-1">
					...
					<section class="col-md-6 col-lg-6 col-xlg-4 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center align-top m-0 p-1 pb-5">
										<img src="<?php echo base_url() ?>uploads/pictures/9.jpg" alt="user" class="img-thumbnail">
									</div>
									<div class="col-md-8 col-lg-9">
										<h4 class="card-title mb-0">John Doe</h4><small>Jazz, Metal</small>
										<div class="row mt-1">
						...
						<div class="card">
							<div class="card-body p-0">
								...
								<div class="row no-gutters">
									<div class="col-md-3 rounded-left" style="background: url('<?php echo base_url() ?>uploads/pictures/9.jpg') center center / cover no-repeat; min-height:250px;"></div>
									<!-- column -->
									<div class="col-md-9">
										<div class="row no-gutters">
											<div class="col-md-6 border-right border-bottom border-warning">
												<div class="p-2">
											...
											<div class="col-md-6 border-bottom border-warning">
												<div class="p-2">
													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-bath fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Bathrooms</span>
														<span class="badge badge-pill badge-info ml-auto">2</span>
													</div>

													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-bed fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Beds</span>
														<span class="badge badge-pill badge-info ml-auto">2</span>
													</div>

													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-car fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Garages</span>
														<span class="badge badge-pill badge-secondary ml-auto">1</span>
													</div>

													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-coffee fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Coffee</span>
														<span class="badge badge-pill badge-success ml-auto">YES</span>
													</div>

													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-utensils fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Dinner</span>
														<span class="badge badge-pill badge-danger ml-auto">NO</span>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="p-1">
													<div class="d-flex no-block align-items-center">
														<div class="avatar avatar-xs mr-4">
															<span class="avatar-letter avatar-letter-r"></span>
														</div>
														<div class="mt-2">
															<h5 class="card-title mb-0">Jon Doe</h5>
															<h6 class="text-muted">5 Property</h6>
														</div>
														<div class="ml-auto text-muted text-right">
															<i class="fas fa-map-marker fa-fw text-danger mr-1"></i> New York City
														</div>
													</div>
												</div>
											</div>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body p-0">
								<!-- row -->
								<div class="row no-gutters">
									<div class="col-md-3 rounded-left" style="background: url('<?php echo base_url() ?>uploads/pictures/2.jpg') center center / cover no-repeat; min-height:250px;"></div>
									<!-- column -->
									<div class="col-md-9">
										<div class="row no-gutters">
											<div class="col-md-6 border-right border-bottom border-warning">
											...
											<div class="col-md-6 border-bottom border-warning">
												<div class="p-2">
													...
													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-bed fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Beds</span>
														<span class="badge badge-pill badge-success ml-auto">2</span>
													</div>

													<div class="d-flex no-block align-items-center">
														<span><i class="fas fa-car fa-fw text-warning mr-1"></i></span>
														<span class="p-1 text-muted">Garages</span>
														<span class="badge badge-pill badge-success ml-auto">1</span>
													</div>
											...
											<div class="col-md-12">
												<div class="p-1">
													<div class="d-flex no-block align-items-center">
														<div class="avatar avatar-xs mr-4">
															<span class="avatar-letter avatar-letter-d"></span>
														</div>
														<div class="mt-2">
															<h5 class="card-title mb-0">Jon Doe</h5>
															<h6 class="text-muted">5 Property</h6>
					...
					<div class="col-md-6 col-lg-6 col-xlg-4 mb-3">
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center">
										<a href="#">
											<img src="<?php echo base_url() ?>assets/avatars/avatar1.png" alt="user" class="img-fluid">
										</a>
									</div>
									<div class="col-md-8 col-lg-9">
										<h3 class="text-warning mb-0">Johnathan Doe</h3>
						...
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center">
										<a href="#">
											<img src="<?php echo base_url() ?>assets/avatars/avatar2.png" alt="user" class="img-fluid">
										</a>
									</div>
									<div class="col-md-8 col-lg-9">
										<h3 class="text-warning mb-0">Johnathan Doe</h3>
						...
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center">
										<a href="#">
											<img src="<?php echo base_url() ?>assets/avatars/avatar3.png" alt="user" class="img-fluid">
										</a>
									</div>
									<div class="col-md-8 col-lg-9">
										<h3 class="text-warning mb-0">Johnathan Doe</h3>
						...
						<div class="card">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-md-4 col-lg-3 text-center">
										<a href="#">
											<img src="<?php echo base_url() ?>assets/avatars/avatar4.png" alt="user" class="img-fluid">
										</a>
									</div>
									<div class="col-md-8 col-lg-9">
										<h3 class="text-warning mb-0">Johnathan Doe</h3>
