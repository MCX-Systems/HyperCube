			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Box Shadows</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Box Shadow examples</h4>
								<h6 class="card-subtitle">
									Use of <code>z-depth-top-*</code> class
									<code>for box shadows</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-top-0" data-toggle="tooltip" data-placement="top" title=".z-depth-top-0">
							<p class="text-sm-center">Use class <code>z-depth-top-0</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-top-1" data-toggle="tooltip" data-placement="top" title=".z-depth-top-1">
							<p class="text-sm-center ">Use class <code>z-depth-top-1</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-top-2" data-toggle="tooltip" data-placement="top" title=".z-depth-top-2">
							<p class="text-sm-center">Use class <code>z-depth-top-2</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-top-3" data-toggle="tooltip" data-placement="top" title=".z-depth-top-3">
							<p class="text-sm-center">Use class <code>z-depth-top-3</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-top-4" data-toggle="tooltip" data-placement="top" title=".z-depth-top-4">
							<p class="text-sm-center">Use class <code>z-depth-top-4</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-top-5" data-toggle="tooltip" data-placement="top" title=".z-depth-top-5">
							<p class="text-sm-center">Use class <code>z-depth-top-5</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-0" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-0">
							<p class="text-sm-center">Use class <code>z-depth-bottom-0</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-1" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-1">
							<p class="text-sm-center ">Use class <code>z-depth-bottom-1</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-2" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-2">
							<p class="text-sm-center">Use class <code>z-depth-bottom-2</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-3" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-3">
							<p class="text-sm-center">Use class <code>z-depth-bottom-3</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-4" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-4">
							<p class="text-sm-center">Use class <code>z-depth-bottom-4</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-bottom-5" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-bottom-5">
							<p class="text-sm-center">Use class <code>z-depth-bottom-5</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-left-0" data-toggle="tooltip" data-placement="top" title=".z-depth-left-0">
							<p class="text-sm-center">Use class <code>z-depth-left-0</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-left-1" data-toggle="tooltip" data-placement="top" title=".z-depth-left-1">
							<p class="text-sm-center ">Use class <code>z-depth-left-1</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-left-2" data-toggle="tooltip" data-placement="top" title=".z-depth-left-2">
							<p class="text-sm-center">Use class <code>z-depth-left-2</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-left-3" data-toggle="tooltip" data-placement="top" title=".z-depth-left-3">
							<p class="text-sm-center">Use class <code>z-depth-left-3</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-left-4" data-toggle="tooltip" data-placement="top" title=".z-depth-left-4">
							<p class="text-sm-center">Use class <code>z-depth-left-4</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-left-5" data-toggle="tooltip" data-placement="top" title=".z-depth-left-5">
							<p class="text-sm-center">Use class <code>z-depth-left-5</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-right-0" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-0">
							<p class="text-sm-center">Use class <code>z-depth-right-0</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-right-1" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-1">
							<p class="text-sm-center ">Use class <code>z-depth-right-1</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-right-2" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-2">
							<p class="text-sm-center">Use class <code>z-depth-right-2</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-right-3" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-3">
							<p class="text-sm-center">Use class <code>z-depth-right-3</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-right-4" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-4">
							<p class="text-sm-center">Use class <code>z-depth-right-4</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-right-5" data-toggle="tooltip" data-placement="top"
						     title=".z-depth-right-5">
							<p class="text-sm-center">Use class <code>z-depth-right-5</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-0" data-toggle="tooltip" data-placement="top" title=".z-depth-0">
							<p class="text-sm-center">Use class <code>z-depth-0</code> inside div element to add box-shadow.
							</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-1" data-toggle="tooltip" data-placement="top" title=".z-depth-1">
							<p class="text-sm-center ">Use class <code>z-depth-1</code> inside div element to add
								box-shadow.</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-2" data-toggle="tooltip" data-placement="top" title=".z-depth-2">
							<p class="text-sm-center">Use class <code>z-depth-2</code> inside div element to add box-shadow.
							</p>
						</div>
					</section>
					...
					<section class="col-lg-4">
						<div class="p-5 z-depth-3" data-toggle="tooltip" data-placement="top" title=".z-depth-3">
							<p class="text-sm-center">Use class <code>z-depth-3</code> inside div element to add box-shadow.
							</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-4" data-toggle="tooltip" data-placement="top" title=".z-depth-4">
							<p class="text-sm-center">Use class <code>z-depth-4</code> inside div element to add box-shadow.
							</p>
						</div>
					</section>

					<section class="col-lg-4">
						<div class="p-5 z-depth-5" data-toggle="tooltip" data-placement="top" title=".z-depth-5">
							<p class="text-sm-center">Use class <code>z-depth-5</code> inside div element to add box-shadow.
							</p>
						</div>
					</section>
