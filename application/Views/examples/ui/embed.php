			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title text-warning">Embed element examples</h4>
								<h6 class="card-subtitle mb-2 text-muted">Use of
									<code>extended</code> bootstrap 4 <code>embed</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold no-margin-top">Youtube 21:9 ratio</h6>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold no-margin-top">Youtube 16:9 ratio</h6>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold">Youtube 4:3 ratio</h6>
								<div class="embed-responsive embed-responsive-4by3">
									<iframe allowfullscreen
									        class="embed-responsive-item" frameborder="0"
									        src="https://www.youtube.com/embed/IyTv_SR2uUo"></iframe>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold mt-0">Vimeo 16:9 ratio</h6>
								<div class="embed-responsive embed-responsive-16by9">
									<iframe allowfullscreen class="embed-responsive-item"
									        frameborder="0" src="https://player.vimeo.com/video/195944915"></iframe>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold mt-o">Vimeo 4:3 ratio</h6>
								<div class="embed-responsive embed-responsive-4by3">
									<iframe allowfullscreen class="embed-responsive-item"
									        frameborder="0" src="https://player.vimeo.com/video/195444476"></iframe>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold mt-0">IMDB 16:9 ratio</h6>
								<div class="embed-responsive embed-responsive-16by9">
									<iframe class="embed-responsive-item"
									        frameborder="0" src="http://www.imdb.com/videoembed/vi1942205977"></iframe>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h6 class="text-semibold mt-0">IMDB 4:3 ratio</h6>
								<div class="embed-responsive embed-responsive-4by3">
									<iframe class="embed-responsive-item"
									        frameborder="0" src="http://www.imdb.com/videoembed/vi338798873"></iframe>
								</div>
							</div>
						</div>
					</section>
