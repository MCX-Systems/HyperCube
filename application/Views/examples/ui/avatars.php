			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Avatar examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4
									<code>avatars</code>.
								</h6>
							</div>
						</div>
					...
					<section class="col-md-12">
						<div class="d-flex justify-content-start">
							<div class="textAvatar mr-3" style="width: 120px; background: orangered;" data-name="Steve Rogers" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 100px; background: #00c800;" data-name="Tony Stark" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 80px;" data-name="Thor Odinson" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 40px; background: deepskyblue" data-name="Loki Laufeyson" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 120px; background: orangered;" data-name="Steve" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 100px; background: #00c800;" data-name="Tony" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 80px;" data-name="Odinson" data-toggle="textavatar"></div>
							<div class="textAvatar mr-3" style="width: 40px; background: deepskyblue" data-name="Loki" data-toggle="textavatar"></div>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						...
						<div class="avatar avatar-lg mr-4">
							<span class="avatar-letter avatar-letter-c"></span>
						</div>

						<div class="avatar avatar-md mr-4">
							<span class="avatar-letter avatar-letter-t"></span>
						</div>

						<div class="avatar avatar-sm mr-4">
							<span class="avatar-letter avatar-letter-p"></span>
						</div>

						<div class="avatar avatar-xs mr-4">
							<span class="avatar-letter avatar-letter-o"></span>
						</div>
					</section>

					<section class="col-md-12 mb-3">
						<div class="avatar avatar-rect mr-4">
							<span class="avatar-letter avatar-letter-i"></span>
						</div>

						<div class="avatar avatar-lg avatar-rect mr-4">
							<span class="avatar-letter avatar-letter-j"></span>
						</div>

						<div class="avatar avatar-md avatar-rect mr-4">
							<span class="avatar-letter avatar-letter-w"></span>
						</div>

						<div class="avatar avatar-sm avatar-rect mr-4">
							<span class="avatar-letter avatar-letter-q"></span>
						</div>

						<div class="avatar avatar-xs avatar-rect mr-4">
							<span class="avatar-letter avatar-letter-x"></span>
						</div>
					</section>

					<section class="col-md-12 mb-3">
						<div class="avatar avatar-round mr-4">
							<span class="avatar-letter avatar-letter-a"></span>
						</div>

						<div class="avatar avatar-lg avatar-round mr-4">
							<span class="avatar-letter avatar-letter-b"></span>
						</div>

						<div class="avatar avatar-md avatar-round mr-4">
							<span class="avatar-letter avatar-letter-d"></span>
						</div>

						<div class="avatar avatar-sm avatar-round mr-4">
							<span class="avatar-letter avatar-letter-l"></span>
						</div>

						<div class="avatar avatar-xs avatar-round mr-4">
							<span class="avatar-letter avatar-letter-m"></span>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						<div class="avatar mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar2.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar3.png" class="img-fluid" alt="Avatar Example" />
						</div>
						...
						<div class="avatar avatar-sm mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar5.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-xs mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar6.png" class="img-fluid" alt="Avatar Example" />
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						...
						<div class="avatar avatar-rect avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar3.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-rect avatar-md mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar4.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-rect avatar-sm mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar5.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-rect avatar-xs mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar6.png" class="img-fluid" alt="Avatar Example" />
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						...
						<div class="avatar avatar-round avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar3.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-round avatar-md mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar4.png" class="img-fluid" alt="Avatar Example" />
						</div>
						...
						<div class="avatar avatar-round avatar-xs mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar6.png" class="img-fluid" alt="Avatar Example" />
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar1.png" class="img-fluid" alt="Avatar Example" />
						</div>
						...
						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar7.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar8.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar9.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar10.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar11.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar12.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar13.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar14.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar15.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar16.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar17.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar18.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar19.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar20.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar21.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar22.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar23.png" class="img-fluid" alt="Avatar Example" />
						</div>

						<div class="avatar avatar-lg mr-4">
							<img src="<?php echo base_url() ?>assets/Avatars/avatar24.png" class="img-fluid" alt="Avatar Example" />
						</div>
					</section>
