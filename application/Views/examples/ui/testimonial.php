			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Testimonials examples</h4>
								<h6 class="card-subtitle">Use of <code>.testimonial</code> class.</h6>
							</div>
						</div>
					</section>
					...
					<div class="col-sm-6">
						<div class="testimonial testimonial-default">
							<div class="testimonial-section">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
								<img src="<?php echo base_url() ?>assets/Avatars/avatar14.png" class="img-fluid" alt="Avatar Example" />
								<div class="testimonial-writer">
									<div class="testimonial-writer-name">Fredi Forič</div>
					...
					<div class="col-sm-6">
						<div class="testimonial">
							<div class="testimonial-section bg-primary">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
					...
					<div class="col-sm-6">
						<div class="testimonial">
							<div class="testimonial-section bg-info">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
					...
					<div class="col-sm-6">
						<div class="testimonial">
							<div class="testimonial-section bg-success">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
					...
					<div class="col-sm-6">
						<div class="testimonial">
							<div class="testimonial-section bg-warning">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
					...
					<div class="col-sm-6">
						<div class="testimonial">
							<div class="testimonial-section bg-danger">
								Denim you probably haven't heard of. Lorem ipsum dolor met consectetur adipisicing sit amet,
								consectetur adipisicing elit, of them jean shorts sed magna aliqua. Lorem ipsum dolor met.
							</div>
							<div class="testimonial-desc">
