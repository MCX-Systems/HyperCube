			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<ul class="list-feed list-feed-rhombus">
									<li>
										<a href="#">David Linner</a> requested refund for a double bank card charge
									</li>
						...
						<div class="card mb-3">
							<div class="card-body">
								<ul class="list-feed list-feed-time">
									<li>
										<span class="feed-time text-warning">12:47</span>
										<a href="#">David Linner</a> requested refund for a double bank card charge
									</li>

									<li>
										<span class="feed-time text-warning">10:25</span>
										User <a href="#">Christopher Wallace</a> from Google is awaiting for staff reply
									</li>

									<li>
										<span class="feed-time text-warning">09:37</span>
										Ticket <strong>#43683</strong> has been resolved by <a href="#">Victoria Wilson</a>
									</li>

									<li>
										<span class="feed-time text-warning">08:28</span>
										<a href="#">Eugene Kopyov</a> merged <strong>Master</strong>, <strong>Demo</strong> and <strong>Dev</strong> branches
									</li>

									<li>
										<span class="feed-time text-warning">07:58</span>
										All sellers have received payouts for December, 2016!
									</li>

									<li>
										<span class="feed-time text-warning">06:32</span>
										<a href="#">Chris Arney</a> created a new ticket <strong>#43136</strong> and assigned to <a href="#">John Nod</a>
									</li>
								</ul>
							</div>
							...
							<div class="card-body">
								<ul class="list-feed media-list">
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">12:47</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">10:25</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">09:37</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">08:28</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">07:58</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-warning text-size-small">06:32</div>
									</li>
								</ul>
							</div>
						</div>
