			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Forms examples</h4>
					...
					<section class="col-md-12">
						<a href="<?php echo base_url() ?>examples/formsLayouts" class="btn btn-info btn-md">Forms Layouts Examples</a>
						<a href="<?php echo base_url() ?>examples/formsWizards" class="btn btn-info btn-md">Forms Wizards Examples</a>
					</section>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Single select</span>
							</div>

							<div class="card-body">
								<div class="form-group">
									<label>Basic select</label>
									<select class="select2" title="">
								...
								<div class="form-group">
									<label class="display-block">Fixed select width</label>
									<select class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									...
									<select data-placeholder="Select a State..." class="select2" title="">
										<option></option>
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									...
									<select class="select2" disabled="disabled" title="">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
								...
								<div class="form-group">
									<label class="display-block">Select background color</label>
									<select class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									<label class="display-block">Menu background color</label>
									<select class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									<label class="display-block">Custom color</label>
									<select class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									<label class="display-block">Custom border and text color</label>
									<select class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Multiple select</span>
							</div>

							<div class="card-body">
								<div class="form-group">
									<label>Multiple select</label>
									<select multiple="multiple" class="select2" title="">
										<optgroup label="Mountain Time Zone">
								...
								<div class="form-group">
									<label class="display-block">Fixed width select</label>
									<select multiple="multiple" class="select2" title="">
										<optgroup label="Mountain Time Zone">
											<option value="AZ" selected="selected">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									...
									<select data-placeholder="Select a State..." multiple="multiple" class="select2" title="">
										<option></option>
										<optgroup label="Mountain Time Zone">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
								...
								<div class="form-group">
									...
									<select multiple="multiple" data-placeholder="Select a state..." class="select2" title="">
										<optgroup label="Services">
											<option value="wordpress2" data-icon="wordpress2">Wordpress</option>
											<option value="tumblr2" data-icon="tumblr2">Tumblr</option>
											<option value="stumbleupon" data-icon="stumbleupon">Stumble upon</option>
								...
								<div class="form-group">
									...
									<select class="select2" multiple="multiple" title="">
										<option value="AZ" selected="selected">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
								...
								<div class="form-group">
									<label>Disabled select</label>
									<select multiple="multiple" class="select2" disabled="disabled" title="">
										<option value="AZ" selected="selected">Arizona</option>
										<option value="CO">Colorado</option>
					...
					<script type="text/javascript">
						...
						var countries = new Bloodhound({
							...
							prefetch: global_base_url + 'uploads/test/countries.json'
						});
						...
						var nflTeams = new Bloodhound({
							...
							prefetch: global_base_url + 'uploads/test/nfl.json'
						});
						...
						var nbaTeams = new Bloodhound({
							datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
							queryTokenizer: Bloodhound.tokenizers.whitespace,
							prefetch: global_base_url + 'uploads/test/nba.json'
						});

						var nhlTeams = new Bloodhound({
							datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
							queryTokenizer: Bloodhound.tokenizers.whitespace,
							prefetch: global_base_url + 'uploads/test/nhl.json'
						});
							...
							<div class="card-body">
								...
								<form id="needs-validation" novalidate>
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="text" class="form-control" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="email" name="email" class="form-control" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="password" name="password" class="form-control" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="password" name="password2" class="form-control" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="maxChar" class="form-control" required maxlength="10" title=""/>
										</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="minChar" class="form-control" required minlength="6" title=""/>
										</div>
										<div class="form-control-feedback">
											<small>Add <code>minlength="6"</code> attribute for minimum number of characters to accept.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="number" name="onlyNum" class="form-control" required title=""/>
										</div>
									</div>

									<div class="form-group">
										<h5>Maximum Number <span class="text-danger">*</span></h5>
										<input type="number" name="maxNum" class="form-control" required max="25" title=""/>
										<div class="form-control-feedback">
											<small><i>Must be lower than 25</i></small> - <small>Add <code>max</code> attribute for maximum number to accept.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="number" name="minNum" class="form-control" required min="10" title=""/>
										</div>
										<div class="form-control-feedback">
											<small><i>Must be higher than 10</i></small> - <small>Add <code>min</code> attribute for minimum number to accept.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="text" class="form-control" required minlength="10" maxlength="20" placeholder="Enter chars between 10 &amp; 20" title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="url" class="form-control" placeholder="Add URL" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="date" class="form-control" placeholder="MM/DD/YYYY" required title=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls">
											<select name="select" id="select" required class="form-control" title="">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-4 mb-3">
										...
										<select id='pre-selected-options' multiple='multiple' title="">
									...
									<div class="col-md-3">
										...
										<select multiple id="optgroup" name="optgroup[]" title="">
									...
									<div class="col-md-4">
										...
										<select multiple id="public-methods" name="public-methods[]" title="">
											<option value="elem_1">elem 1</option>
										...
										<div class="button-box mt-2">
											<a id="select-all" class="btn btn-danger btn-sm" href="#">Select All</a>
											<a id="deselect-all" class="btn btn-info btn-sm" href="#">Deselect All</a>
											<a id="add-option" class="btn btn-success btn-sm" href="#">Add Option</a>
											<a id="refresh" class="btn btn-warning btn-sm" href="#">Refresh</a>
										</div>
									</div>
								</div>
							</div>
					...
					<section class="col-md-12">
									...
									<div class="col-lg-6">
										<form>
											<div class="form-group">
												...
												<input class="vertical-spin" type="text" data-bts-button-down-class="btn btn-info btn-outline" data-bts-button-up-class="btn btn-info btn-outline" value="" name="vertical-spin" title="" />
											</div>

											<div class="form-group">
												<label class="control-label">Postfix</label>
												<input id="tch1" type="text" value="55" name="tch1" data-bts-button-down-class="btn btn-info btn-outline" data-bts-button-up-class="btn btn-info btn-outline" title="" />
											</div>

											<div class="form-group">
												<label class="control-label">Prefix</label>
												<input id="tch2" type="text" value="0" name="tch2" class=" form-control" data-bts-button-down-class="btn btn-info btn-outline" data-bts-button-up-class="btn btn-info btn-outline" title="" />
											</div>
										</form>
									</div>
									...
									<div class="col-lg-6">
										<form>
											<div class="form-group">
												...
												<input id="tch3" type="text" value="" name="tch3" data-bts-button-down-class="btn btn-success btn-outline" data-bts-button-up-class="btn btn-success btn-outline" title="" />
											</div>

											<div class="form-group">
												<label class="control-label">Value set 30 </label>
												<input id="tch4" type="text" value="30" name="tch4" data-bts-button-down-class="btn btn-danger btn-outline" data-bts-button-up-class="btn btn-danger btn-outline" title="" />
											</div>

											<div class="form-group">
												<label class="control-label">Button group</label>
												<div class="input-group">
													<input id="tch5" type="text" class="form-control" name="tch5" value="50" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" title="" />
												</div>
											</div>
										</form>
									</div>
						...
						<script type="text/javascript">
							jQuery(function () {
								...
								if (vspinTrue) {
									vspinTrue.prev('.bootstrap-touchspin-prefix').remove();
								}
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">MaxLength Examples</h4>
								...
								<form class="form">
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input class="form-control textLimiter" maxlength="3" placeholder="" type="text" />
											<span class="badge badge-warning">The badge will show up by default when the remaining chars are 3 or less</span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input class="form-control textLimiter" maxlength="7" placeholder="" type="text" />
											<span class="badge badge-warning">Set threshold value to show there are 5 chars or less</span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input class="form-control textLimiter" maxlength="6" placeholder="" type="text" />
											<span class="badge badge-warning">Show the counter on input focus</span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input class="form-control textLimiter" maxlength="8" placeholder="" type="text" />
											<span class="badge badge-warning">Display custom text on input focus</span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<textarea class="form-control textLimiter" maxlength="8" placeholder="" rows="6"></textarea>
											<span class="badge badge-warning">Bootstrap maxlength supports textarea as well as inputs</span>
										</div>
									</div>
								</form>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Password Strenth</h4>
								<h6 class="card-subtitle">Automaticall password strenth meter and generator.</h6>

								<form role="form">
									<div class="form-group">
										<label for="password">Password</label>
										<input name="password" type="password" class="form-control" placeholder="Password" aria-label="" aria-describedby="basic-addon1"/>
										<div class="pwstrength_viewport_progress pl-1 pr-1"></div>
									</div>

									<div class="form-group">
										<label for="password1">Password Second</label>
										<input name="password1" type="password" class="form-control" placeholder="Password1" aria-label="" aria-describedby="basic-addon1"/>
										<div class="pwstrength_viewport_progress pl-1 pr-1"></div>
									</div>

									<div class="form-group">
										<label for="password2">Password Third</label>
										<div class="input-group">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fas fa-lock"></i></span>
											</div>
											<input name="password2" type="password" class="form-control" placeholder="Password2" aria-label="" aria-describedby="basic-addon1"/>
										</div>
									</div>

									<div class="form-group">
										<label for="GeneratedPassword">Password Generated</label>
										<div class="input-group">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fas fa-lock"></i></span>
											</div>
											<input id="GeneratedPassword" name="GeneratedPassword" type="text" class="form-control" placeholder="Generate your password" aria-label="" aria-describedby="basic-addon1"/>
											<div class="input-group-append">
												<button id="passwordGenerate" class="btn btn-info" type="button">Generate Password</button>
											</div>
										</div>
									</div>
								</form>
							...
							<div class="card-body">
								...
								<div class="tags-default">
									<div class="input-group">
										...
										<input type="text" value="Amsterdam,Washington,Sydney" data-role="tagsinput" placeholder="Add Tags" aria-label="" aria-describedby="basic-addon1"/>
									</div>
								</div>

								<h4 class="card-title mt-3">Select Tags</h4>
								<h6 class="card-subtitle">You can also use <code>select multiple</code> to your input field.</h6>

								<select multiple data-role="tagsinput" title="">
									<option value="Amsterdam">Amsterdam</option>
									<option value="Washington">Washington</option>
									<option value="Sydney">Sydney</option>
								</select>

								<h4 class="card-title mt-3">Input Group Tags</h4>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h3 class="box-title">Input States</h3>
								<p class="text-muted mb-3">Validation styles for error, warning, and success states on form controls.</p>
								...
								<div class="row">
									<div class="col-md-6">
										<form class="form-horizontal row" role="form">
											<div class="col-md-4">
												<div class="form-group has-success">
													<h5>Success</h5>
													<input class="form-control form-control-success-icon" id="username" type="text" title="" aria-label="" aria-describedby="basic-addon1"/>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group has-warning">
													<h5>Warning</h5>
													<input class="form-control form-control-warning-icon" id="password" type="password" title="" aria-label="" aria-describedby="basic-addon1"/>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group has-danger">
													<h5>Danger</h5>
													<input class="form-control form-control-danger-icon" id="phone" type="tel" title="" aria-label="" aria-describedby="basic-addon1"/>
												</div>
											</div>
											...
											<div class="col-12">
												<div class="form-group has-success">
													...
													<input type="text" class="form-control form-control-success" id="inputSuccess1" aria-label="" aria-describedby="basic-addon1"/>
												...
												<div class="form-group has-warning">
													...
													<input type="text" class="form-control form-control-warning" id="inputWarning1" aria-label="" aria-describedby="basic-addon1"/>
												...
												<div class="form-group has-danger">
													...
													<input type="text" class="form-control form-control-danger" id="inputDanger1" aria-label="" aria-describedby="basic-addon1"/>
										...
										<form class="form-horizontal" role="form">
											<div class="form-group row has-success">
												...
												<div class="col-sm-10">
													<input type="email" class="form-control form-control-success" id="inputHorizontalSuccess" placeholder="name@example.com" aria-label="" aria-describedby="basic-addon1"/>
													<div class="form-control-feedback">Success! You've done it.</div>
													<small class="form-text text-muted">Example help text that remains unchanged.</small>
												</div>
											</div>
											...
											<div class="form-group row has-warning">
												...
												<div class="col-sm-10">
													<input type="email" class="form-control form-control-warning" id="inputHorizontalWarning" placeholder="name@example.com" aria-label="" aria-describedby="basic-addon1"/>
													<div class="form-control-feedback">Shucks, check the formatting of that and try again.</div>
													<small class="form-text text-muted">Example help text that remains unchanged.</small>
												</div>
											</div>
											...
											<div class="form-group row has-danger">
												...
												<div class="col-sm-10">
													<input type="email" class="form-control form-control-danger" id="inputHorizontalDnger" placeholder="name@example.com" aria-label="" aria-describedby="basic-addon1"/>
													<div class="form-control-feedback">Sorry, that username's taken. Try another?</div>
													<small class="form-text text-muted">Example help text that remains unchanged.</small>
												</div>
											</div>
									...
									<div class="col-md-6">
										<form role="form" class="form-horizontal row">
											<div class="col-12">
												<div class="form-group">
													<label class="col-md-3 form-control-label" for="example-input-small">Small</label>
													<div class="col-md-6">
														<input type="text" id="example-input-small" name="example-input-small" class="form-control form-control-sm" placeholder="form-control-sm" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-3 form-control-label" for="example-input-normal">Normal</label>
													<div class="col-md-6">
														<input type="text" id="example-input-normal" name="example-input-normal" class="form-control" placeholder="Normal" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-3 form-control-label" for="example-input-large">Large</label>
													<div class="col-md-6">
														<input type="text" id="example-input-large" name="example-input-large" class="form-control form-control-lg" placeholder="form-control-lg" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-3 form-control-label">Grid Sizes</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder=".col-4" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>

												<div class="form-group">
													<div class="col-md-5">
														<input type="text" class="form-control" placeholder=".col-5" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>

												<div class="form-group">
													<div class="col-md-6">
														<input type="text" class="form-control" placeholder=".col-6" aria-label="" aria-describedby="basic-addon1"/>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<input name="example-disabled" disabled="" class="form-control" id="example-disabled" type="text" placeholder="Disabled"/>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<textarea name="example-textarea-input" class="form-control" id="example-textarea-input" placeholder="Description.." rows="7"></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<select name="example-multiple-select" class="form-control" id="example-multiple-select" size="5" multiple="">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12">
										<form>
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" title=""/>
											</div>

											<div class="input-group mb-3">
												<input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" title=""/>
												<div class="input-group-append">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" title=""/>
											</div>
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" title=""/>
												<div class="input-group-append">
									...
									<div class="col-md-12">
										<form>
											<label class="control-label mt-2" for="example-input1-group2">Checkboxes and radio addons</label>
											<div class="row">
												<div class="col-md-6">
													<div class="input-group">
														<div class="input-group-prepend">
														...
														<input type="text" class="form-control" aria-label="Text input with checkbox" title=""/>
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="input-group">
														<div class="input-group-prepend">
															<div class="input-group-text">
																<input type="radio" aria-label="Radio button for following text input" title=""/>
															</div>
														</div>
														<input type="text" class="form-control" aria-label="Text input with radio button" title=""/>
													</div>
												</div>
											</div>

											<label class="control-label mt-2" for="example-input1-group2">Multiple addons</label>
											<div class="row">
												<div class="col-md-6">
													<div class="input-group">
														<div class="input-group-prepend">
									...
									<div class="col-md-12">
										<form class="input-form">
											<label class="control-label mt-2" for="example-input1-group2">Button addons</label>
											<div class="row">
												<div class="col-md-6">
													<div class="input-group mb-3">
														<div class="input-group-prepend">
														...
														<input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" title=""/>
													</div>
												</div>
									...
									<div class="col-md-12">
										<label class="control-label mt-2" for="example-input1-group2">Dropdown addons</label>
										<form class="input-form">
											<div class="row">
												<div class="col-md-6">
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control" aria-label="Text input with dropdown button" title="">
													</div>
												</div>
