		...
		<div class="main-scroller">
			<div class="row main-content-box">
				...
				<section class="col-md-12 mb-3">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Alert and Notices examples</h4>
							<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4
								<code>alert and notices</code>.
							</h6>
						</div>
					</div>
				</section>
				...
				<!-- Styled left alerts -->
				<section class="col-md-6">
					<div class="alert alert-primary alert-styled-left" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
						<span class="text-semibold">Morning!</span> We're glad to
						<a href="javascript:void(0);" class="alert-link"> see you again</a> and wish you a nice day.
					</div>
					...
					<div class="alert alert-danger alert-styled-left" role="alert">
						...
						<span class="text-semibold">Oh snap!</span> Change a few things up and
						<a href="javascript:void(0);" class="alert-link"> try submitting again</a>.
					</div>
					...
					<div class="alert alert-success alert-styled-left" role="alert">
						...
						<span class="text-semibold">Well done!</span> You successfully read
						<a href="javascript:void(0);" class="alert-link"> this important</a> alert message.
					</div>
				</section>
				...
				<section class="col-md-6">
					<div class="alert alert-warning alert-styled-left" role="alert">
						...
						<span class="text-semibold">Warning!</span> Better
						<a href="javascript:void(0);" class="alert-link"> check yourself</a>, you're not looking too good.
					</div>
					...
					<div class="alert alert-info alert-styled-left" role="alert">
						...
						<span class="text-semibold">Heads up!</span> This alert needs your attention, but it's not
						<a href="javascript:void(0);" class="alert-link"> super important</a>.
					</div>

					<div class="alert alert-dark alert-styled-left" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
						<span class="text-semibold">Surprise!</span> This is a super-duper nice looking
						<a href="javascript:void(0);" class="alert-link"> alert</a> with custom color.
					</div>
				</section>

				<section class="col-md-6">
					<div class="alert alert-primary alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
					...
					<div class="alert alert-danger alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
					...
					<div class="alert alert-success alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
				...
				<section class="col-md-6">
					<div class="alert alert-warning alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
					...
					<div class="alert alert-info alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
					...
					<div class="alert alert-dark alert-styled-right" role="alert">
						<button type="button" class="close" data-dismiss="alert">
							<span>&times;</span>
							<span class="sr-only">Close</span>
						</button>
				...
				<section class="col-md-6">
					...
					<div class="alert bg-dark" role="alert">
						...
						<span class="text-semibold">Surprise!</span> This is a super-duper nice looking
						<a href="javascript:void(0);" class="alert-link">alert</a> with dark color.
					</div>
				</section>
