			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Typography examples</h4>
								<h6 class="card-subtitle">Use of typography text examples.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						...
						<h6 class="card-subtitle">
							Convey meaning through color with a handful of emphasis utility classes. These may also
							be applied to links and will darken on hover just like our default link styles.
						</h6>
						...
						<div class="table-responsive">
							<table class="table table-lg">
								...
								<tbody>
								<tr>
									<td><span class="text-muted">This is a muted text</span></td>
									<td>For muted text color use <code>.text-muted</code> class</td>
								</tr>
								<tr>
									<td><span class="text-primary">This is a primary text</span></td>
									<td>For primary text color use <code>.text-primary</code> class</td>
								</tr>
								<tr>
									<td><span class="text-danger">This is a danger text</span></td>
									<td>For danger text color use <code>.text-danger</code> class</td>
								</tr>
								<tr>
									<td><span class="text-success">This is a success text</span></td>
									<td>For success text color use <code>.text-success</code> class</td>
								</tr>
								<tr>
									<td><span class="text-warning">This is a warning text</span></td>
									<td>For warning text color use <code>.text-warning</code> class</td>
								</tr>
								<tr>
									<td><span class="text-info">This is a info text</span></td>
									<td>For info text color use <code>.text-info</code> class</td>
								</tr>
								</tbody>
							</table>
						</div>
					...
					<section class="col-md-6">
						<h4 class="card-title">Contextual backgrounds</h4>
						<h6 class="card-subtitle">
						...
						<div class="table-responsive">
							<table class="table table-lg">
								...
								<tbody>
								<tr>
									<td><span class="bg-primary text-highlight">Primary background</span></td>
									<td>For primary background color use <code>.bg-primary</code> class</td>
								</tr>
								<tr>
									<td><span class="bg-danger text-highlight">Danger background</span></td>
									<td>For danger background color use <code>.bg-danger</code> class</td>
								</tr>
								<tr>
									<td><span class="bg-success text-highlight">Success background</span></td>
									<td>For success background color use <code>.bg-success</code> class</td>
								</tr>
								<tr>
									<td><span class="bg-warning text-highlight">Warning background</span></td>
									<td>For warning background color use <code>.bg-warning</code> class</td>
								</tr>
								<tr>
									<td><span class="bg-info text-highlight">Info background</span></td>
									<td>For info background color use <code>.bg-info</code> class</td>
								</tr>
								</tbody>
							</table>
						</div>
					...
					<section class="col-md-12">
						<h4 class="card-title">Text options</h4>
						<h6 class="card-subtitle">
							HyperCube template supports the majority of all possible text
							styling options - weights, sizes, styles and additional elements such as marks,
							abbreviations, keyboard inputs, sample and variable inputs etc. All these stylings
							can be applied any section heading, form components, content and UI elements just by
							adding proper class to the element. Basic text styles are included to BS framework by
							default.
						</h6>
						...
						<div class="table-responsive">
							<table class="table table-lg">
								...
								<tbody>
								<tr>
									<th colspan="3" class="active">Links</th>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>To use a link with custom color link, add <code>.text-teal</code> or any other text color class</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Font weight</th>
								</tr>
								<tr>
									<td>This is a <span class="text-thin">thin text</span></td>
									<td>For thin font weight use <code>.text-thin</code> class</td>
								</tr>
								<tr>
									<td>This is a <span class="text-light">light text</span></td>
									<td>For light font weight use <code>.text-light</code> class</td>
								</tr>
								<tr>
									<td>This is a <span class="text-regular">regular text</span></td>
									<td>For forced regular font weight use <code>.text-regular</code> class</td>
								</tr>
								<tr>
									<td>This is a <span class="text-semibold">semibold text</span></td>
									<td>For semibold font weight use <code>.text-semibold</code> class</td>
								</tr>
								<tr>
									<td>This is a <span class="text-bold">bold text</span></td>
									<td>For bold font weight use <code>.text-bold</code> class</td>
								</tr>
								<tr>
									<td>This is a <span class="text-black">black text</span></td>
									<td>For black font weight use <code>.text-black</code> class</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Font style</th>
								</tr>
								<tr>
									<td>This is an <em>italic text</em></td>
									<td>For italic font style use <code>&lt;em></code> tag</td>
								</tr>
								<tr>
								...
								<tr>
									<th colspan="3" class="active">Font size</th>
								</tr>
								<tr>
									<td><span class="text-size-large">This is a larger text size</span></td>
									<td>For larger text size use <code>.text-size-large</code> class</td>
								</tr>
								<tr>
								...
								<tr>
									<td><span class="text-size-small">This is a smaller text size</span></td>
									<td>For smaller text size use <code>.text-size-small</code> class</td>
								</tr>
								<tr>
									<td><span class="text-size-mini">This is a mini text size</span></td>
									<td>For mini text size use <code>.text-size-mini</code> class</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Text elements</th>
								</tr>
								<tr>
								...
								<tr>
									<th colspan="3" class="active">Text alignment</th>
								</tr>
								<tr>
									<td class="text-left">Left aligned text</td>
									<td>For left text alignment, use <code>.text-left</code> alignment class</td>
								</tr>
								<tr>
									<td class="text-center">Centered text</td>
									<td>For center text alignment, use <code>.text-center</code> alignment class</td>
								</tr>
								<tr>
									<td class="text-right">Right aligned text</td>
									<td>For right text alignment, use <code>.text-right</code> alignment class</td>
								</tr>
								<tr>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Default unordered list</h4>
								<h6 class="card-subtitle mb-3">
									Default unordered list using <code>.list</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle mb-3">
									Unstyled list using <code>.list-unstyled</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Square list type</h4>
								<h6 class="card-subtitle mb-3">
									Square list style using <code>.list-square</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Default ordered list</h4>
								<h6 class="card-subtitle mb-3">
									Default ordered list using <code>.list</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Circle list type</h4>
								<h6 class="card-subtitle mb-3">
									Circle list style using <code>.list-circle</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">List with icons</h4>
								<h6 class="card-subtitle mb-3">
									List with icons using <code>.list-icons</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Condensed list</h4>
								<h6 class="card-subtitle mb-3">
									Condensed list using <code>.list-condensed</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Default list size</h4>
								<h6 class="card-subtitle mb-3">
									Default size using <code>.list</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Extended list</h4>
								<h6 class="card-subtitle mb-3">
									Extended list using <code>.list-extended</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Default inline list</h4>
								<h6 class="card-subtitle mb-3">
									Inline list using <code>.list-inline</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Condensed inline list</h4>
								<h6 class="card-subtitle mb-3">
									Using <code>.list-inline-condensed</code> class.
								</h6>
					...
					<section class="col-md-4">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Separated inline list</h4>
								<h6 class="card-subtitle mb-3">
									Using <code>.list-inline-separate</code> class.
								</h6>
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Vertical description list</h4>
								<h6 class="card-subtitle mb-3">
					...
					<section class="col-md-6">
						<div class="card mb-3">
							<div class="card-body">
								<h4 class="card-title">Horizontal description list</h4>
								<h6 class="card-subtitle mb-3">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6">
										<h4 class="card-title">Example Heading with badges</h4>
										<h6 class="card-subtitle">Use tags <code>h1 to h6</code> for get desire heading.</h6>
										<h1>Example heading <span class="badge badge-dark">New</span></h1>
									...
									<div class="col-md-6">
										<h4 class="card-title">Other elements with heading sizes</h4>
										<h6 class="card-subtitle">Use tags <code>h1 to h6</code> for get desire heading.</h6>
								...
								<pre><code class="text-white-50">&lt;p&gt;Sample text here...&lt;/p&gt;&lt;p&gt;And another line of sample text here...&lt;/p&gt;</code></pre>
								<hr/>
								...
								<div class="well lorem-one"></div>
								<hr/>
								<div class="well lorem-two"></div>
								<hr/>
								<div class="well lorem-three"></div>
								<hr/>
								<div class="well lorem-full"></div>
							</div>
						</div>
					</section>
