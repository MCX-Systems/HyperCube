			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				...
				<div id="topMenu">
					<div class="tm-wrapper">
						<div class="tm-item">
							<a href="#" title="Site Settings" class="text-warning">
								<i class="fas fa-cog"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Arduino Settings" class="text-warning">
								<i class="fas fa-microchip"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Language Settings" class="text-warning">
								<i class="fas fa-language"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Image Settings" class="text-warning">
								<i class="fas fa-camera"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Repair Website" class="text-warning">
								<i class="fas fa-ambulance"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="User Settings" class="text-warning">
								<i class="fas fa-user"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="UserGroup Settings" class="text-warning">
								<i class="fas fa-id-card"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Email Settings" class="text-warning">
								<i class="fas fa-envelope"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Games" class="text-warning">
								<i class="fas fa-gamepad"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Video" class="text-warning">
								<i class="fas fa-video"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Audio" class="text-warning">
								<i class="fas fa-music"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Content" class="text-warning">
								<i class="fas fa-newspaper"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Sharing" class="text-warning">
								<i class="fas fa-share-alt-square"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Uploads" class="text-warning">
								<i class="fas fa-upload"></i>
							</a>
						</div>

						<div class="tm-item">
							<a href="#" title="Manage Google Ads" class="text-warning">
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Forms Layouts examples</h4>
								<h6 class="card-subtitle">
									Use of <code>extended</code> bootstrap 4
									<code> form layouts</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Horizontal row labels</span>
							</div>
							...
							<div class="card-body">
								<form action="#">
									...
									<div class="text-right">
										<button type="submit" class="btn btn-primary">Submit form <i class="fas fa-arrow-right fa-fw float-right ml-2"></i></button>
									</div>
								</form>
							</div>
						</div>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Horizontal input labels</span>
							</div>
							...
							<div class="card-body">
								<form action="#">
									<div class="form-group row">
										<div class="col-md-2">
											<div class="row">
												<label class="col-md-4 col-form-label text-right">Label: </label>
												<div class="col-md-8">
													<input type="text" class="form-control" placeholder="col-md-2">
												</div>
											</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Vertical row label</span>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Vertical input label</span>
							</div>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Centered form</span>
								</div>
									...
									<div class="row">
										...
										<div class="col-md-10 col-md-offset-1">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="Davorin Casar" />
											</div>
											...
											<div class="form-group">
												<label>Select your state:
													<select title="Select your state" data-placeholder="Select your state" class="select2">
														<option></option>
											...
											<div class="form-group">
												<label class="text-warning">Attach screenshoot:</label>
												<input type="file" class="form-control" />
												<small class="form-text text-muted">Accepted formats: gif, png, jpg. Max file size 2Mb</small>
											</div>
						...
						<form action="#">
							<div class="row">
								...
								<div class="col-md-10 col-md-offset-1">
									<div class="card">
										<div class="card-header">
											<span class="card-title">Centered panel</span>
										</div>
										...
										<div class="card-body">
											...
											<div class="form-group">
												<label>Select your state:
													<select data-placeholder="Select your state" class="select2">
														<option></option>
														<optgroup label="Alaskan/Hawaiian Time Zone">
															<option value="AK">Alaska</option>
															<option value="HI">Hawaii</option>
											...
											<div class="form-group">
												<label class="text-warning">Attach ScreenShot:</label>
												<input type="file" class="form-control" />
												<small class="form-text text-muted">Accepted formats: gif, png, jpg. Max file size 2Mb</small>
											</div>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Basic legend</span>
								</div>

								<div class="card-body">
									<fieldset>
										<legend class="text-semibold text-warning">Enter your information</legend>
									...
									<fieldset>
										<legend class="text-semibold text-warning">Add personal details</legend>
										<div class="form-group">
											<label>Your country:
												<select data-placeholder="Select your country" class="select2">
										...
										<div class="form-group form-radio">
											<div class="radio radiofill radio-primary">
												Gender:
												<label>
													<input name="gender2" type="radio" checked="checked" />
													<i class="helper"></i>Male
												</label>
												<label>
													<input name="gender2" type="radio" />
										...
										<div class="form-group">
											...
											<input type="file" class="form-control" />
											<small class="form-text text-muted">Accepted formats: pdf, doc. Max file size 2Mb</small>
										</div>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Advanced legend</span>
								</div>

								<div class="card-body">
									<fieldset>
										<legend class="text-semibold text-warning">
											<i class="fas fa-file float-left mr-2"></i>
											Enter your information
											<a href="#demo1" class="control-arrow" data-toggle="collapse" data-target="#demo1" aria-expanded="true" aria-controls="demo1">
									...
									<fieldset>
										<legend class="text-semibold text-warning">
											<i class="fas fa-user float-left mr-2"></i>
											Add personal details
											<a href="#demo2" class="control-arrow" data-toggle="collapse" data-target="#demo2" aria-expanded="false" aria-controls="demo2">
												<i class="fas fa-arrow-circle-down fa-fw"></i>
											</a>
										</legend>
										...
										<div id="demo2" class="collapse">
											...
											<div class="form-group form-radio">
												<div class="radio radiofill radio-primary">
													Gender:
													<label>
														<input name="gender3" type="radio" checked="checked" />
														<i class="helper"></i>Male
													</label>
													<label>
														<input name="gender3" type="radio" />
														<i class="helper"></i>Female
													</label>
												</div>
											</div>
					...
					<section class="col-md-12">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Multiple columns</span>
								</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
											<fieldset>
												<legend class="text-semibold text-warning"><i class="fas fa-user fa-fw float-left mr-2"></i>Personal details</legend>
										...
										<div class="col-md-6">
											<fieldset>
												<legend class="text-semibold text-warning"><i class="fas fa-truck fa-fw float-left mr-2"></i> Shipping details</legend>

												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label>First name:</label>
															<input type="text" placeholder="Davorin" class="form-control" />
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" placeholder="Casar" class="form-control" />
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label>Email:</label>
															<input type="text" placeholder="test@example.com" class="form-control" />
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" placeholder="Prekmurje" class="form-control" />
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" placeholder="9000" class="form-control" />
														</div>
													</div>
													...
													<div class="col-md-3">
														<div class="form-group">
															<label>City:</label>
															<input type="text" placeholder="Murska Sobota" class="form-control" />
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" placeholder="Partizanska 34" class="form-control" />
														</div>
													</div>
												</div>
									...
									<div class="text-right">
										<button type="submit" class="btn btn-primary">Submit form <i class="fas fa-arrow-right float-right ml-2"></i></button>
									</div>
								</div>
							</div>
						</form>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Centered Inline form</span>
								</div>
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<label for="state2" class="col-lg-3 col-form-label">Select your state:</label>
										<div class="col-lg-9">
											<select id="state2" data-placeholder="Select your state" class="select2">
												<option></option>
												<optgroup label="Alaskan/Hawaiian Time Zone">
													<option value="AK">Alaska</option>
													<option value="HI">Hawaii</option>
						...
						<form action="#">
							<div class="row">
								...
								<div class="col-md-10 col-md-offset-1">
									<div class="card">
										<div class="card-header">
											<span class="card-title">Centered inline panel</span>
										</div>
										...
										<div class="card-body">
											...
											<div class="form-group row">
												<label for="state1" class="col-lg-3 col-form-label">Select your state:</label>
												<div class="col-lg-9">
													<select id="state1" data-placeholder="Select your state" class="select2">
														<option></option>
														<optgroup label="Alaskan/Hawaiian Time Zone">
															<option value="AK">Alaska</option>
															<option value="HI">Hawaii</option>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Basic inline legend</span>
								</div>
								...
								<div class="card-body">
									...
									<fieldset>
										...
										<div class="form-group row">
											<label for="country1" class="col-lg-3 col-form-label">Your country:</label>
											<div class="col-lg-9">
												<select id="country1" data-placeholder="Select your country" class="select2">
													<option value="Slovenija" selected>Slovenija</option>
													<option value="United Kingdom">United Kingdom</option>
													<option value="...">...</option>
													<option value="Australia">Australia</option>
										...
										<div class="form-group row">
											<label for="state3" class="col-lg-3 col-form-label">Select your state:</label>
											<div class="col-lg-9">
												<select id="state3" data-placeholder="Select your state" class="select2">
													<option></option>
													<optgroup label="Alaskan/Hawaiian Time Zone">
														<option value="AK">Alaska</option>
														<option value="HI">Hawaii</option>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 form-radio">
												<div class="radio radio-inline radiofill radio-primary">
													<label>
														<input name="gender3" type="radio" checked="checked" />
														<i class="helper"></i>Male
													</label>
					...
					<section class="col-md-6">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Advanced inline legend</span>
								</div>
								...
								<div class="card-body">
									<fieldset>
										<legend class="text-semibold text-warning">
											<i class="fas fa-user float-left mr-2"></i>
											Enter your information
											<a href="#demo3" class="control-arrow" data-toggle="collapse" data-target="#demo3" aria-expanded="true" aria-controls="demo3">
												<i class="fas fa-arrow-circle-down fa-fw"></i>
											</a>
										</legend>
									...
									<fieldset>
										<legend class="text-semibold text-warning">
											<i class="fas fa-user float-left mr-2"></i>
											Add personal details
											<a href="#demo4" class="control-arrow" data-toggle="collapse" data-target="#demo4" aria-expanded="false" aria-controls="demo4">
												<i class="fas fa-arrow-circle-down fa-fw"></i>
											</a>
										</legend>
										...
										<div id="demo4" class="collapse">
											<div class="form-group row">
												<label for="country2" class="col-lg-3 col-form-label">Your country:</label>
												<div class="col-lg-9">
													<select id="country2" data-placeholder="Select your country" class="select2">
														<option value="Slovenija" selected>Slovenija</option>
														<option value="United Kingdom">United Kingdom</option>
														<option value="...">...</option>
														<option value="Australia">Australia</option>
											...
											<div class="form-group row">
												<label for="state4" class="col-lg-3 col-form-label">Select your state:</label>
												<div class="col-lg-9">
													<select id="state4" data-placeholder="Select your state" class="select2">
														<option></option>
														<optgroup label="Alaskan/Hawaiian Time Zone">
															<option value="AK">Alaska</option>
															<option value="HI">Hawaii</option>
					...
					<section class="col-md-12">
						<form action="#">
							<div class="card">
								<div class="card-header">
									<span class="card-title">Inline Multiple columns</span>
								</div>
									...
									<div class="row">
										<div class="col-md-6">
											<fieldset>
												...
												<div class="form-group row">
													<label for="state5" class="col-lg-3 col-form-label">Select your state:</label>
													<div class="col-lg-9">
														<select id="state5" data-placeholder="Select your state" class="select2">
															<option></option>
															<optgroup label="Alaskan/Hawaiian Time Zone">
																<option value="AK">Alaska</option>
																<option value="HI">Hawaii</option>
															...
															<div class="col-md-6 mb-3">
																<label>
																	<select data-placeholder="Select your country" class="select2">
																		...
																		<option value="2" selected>Slovenija</option>
									...
									<form class="form">
										<div class="form-body">
											<h4 class="form-section text-warning">
												<i class="fas fa-user ml-1 mr-3"></i>Personal Info
											</h4>
											...
											<h4 class="form-section text-warning">
												<i class="fas fa-check-circle ml-1 mr-3"></i> Requirements
											</h4>
							...
							<div class="card-content">
								<div class="card-body">
									<form class="form">
										<div class="form-body">
											<h4 class="form-section text-warning">
												<i class="fas fa-eye ml-1 mr-3"></i>About User
											</h4>
											...
											<h4 class="form-section text-warning">
												<i class="fas fa-envelope ml-1 mr-3"></i>Contact Info &amp; Bio
											</h4>
