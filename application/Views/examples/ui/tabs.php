			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Tabs examples</h4>
								<h6 class="card-subtitle">Use of vertical and horizontal tabs.</h6>
							</div>
						</div>
					</section>
								...
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#home" role="tab">
											<span class="hidden-sm-up"><i class="fas fa-home mr-2"></i></span>
											<span class="hidden-xs-down">Home</span>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#profile" role="tab">
											<span class="hidden-sm-up"><i class="fas fa-user mr-2"></i></span>
											<span class="hidden-xs-down">Profile</span>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#messages" role="tab">
											<span class="hidden-sm-up"><i class="fas fa-envelope mr-2"></i></span>
					...
					<section class="col-md-12 col-lg-6">
						<div class="card">
							<div class="card-body">
								<!-- Nav tabs -->
								<div class="vertical-tabs customvtab">
									<ul class="nav nav-tabs tabs-vertical" role="tablist">
										<li class="nav-item">
										...
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#messages3" role="tab" aria-expanded="false">
												<span class="hidden-sm-up"><i class="fas fa-envelope mr-2"></i></span>
												<span class="hidden-xs-down">Messages</span>
											</a>
										</li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane pad" id="profile3" role="tabpanel" aria-expanded="false">2
										</div>
										<div class="tab-pane pad" id="messages3" role="tabpanel" aria-expanded="false">3
										</div>
									</div>
								</div>
							</div>
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
											<span class="hidden-sm-up"><i class="fas fa-envelope mr-2"></i></span>
											<span class="hidden-xs-down">Dropdown</span>
										</a>
										<div class="dropdown-menu">
											<a class="dropdown-item" id="dropdown1-tab" href="#dropdown1" role="tab" data-toggle="tab" aria-controls="dropdown1">
												@fat
											</a>
									...
									<div id="navpills-1" class="tab-pane active">
										<div class="row">
											...
											<div class="col-md-8">
												...
												cliche tempor, williamsburg carles vegan helvetica.<br /><br />
												<p>
					...
					<section class="col-md-12 col-lg-6">
						<div class="card">
							<div class="card-body">
								<!-- Nav tabs -->
								<ul class="nav nav-pills justify-content-end mt-1">
									<li class=" nav-item">
										<a href="#navpills2-1" class="nav-link active" data-toggle="tab" aria-expanded="false">
											Tab One
										</a>
									</li>
									<li class="nav-item">
										<a href="#navpills2-2" class="nav-link" data-toggle="tab" aria-expanded="false">
											Tab Two
										</a>
									</li>
									<li class="nav-item">
										<a href="#navpills2-3" class="nav-link" data-toggle="tab" aria-expanded="true">
											Tab Three
										</a>
									</li>
								</ul>
					...
					<section class="col-md-12 col-lg-6">
						<div class="card">
							<div class="card-body">
								<!-- Nav tabs -->
								<div class="vertical-tabs">
									<ul class="nav nav-tabs tabs-vertical tabs-vertical-icons" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#home9" role="tab">
												<span><i class="fas fa-home"></i></span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#profile9" role="tab">
												<span><i class="fas fa-user"></i></span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#messages9" role="tab">
												<span><i class="fas fa-envelope"></i></span>
											</a>
										</li>
									</ul>
