			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Loaders examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4
									<code>pure css3 loaders</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sk-rotating-plane bg-danger"></div>
					</section>

					<section class="col-md-3">
						<div class="sk-double-bounce">
							<div class="sk-child sk-double-bounce1 bg-warning"></div>
							<div class="sk-child sk-double-bounce2 bg-warning"></div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sk-cube-grid">
							<div class="sk-cube sk-cube1 bg-success"></div>
							<div class="sk-cube sk-cube2 bg-success"></div>
							<div class="sk-cube sk-cube3 bg-success"></div>
							<div class="sk-cube sk-cube4 bg-success"></div>
							<div class="sk-cube sk-cube5 bg-success"></div>
							<div class="sk-cube sk-cube6 bg-success"></div>
							<div class="sk-cube sk-cube7 bg-success"></div>
							<div class="sk-cube sk-cube8 bg-success"></div>
							<div class="sk-cube sk-cube9 bg-success"></div>
						</div>
					</section>
