			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Dropdown examples</h4>
								<h6 class="card-subtitle">Use of <code>.counter-value</code> class <code>for counter</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						<h3 class="page-header">Dropdown Basic<small> - Dropdowns are toggleable, contextual overlays for displaying lists of links and more.</small></h3>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										...
										<div class="dropdown dropup">
											<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropup</button>
											<div class="dropdown-menu">
												<a class="dropdown-item" href="#">Action</a>
												<a class="dropdown-item" href="#">Another action</a>
												<a class="dropdown-item" href="#">Something else here</a>
									...
									<div class="col-lg-4">
										...
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle no-caret" type="button" data-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
												<a class="dropdown-item" href="#">Action</a>
												<a class="dropdown-item" href="#">Another action</a>
												<a class="dropdown-item" href="#">Something else here</a>
									...
									<div class="col-lg-4">
										...
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fas fa-cog mr-2"></i> Dropdown</button>
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="#">Action</a>
												<a class="dropdown-item" href="#">Another action</a>
												<a class="dropdown-item" href="#">Something else here</a>
					...
					<section class="col-md-12">
						<h3 class="page-header">Dropdown menu<small> - Dropdowns are toggleable, contextual overlays for displaying lists of links and more.</small></h3>
								...
								<div class="row">
									...
									<div class="col-lg-3">
										...
										<div class="dropdown">
											<button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
												<a class="dropdown-item" href="#"><i class="fas fa-plus"></i> New</a>
									...
									<div class="col-lg-3">
										<hr>
										<h5>Small</h5>
										<p><code>.dropdown-sm</code> applies to <em>.dropdown</em> or <em>.dropup</em></p>
									...
									<div class="col-lg-3">
										<hr>
										<h5>Large</h5>
										<p><code>.dropdown-lg</code> applies to <em>.dropdown</em> or <em>.dropup</em></p>
					...
					<div class="col-lg-4">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-grid">
								...
								<a class="dropdown-item" href="#">
									<span class="icon fas fa-newspaper"></span>
								</a>
								<a class="dropdown-item" href="#">
					...
					<div class="col-lg-4">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-grid">
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/compact_camera.svg" alt="compact_camera.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/stack_of_photos.svg" alt="stack_of_photos.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/folder.svg" alt="folder.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/start.svg" alt="start.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/music.svg" alt="music.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/news.svg" alt="news.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/contacts.svg" alt="contacts.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/download.svg" alt="download.svg"/>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/settings.svg" alt="settings.svg"/>
								</a>
							</div>
						</div>
					...
					<div class="col-lg-4">
						<hr>
						<h5>2 cols</h5>
						<p><code>.cols-2</code> applies to <em>.dropdown-grid</em></p>
					...
					<div class="col-lg-4">
						<hr>
						<h5>4 cols</h5>
						<p><code>.cols-4</code> applies to <em>.dropdown-grid</em></p>
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-grid cols-4">
								...
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/phone.svg" alt="phone.svg"/>
								...
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/calculator.svg" alt="calculator.svg"/>
									<span class="title">Calculator</span>
								</a>
								<a class="dropdown-item" href="#">
									<img class="icon" src="<?php echo base_url() ?>assets/icons/SVG/alarm_clock.svg" alt="alarm_clock.svg"/>
