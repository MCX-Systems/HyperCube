			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Hoverer</li>
					</ul>
				</div>
				<!-- ============================================================== -->
		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-oscar">
							<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="" class="img-fluid" />
							<figcaption>
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-sarah">
							<img src="<?php echo base_url() ?>uploads/pictures/8.jpg" alt="" class="img-fluid" />
							<figcaption>
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-bubba">
							<img src="<?php echo base_url() ?>uploads/pictures/12.jpg" alt="" class="img-fluid" />
							<figcaption>
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-layla">
							<img src="<?php echo base_url() ?>uploads/pictures/21.jpg" alt="" class="img-fluid" />
							<figcaption>
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-ruby">
							<img src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="" class="img-fluid" />
							<figcaption>
					...
					<section class="col-md-4 hoverer">
						<figure class="effect-marley">
							<img src="<?php echo base_url() ?>uploads/pictures/17.jpg" alt="" class="img-fluid" />
							<figcaption>
