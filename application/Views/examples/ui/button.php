				...
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h3 class="card-title">
									<i class="fas fa-building mr-3"></i>Button Builder
								</h3>

								<div class="row">
									<div class="col-md-5">
										<p class="lead">Button Preview and Generated code</p>
										<div class="well">
											<div id="result">
												<div id="button">
													<a href="#" class="btn btn-sm btn-primary">
														<i class="fas fa-check"></i> Default text here
													</a>
												</div>
												<br />
												<p>
													Generated Code
													<textarea id="output" type="text" class="form-control" placeholder="Output" rows="10"></textarea>
												</p>
											</div>
										</div>
										<hr />
									...
									<div class="col-md-7 bg-black">
										<p class="lead">Set Button Text:</p>
										<p id="input">
											<input id="name" autocomplete="off" class="form-control" type="text" placeholder="Please enter your button name" />
										</p>

										<hr />
										<p class="lead">Set Button Color:</p>
										...
										<hr />
										<p class="lead">Set Button Size:</p>
										<div id="sizes">
											<p>
								...
								<div class="row">
									<div class="col-md-12 p-0">
										...
										<div id="icons">
											<div class="row">
												<div class="col-md-9">
													<p class="lead ml-2">Choose and set Button Icon:</p>
												</div>
												<div class="col-md-3">
													Set Icon Position:
													<div id="icon-position" class="btn-group float-right mr-4">
														<button class="btn btn-info btn-sm" value="left" type="button">
															<i class="fas fa-arrow-left"></i> &nbsp; &nbsp;Left
														</button>
														<button class="btn btn-info btn-sm" value="right" type="button">
															Right &nbsp; &nbsp;
											...
											<div class="row">
												<div class="col-md-12 p-0 m-0">
													<ul class="list bs-fas">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-ban-circle fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-circle-arrow-down fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-circle-arrow-left fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-circle-arrow-right fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-circle-arrow-up fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-cloud-upload fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-collapse-down fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-collapse-up fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-compressed fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-copyright-mark fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-cutlery fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-download-alt fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-earphone fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-euro fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-exclamation-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-export fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-eye-close fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-eye-open fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-facetime-video fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-floppy-open fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-floppy-remove fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-floppy-save fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-floppy-saved fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-folder-close fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-fullscreen fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-gbp fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-hand-down fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-hand-left fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-hand-right fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-hand-up fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-hd-video fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-heart-empty fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-indent-left fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-indent-right fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-info-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-log-in fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-log-out fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-magnet fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-minus-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-move fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-new-window fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-off fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-ok fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-ok-circle fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-ok-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-open fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-picture fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-plus-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-pushpin fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-question-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-registration-mark fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-remove-circle fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-remove-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-resize-full fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-resize-horizontal fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-resize-small fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-resize-vertical fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-saved fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-screenshot fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sd-video fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-alphabet fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-alphabet-alt fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-attributes fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-attributes-alt fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-order fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sort-by-order-alt fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sound-5-1 fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sound-6-1 fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sound-7-1 fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sound-dolby fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-sound-stereo fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-star-empty fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-stats fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-subtitles fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-text-height fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-tower fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-transfer fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-tree-conifer fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-tree-deciduous fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-unchecked fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-volume-off fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-warning-sign fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
														...
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-zoom-in fa-fw"></i>
															</a>
														</li>
														<li class="list-inline-item">
															<a href="#" class="btn btn-info">
																<i class="fas fa-zoom-out fa-fw"></i>
															</a>
														</li>
													</ul>
												</div>
						...
						<script type="text/javascript">
							...
							ButtonView = Backbone.View.extend({
								...
								render: function() {
									var e = _.template("<a href=\"#\" class=\"btn<% fullwidth != false ? print(' btn-block') :'' %><% size !=''? print(' '+size) :'' %><% type !=''? print(' '+type) :'' %>\"><% if(iconplacement != 'right') { icon != '' ? print('<i class=\"mr-3 ' + icon + '\"></i> ') : null } %><%= name %><% if(iconplacement == 'right') { icon != '' ? print(' <i class=\"float-right ml-3 '+icon +'\"></i>') : null } %></a>");
									this.$el.find("#button").html(e(this.model.toJSON()));
									this.$el.find("textarea").val(e(this.model.toJSON()))
								}
							});
							...
							IconView = Backbone.View.extend({
								...
								update: function(e) {
									e.preventDefault();
									this.model.set({
										icon: $(e.currentTarget).find("i").attr("class")
									})
								},
							...
							var icons = [];
							$(".bs-fas").children().each(function()
							{
								classstr = $(this).find("a").find("i").attr("class");
								icons.push(classstr)
							});
