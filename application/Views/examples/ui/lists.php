			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Extended Lists</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Extended Lists examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> lists.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<ul class="extended-list">
							<li>
								<div class="extended-item">
									<div class="extended-icon">
										<a href="<?php echo base_url(); ?>uploads/pictures/6.jpg" class="highslide" onclick="return hs.expand(this)">
											<img src="<?php echo base_url(); ?>uploads/pictures/m7.jpg" class="icon" alt="" />
										</a>
									</div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
										<span class="extended-date ml-2 float-left">17.03.2008</span>
										<a href="#" title="sfdsjdkf"><i class="fas fa-check-circle"></i></a>
										<a href="#" title="sfdsjdkffgfgd"><i class="fas fa-remove"></i></a>
										<a href="#" title="sfdsjdkfdfgfdgdgd"><i class="fas fa-info-circle"></i></a>
										<a href="#" title="sfdsjdkfdfgfdgfdgfdgfdg"><i class="fas fa-envelope"></i></a>
									</div>
								</div>
							</li>
							...
							<li>
								<div class="extended-item">
									<div class="extended-icon">
										<a href="<?php echo base_url(); ?>uploads/pictures/8.jpg" class="highslide" onclick="return hs.expand(this)">
											<img src="<?php echo base_url(); ?>uploads/pictures/m3.jpg" class="icon" alt="" />
										</a>
									</div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
										<span class="extended-date ml-2 float-left">17.03.2008</span>
										<a href="#" title="sfdsjdkf"><i class="fas fa-check-circle fa-fw"></i></a>
										<a href="#" title="sfdsjdkffgfgd"><i class="fas fa-remove fa-fw"></i></a>
										<a href="#" title="sfdsjdkfdfgfdgdgd"><i class="fas fa-info-circle fa-fw"></i></a>
										<a href="#" title="sfdsjdkfdfgfdgfdgfdgfdg"><i class="fas fa-envelope fa-fw"></i></a>
									</div>
								</div>
							</li>
							...
							<li>
								<div class="extended-item">
									<div class="extended-icon"><a href="#"><img src="<?php echo base_url(); ?>uploads/pictures/m3.jpg" class="icon" alt="" /></a></div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
							...
							<li>
								<div class="extended-item">
									<div class="extended-icon"><a href="#"><img src="<?php echo base_url(); ?>uploads/pictures/m4.jpg" class="icon" alt="" /></a></div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
							...
							<li>
								<div class="extended-item">
									<div class="extended-icon"><a href="#"><img src="<?php echo base_url(); ?>uploads/pictures/m5.jpg" class="icon" alt="" /></a></div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
							...
							<li>
								<div class="extended-item">
									<div class="extended-icon"><a href="#"><img src="<?php echo base_url(); ?>uploads/pictures/m6.jpg" class="icon" alt="" /></a></div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
							...
							<li>
								<div class="extended-item">
									<div class="extended-top clearfix">
										<div class="top_rating float-left">
											<div class="rating1">
												<div id="no-checked-stars"></div>
											</div>
										</div>
										<div class="top_text float-right"><b>Points:</b> 40</div>
									</div>
									<div class="extended-icon"><a href="#"><img src="<?php echo base_url(); ?>uploads/pictures/m7.jpg" class="icon" alt="" /></a></div>
									<h1 class="text-warning">Lorem Ipsum</h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in lectus.</p>
									<div class="extended-description">
										<i class="fas fa-clock float-left m-0"></i>
