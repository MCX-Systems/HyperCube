			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Badges examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4 <code>badges</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-default">
								<tbody>
								<tr>
									<th colspan="3" class="active">Basic badge styling</th>
								</tr>
								<tr>
									<td>Primary badge</td>
									<td>
									...
									<td>
										Primary contextual alternative. To use, add
										<code>.badge-primary</code> to the base
								...
								<tr>
									...
									<td>
										Info contextual alternative. To use, add
										<code>.badge-secondary</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Danger contextual alternative. To use, add
										<code>.badge-danger</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Success contextual alternative. To use, add
										<code>.badge-success</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Warning contextual alternative. To use, add
										<code>.badge-warning</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Info contextual alternative. To use, add
										<code>.badge-info</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Info contextual alternative. To use, add
										<code>.badge-light</code> to the base
										<code>.badge</code> class
									</td>
								</tr>
								<tr>
									...
									<td>
										Info contextual alternative. To use, add
										<code>.badge-dark</code> to the base
										<code>.badge</code> class
									</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Basic badge options</th>
								</tr>
								<tr>
									<td>Rounded badge</td>
									<td>
									...
									<td>
										Badge with rounded corners. To use, add
										<code>.badge-rounded</code> class to the
										<code>.badge</code> element
									</td>
								</tr>
								<tr>
									<td>Roundless badge</td>
									<td>
										<span class="badge badge-success badge-roundless">Roundless badge</span>
									</td>
									<td>
										This badge doesn't have rounded borders. To use, add
										<code>.badge-roundless</code> class to the
										<code>.badge</code> element
									</td>
								</tr>
								<tr>
									<td>Block badge</td>
									<td>
										<span class="badge badge-danger badge-block">Block badge</span>
									</td>
									<td>
										This badge fills 100% width of a parent element. To use, add
										<code>.badge-block</code> class to the
										<code>.badge</code> element
									</td>
								</tr>
								<tr>
									<td>Linked badge</td>
									<td>
										<a href="#" class="badge badge-info">Linked badge</a>
									</td>
									<td>
										You can also use badges as a link in an
										<code>&lt;a></code> element
									</td>
								</tr>
								<tr>
									...
									<td>
										badge with icon. To use, add icon and
										<code>.badge-icon</code> class to the badge. Available in 4 sizes
									</td>
								</tr>
								<tr>
									<td>Icon in badge</td>
									<td>
									<span class="badge badge-warning badge-icon badge-icon-lg">
										<i class="fas fa-wrench" aria-hidden="true"></i>
									</span>
									</td>
									<td>
										badge with icon. To use, add icon and
										<code>.badge-icon</code> class to the badge. Available in 4 sizes
										<code>.badge-icon-lg</code> class to the badge.
									</td>
								</tr>
								<tr>
									<td>Icon in badge</td>
									<td>
									<span class="badge badge-warning badge-icon badge-icon-sm">
										<i class="fas fa-wrench" aria-hidden="true"></i>
									</span>
									</td>
									<td>
										badge with icon. To use, add icon and
										<code>.badge-icon</code> class to the badge. Available in 4 sizes
										<code>.badge-icon-sm</code> class to the badge.
									</td>
								</tr>
								<tr>
									<td>Icon in badge</td>
									<td>
									<span class="badge badge-warning badge-icon badge-icon-xs">
										<i class="fas fa-wrench" aria-hidden="true"></i>
									</span>
									</td>
									<td>
										badge with icon. To use, add icon and
										<code>.badge-icon</code> class to the badge. Available in 4 sizes
										<code>.badge-icon-xs</code> class to the badge.
									</td>
								</tr>
								<tr>
									<td>Icon in linked badge</td>
									<td>
										<a href="#" class="badge badge-primary badge-icon">
											<i class="fas fa-wrench" aria-hidden="true"></i>
										</a>
									</td>
									<td>
										Linked badge with icon. To use, add icon and
										<code>.badge-icon</code> to the link
									</td>
								</tr>
								<tr>
									<td>Icon in rounded badge</td>
									<td>
									<span class="badge badge-success badge-rounded badge-icon">
										<i class="fas fa-wrench" aria-hidden="true"></i>
									</span>
									</td>
									<td>
										Rounded linked icon. Usage is the same, but with additional
										<code>.badge-rounded</code> class
									</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Striped badges</th>
								</tr>
								<tr>
									<td>Primary badge</td>
									<td>
										<span class="badge badge-border-left-primary badge-striped">Primary</span>
									</td>
									<td>
										Primary contextual alternative. To use with primary badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Secondary badge</td>
									<td>
										<span class="badge badge-border-left-secondary badge-striped">Secondary</span>
									</td>
									<td>
										Secondary contextual alternative. To use with secondary badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Danger badge</td>
									<td>
										<span class="badge badge-border-left-danger badge-striped">Danger</span>
									</td>
									<td>
										Danger contextual alternative. To use with danger badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Success badge</td>
									<td>
										<span class="badge badge-border-left-success badge-striped">Success</span>
									</td>
									<td>
										Success contextual alternative. To use with success badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Warning badge</td>
									<td>
										<span class="badge badge-border-left-warning badge-striped">Warning</span>
									</td>
									<td>
										Warning contextual alternative. To use with warning badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Info badge</td>
									<td>
										<span class="badge badge-border-left-info badge-striped">Info</span>
									</td>
									<td>
										Info contextual alternative. To use with info badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Light badge</td>
									<td>
										<span class="badge badge-border-left-light badge-striped">Light</span>
									</td>
									<td>
										Light contextual alternative. To use with light badge and
										<code>.badge-striped</code> class
									</td>
								</tr>
								<tr>
									<td>Dark badge</td>
									<td>
										<span class="badge badge-border-left-dark badge-striped">Dark</span>
									</td>
									<td>
										Dark contextual alternative. To use with dark badge and
										<code>.badge-striped</code> class
									</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Striped badge options</th>
								</tr>
								<tr>
									<td>Right border</td>
									<td>
										<span class="badge badge-border-right-success badge-striped badge-striped-right">Right border</span>
									</td>
									<td>
										To highlight right border instead of left, add
										<code>.badge-striped-right</code> class
									</td>
								</tr>
								<tr>
									<td>Linked badge</td>
									<td>
										<a href="#" class="badge badge-border-left-danger badge-striped">Linked badge</a>
									</td>
									<td>
										Linked striped badge. Use
										<code>.badge-striped</code> and other badge classes in
										<code>&lt;a></code> element
									</td>
								</tr>
								<tr>
									...
									<td>
									<span class="badge badge-striped badge-border-left-danger badge-icon">
										<i class="fas fa-wrench" aria-hidden="true"></i>
									</span>
									</td>
									<td>
										Icon inside striped badge. To use custom border color, add
										<code>.border-*</code> custom border color class. Available in 5 sizes
									</td>
								</tr>
								<tr>
									<td>Icon in linked striped badge</td>
									<td>
										<a href="#" class="badge badge-striped badge-border-left-primary badge-icon">
											<i class="fas fa-wrench" aria-hidden="true"></i>
										</a>
									</td>
									<td>Linked icon inside striped badge</td>
								</tr>

								<tr>
									<th colspan="3" class="active">Basic badges</th>
								</tr>
								<tr>
									<td>Primary badge</td>
									<td>
									...
									<td>
										Primary contextual alternative. To use, add
										<code>.badge-primary</code> to the badge element
									</td>
								</tr>
								<tr>
									<td>Danger badge</td>
									...
									<td>
										Danger contextual alternative. To use, add
										<code>.badge-danger</code> to the badge element
									</td>
								</tr>
								<tr>
									<td>Success badge</td>
									<td>
										<span class="badge badge-success">65</span>
									</td>
									<td>
										Success contextual alternative. To use, add
										<code>.badge-success</code> to the badge element
									</td>
								</tr>
								<tr>
									<td>Warning badge</td>
									...
									<td>
										Warning contextual alternative. To use, add
										<code>.badge-warning</code> to the badge element
									</td>
								</tr>
								<tr>
									<td>Info badge</td>
									<td>
										<span class="badge badge-info">98</span>
									</td>
									<td>
										Info contextual alternative. To use, add
										<code>.badge-info</code> to the badge element
									</td>
								</tr>
								...
								<tr>
									<td>Linked badge</td>
									<td>
										<a href="#" class="badge badge-danger">22</a>
									</td>
									<td>
										Linked badge. Use
										<code>.badge</code> and other badge classes in
										<code>&lt;a></code> element
									</td>
								</tr>
								</tbody>
