		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">
									Use of <code>extended</code> bootstrap 4
									<code>Modal Dialogs</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<button id="register" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#RegistrationModal">REGISTRATION</button>
						<button id="login" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#LogInModal">LOGIN</button>
						<button id="contact" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#ContactModal">CONTACT</button>
						<button id="payment" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#PaymentModal">PAYMENT</button>
						<button id="review" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#ReviewModal">REVIEW</button>
						<button id="subscribe" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#SubscribeModal">SUBSCRIBE</button>
						<button id="forgot" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#ForgotModal">FORGOT</button>
						<button id="reset" class="btn ripple-click-effect btn-rounded btn-info" data-toggle="modal" data-target="#ResetModal">RESET</button>
					</section>
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Modal Dialogs</h4>
								...
								<code>"modal"</code> or
								<code>"modeless"</code>, depending on whether or not they block interaction with the page that initiated the dialog. Table below contains basic modal dialog examples. Click
								<code>Launch</code> button to run modal examples.
								...
								<table class="table mt-3">
									...
									<tr>
										...
										<td style="width: 20%;">
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_default">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Basic modal dialog with
											<code>header</code>,
											<code>body</code> and
											<code>footer</code> areas. Default examples displays: header - contains a title and a close button; footer - contains buttons and body contains static or dynamic content
										</td>
									</tr>
									<tr>
										<td>Modal with icons</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_iconified">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_animation">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Disabled animation. For modals that simply appear rather than fade in to view, remove the
											<code>.fade</code> class from your modal markup
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_mini">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											...
											<code>300px</code>. To use, add
											<code>modal-xs</code> class to
											<code>.modal-dialog</code> container
										</td>
									</tr>
									<tr>
										<td>Small size modal</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_small">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										...
										<td>
											...
											<code>600px</code>. Since this is a default size, modal markup doesn't require any additional sizing classes
										</td>
									</tr>
									<tr>
										<td>Large size modal</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_large">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											...
											<code>900px</code>. To use, add
											<code>modal-lg</code> class to
											<code>.modal-dialog</code> container
										</td>
									</tr>
									<tr>
										...
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_full">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											...
											<code>94%</code> width of the window. To use, add
											<code>modal-full</code> class to
											<code>.modal-dialog</code> container
										</td>
									</tr>
									<tr class="border-double">
									...
									<tr>
										...
										<td>
											...
											<code>white</code> background color. Doesn't require any additional contextual classes
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<code>.bg-primary</code> class to the
											<code>.modal-header</code> container
										</td>
									</tr>
									<tr>
										<td>Secondary modal header</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_theme_secondary">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Secondary modal. To use, add
											<code>.bg-secondary</code> class to the
											<code>.modal-header</code> container
										</td>
									</tr>
									<tr>
										...
										<td>
											<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_theme_danger">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_theme_success">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_theme_warning">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_theme_info">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											...
											<code>.bg-info</code> class to the
											<code>.modal-header</code> container
										</td>
									</tr>
									<tr>
										<td>Light modal header</td>
										<td>
											<button type="button" class="btn btn-light btn-sm" data-toggle="modal" data-target="#modal_theme_light">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Light modal. To use, add
											<code>.bg-light</code> class to the
											<code>.modal-header</code> container
										</td>
									</tr>
									<tr>
										<td>Dark modal header</td>
										<td>
											<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_theme_dark">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Darki modal. To use, add
									...
									<tr>
										<td>Vertical form</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_form_vertical">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Modal with default vertical form layout and responsive grid. Forms must be placed outside of
											<code>.modal-body</code>container to prevent extra horizontal padding
										</td>
									</tr>
									<tr>
										<td>Horizontal form</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_form_horizontal">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
									...
									<tr>
										<td>Inline form</td>
										<td>
											<button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_form_inline">
												Launch
												<i class="fas fa-power-off ml-3"></i>
											</button>
										</td>
										<td>
											Modal with with a simple
											<code>inline</code> form layout
										</td>
									</tr>
									</tbody>
								</table>
...
=======================================-->
<div class="modal" tabindex="-1" id="RegistrationModal" role="dialog" aria-hidden="true">
		...
		<div class="modal-dialog modal-lg" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Sign Up</h4>
								<p>If user doesn't have there account then, Create your account by filling the given entries.</p>
								<div class="custom-social-form-toolbar">
									...
									<div class="anchor-wrap">
										...
										<a class="btn btn-social-icon btn-sm btn-microsoft">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning"><i class="fas fa-user-plus mr-2"></i>Register</h4>
								<form>
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                     <input class="custom-form-input-field" type="text" title="First Name" />
                                                     <label class="custom-form-input-label">
                                                         <span class="custom-form-input-label-content">First name</span>
                                                     </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
	                                                <input class="custom-form-input-field" type="text" title="Email" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Email</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="password" title="Password" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Password</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="password" title="Confirm Password" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Confirm password</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input  class="custom-form-input-field" type="text" title="Phone Number" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Phone number</span>
                                                    </label>
                                                </div>
											</div>
										</div>
											...
											<div class="form-group form-radio">
												<div class="row">
													...
													<div class="col-sm-4">
														<div class="radio radio-inline">
															<label>
																<input type="radio" name="gender" id="uncknownRadio" value="Unknown" />
...
= Login form modal                       =
=======================================-->
<div class="modal" tabindex="-1" id="LogInModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Sign Up</h4>
								<p>If you have account then login. otherwise firstly create your account.</p>
								<div class="custom-social-form-toolbar">
									<p>Login with social media ..</p>
									<div class="anchor-wrap">
										<a class="btn btn-social-icon btn-sm btn-facebook">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning"><i class="fas fa-user-lock mr-2"></i>Login</h4>
								<form>
									<div class="form-group">
                                        <div class="custom-form-span-wrap">
                                            <input class="custom-form-input-field" type="text" title="Email" />
			...
			<div class="modal-content">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Get In Touch</h4>
								<p>If you have any question , please feel free to drop me a line. Just fill the entries that are given and press the button.</p>
							</div>
						</div>

						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning"><i class="fas fa-comment-alt mr-2"></i>Contact</h4>
								<form>
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="Last Name" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Last Name</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
												<div class="custom-form-span-wrap">
                                                    <input  class="custom-form-input-field" type="text" title="Subject" />
                                                    <label class="custom-form-input-label">
                                                       <span class="custom-form-input-label-content">Subject</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <span class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="Email" >
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Email</span>
                                                    </label>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <span class="custom-form-span-wrap">
                                                    <textarea class="custom-form-input-field custom-form-textarea-field" title="Message"></textarea>
                                                    <label class="custom-form-input-label custom-form-textarea-label">
	                                                    <span class="custom-form-input-label-content">Message</span>
                                                    </label>
                                                </span>
											</div>
										</div>
...
= Payment section                       =
======================================-->
<div class="modal" tabindex="-1" id="PaymentModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
		<div class="modal-dialog modal-lg" role="document">
			<!-- Modal content-->
			<div class="modal-content">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Get In Touch</h4>
								<p>
									If you have any question , please feel free to drop me a line. Just fill
									the entries that are given and press the button.
								</p>
								<div class="custom-social-form-toolbar">
									<p>Payment options ..</p>
									<div class="anchor-wrap">
										...
										<i class="fab fa-cc-discover fa-2x mr-2"></i>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning">
									<i class="fas fa-money-bill-alt mr-2"></i>Payment Invoice
								</h4>
								<p>Please provide the billing & payment info below</p>
								...
								<form>
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="Payment Amount" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Payment Amount</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="Holder's Name" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Holder's Name</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mt-3">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
	                                                <input class="custom-form-input-field" type="text" title="CVV" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">CVV</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 mt-3">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="Card Number" />
	                                                <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Card Number</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-button-wrap">
												<button class="btn btn-info" type="button">
													<i class="fas fa-money-bill-alt mr-2"></i>Place Order
												</button>
											</div>
										</div>
									</div>
...
= Review section                       =
=====================================-->
<div class="modal" tabindex="-1" id="ReviewModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
		<div class="modal-dialog" role="document">
			<!-- Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Write a Review</h4>
								<p>
									We'd love to hear more from our visitors. Your feedback will help us to
									undestand what we do well and where we can improve.
								</p>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning">
									<i class="fab fa-rev mr-2"></i>Review
								</h4>
								...
								<form>
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="text" title="User Name" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">User Name</span>
                                                     </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <textarea class="custom-form-input-field custom-form-textarea-field" title="Your comments"></textarea>
                                                    <label class="custom-form-input-label temp-textarea-label">
                                                        <span class="custom-form-input-label-content">Your comments</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-button-wrap">
												<button class="btn btn-info" type="button">
													<i class="fab fa-rev mr-2"></i>Send Review
												</button>
											</div>
										</div>
									</div>
...
= Subscribe form                       =
=====================================-->
<div class="modal" tabindex="-1" id="SubscribeModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
		<div class="modal-dialog modal-lg" role="document">
			<!-- Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Hello world</h4>
								<h2>Hello world</h2>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning">
									<i class="fas fa-check-double mr-2"></i>Subscribe
								</h4>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group form-radio">
												<div class="radio radio-inline">
													<label>
														<input type="radio" name="category" id="travelRadio" value="Travel" />
														<i class="helper"></i>Travel
													</label>
												</div>

												<div class="radio radio-inline">
													<label>
														<input type="radio" name="category" id="MagazineRadio" value="Magazine" />
														<i class="helper"></i>Magazine
													</label>
												</div>

												<div class="radio radio-inline">
													<label>
														<input type="radio" name="category" id="Checked-OptionRadio" value="Checked Option" />
														<i class="helper"></i>Checked Option
													</label>
												</div>

												<div class="radio radio-inline">
													<label>
														<input type="radio" name="category" id="Disabled-OptionRadio" value="Disabled Option" />
														<i class="helper"></i>Disabled Option
													</label>
												</div>
											</div>
										</div>
...
===========================================-->
<div class="modal" tabindex="-1" id="ForgotModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
		<div class="modal-dialog" role="document">
			<!-- Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Forgot your password?</h4>
								<p>
								...
								<form>
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-button-wrap">
												<button class="btn btn-info" type="button">
													<i class="fas fa-check-double mr-2"></i>Send Mail
												</button>
											</div>
										</div>
									</div>
...
<!-- Reset form modal -->
<div class="modal" tabindex="-1" id="ResetModal" role="dialog" aria-hidden="true">
	<div class="custom-modal-wrap">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<button type="button" class="close custom-close-button" data-dismiss="modal">&times;</button>
				<div class="modal-body custom-modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-column-wrap-image">
							<div class="form-inner-wrapper">
								<h4 class="mb-3 mt-2 text-warning">Reset your password</h4>
								<p>You can change your password just by filling the given entries and set new password</p>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-column-wrap">
								<h4 class="mb-3 mt-2 text-warning">
									<i class="fas fa-glasses mr-2"></i>Reset
								</h4>
								...
								<form>
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="password" title="Current Password" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">Current Password</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="password" title="New Password" />
                                                    <label class="custom-form-input-label">
                                                        <span class="custom-form-input-label-content">New Password</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
                                                <div class="custom-form-span-wrap">
                                                    <input class="custom-form-input-field" type="password" title="Confirm New password" />
                                                    <label class="custom-form-input-label">
	                                                    <span class="custom-form-input-label-content">Confirm New password</span>
                                                    </label>
                                                </div>
											</div>
										</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="form-button-wrap">
												<button class="btn btn-info" type="button">
													<i class="fas fa-glasses mr-2"></i>Reset password
												</button>
											</div>
										</div>
									</div>
...
<!-- Modal with alert message and icons -->
<div id="modal_iconified" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">&nbsp;Modal with icons</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-body">
				<div class="alert alert-info alert-styled-left" role="alert">
					...
					<span class="text-semibold">Heads up!</span>Example of an alert inside modal.
				</div>

				<h6 class="text-semibold">
					<i class="icon-law position-left"></i>Sample heading with icon
				</h6>
				<p>
					Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in,
					egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.
				...
				<p>
					<i class="icon-mention position-left"></i>
			...
			<div class="modal-footer">
				...
				<button class="btn btn-primary btn-sm">
					<i class="fas fa-check-square mr-2"></i>Save
				</button>
			</div>
		</div>
	</div>
...
<!-- Secondary modal -->
<div id="modal_theme_secondary" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-secondary">
				<h5 class="modal-title">Secondary header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-danger">
				<h5 class="modal-title">Danger header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-success">
				<h5 class="modal-title">Success header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-warning">
				<h5 class="modal-title">Warning header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-info">
				<h5 class="modal-title">Info header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<!-- Light modal -->
<div id="modal_theme_light" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-light">
				<h5 class="modal-title">Light header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<!-- Dark modal -->
<div id="modal_theme_dark" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-dark">
				<h5 class="modal-title">Dark header</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="text" placeholder="Test Street 12" class="form-control" />
							</div>

							<div class="col-sm-6">
								<label>Address line 2</label>
								<input type="text" placeholder="Test Street 14" class="form-control" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								<label>Email</label>
								<input type="text" placeholder="test@user.com" class="form-control" />
				...
				<div class="modal-body">
					<div class="form-group has-feedback">
						...
						<div class="form-control-feedback">
							<i class="fas fa-user ml-2 text-muted"></i>
						</div>
					</div>
