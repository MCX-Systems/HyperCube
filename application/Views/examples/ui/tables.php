			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Tables examples</h4>
								<h6 class="card-subtitle">Use of <code>.table .table-default</code> class.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add<code>.table-bordered</code>for borders on all sides of the
									table and cells.</h6>
								...
								<div class="table-responsive">
									<table data-toolbar="#table-toolbar"
									       data-search="true"
									       ...
									       data-toggle="table"
									       data-resizable="true"
									       data-onlyInfoPagination="false"
									       data-show-export="true"
									       data-show-multi-sort="true"
									       data-sort-priority='[{"sortName": "installs","sortOrder":"desc"},{"sortName":"created","sortOrder":"desc"},{"sortName":"id","sortOrder":"desc"}]'
										...
										<thead>
										<tr>
											<th data-field="se" data-checkbox="true"></th>
										...
										<tr>
											...
											<td>1</td>
											<td>
												<img src="<?php echo base_url() ?>assets/Avatars/avatar14.png" alt="" width="45"
												     height="45"/>
											</td>
											<td>
												<span>20,859</span><br/>
											...
											<td>
												<a href="#" data-toggle="tooltip" data-original-title="More">
													<i class="fas fa-eye mr-3"></i>
												</a>
												<a href="#" data-toggle="tooltip" data-original-title="Export">
													<i class="fas fa-box-open mr-3"></i>
												</a>
												<a href="#" data-toggle="tooltip" data-original-title="Refresh">
										...
										<tr>
											...
											<td><span class="badge badge-danger">Label</span></td>
											<td>
												<a href="#" data-toggle="tooltip" data-original-title="More">
													<i class="fas fa-eye mr-3"></i>
												</a>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Sorting enabled</h6>
								<div class="table-responsive">
									<table class="table-dark table-bordered"
									       data-toggle="table"
									       data-show-multi-sort="true"
									       data-sort-priority='[{"sortName": "id","sortOrder":"desc"},{"sortName":"price","sortOrder":"desc"}]'
									       data-mobile-responsive="true">
										<thead>
										<tr>
					...
					<section class="col-lg-6">
						<div class="card mb-3">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.primary-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card mb-3">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.success-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.info-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.warning-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.danger-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add class <code>.secondary-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Primary Table</h4>
								<h6 class="card-subtitle">Add class <code>.primary-bordered-table</code></h6>
								<div class="table-responsive">
									<table class="table primary-bordered-table">
										<thead>
										<tr>
											<th>#</th>
											<th>First Name</th>
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Success Table</h4>
								<h6 class="card-subtitle">Add class <code>.success-bordered-table</code></h6>
								<div class="table-responsive">
									<table class="table success-bordered-table">
										<thead>
										<tr>
											<th>#</th>
											<th>First Name</th>
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Info Table</h4>
								<h6 class="card-subtitle">Add class <code>.info-bordered-table</code></h6>
								<div class="table-responsive">
									<table class="table info-bordered-table">
										<thead>
										<tr>
											<th>#</th>
											<th>First Name</th>
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Warning Table</h4>
								<h6 class="card-subtitle">Add class <code>.warning-bordered-table</code></h6>
								<div class="table-responsive">
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Danger Table</h4>
								<h6 class="card-subtitle">Add class <code>.danger-bordered-table</code></h6>
								<div class="table-responsive">
									<table class="table danger-bordered-table">
										<thead>
										<tr>
											<th>#</th>
											<th>First Name</th>
					...
					<section class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Inverse Table</h4>
								<h6 class="card-subtitle">Add class <code>.secondary-bordered-table</code></h6>
								<div class="table-responsive">
									<table class="table secondary-bordered-table">
										<thead>
										<tr>
											<th>#</th>
											<th>First Name</th>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tr>
											...
											<td>Herman Beck</td>
											<td><span class="text-muted"><i class="fas fa-clock"></i> Oct 16, 2017</span>
											</td>
											<td>$45.00</td>
											<td>
										...
										<tr>
											...
											<td>Mary Adams</td>
											<td><span class="text-muted"><i class="fas fa-clock"></i> Oct 12, 2017</span>
											</td>
											<td>$245.30</td>
											<td>
												<div class="badge badge-danger">Shipped</div>
											</td>
											<td>CN</td>
										</tr>
										<tr>
											...
											<td><span class="text-muted"><i class="fas fa-clock"></i> May 18, 2017</span>
											</td>
											<td>$38.00</td>
											<td>
										...
										<tr>
											...
											<td>June Lane</td>
											<td><span class="text-muted"><i class="fas fa-clock"></i> Apr 28, 2017</span>
											</td>
											<td>$77.99</td>
											<td>
												<div class="badge badge-success">Paid</div>
										...
										<tr>
											...
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Edit"><i
														class="fas fa-pencil-alt text-inverse mr-1"></i></a>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Bordered Table and Striped</h4>
								<h6 class="card-subtitle">Add<code>.table-bordered .table-striped</code>for borders on all
									sides of the table and cells and stripes.</h6>
								<div class="table-responsive">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Add<code>.table-hover</code>for hovering color</h6>
								<div class="table-responsive">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Table Small</h4>
								<h6 class="card-subtitle">Add<code>.table-sm</code></h6>
								<div class="table-responsive">
