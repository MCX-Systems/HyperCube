			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Ribbons examples</h4>
								<h6 class="card-subtitle">Use of
									<code>.ribbon</code> class <code>for ribbon component</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-right"><span class="bg-primary">Popular</span></div>
							<p class="ribbon-content ribbon-left">
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-right"><span class="bg-danger">Popular</span></div>
							<p class="ribbon-content ribbon-left">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-right"><span class="bg-info">Popular</span></div>
							<p class="ribbon-content ribbon-left">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-right"><span class="bg-warning">Popular</span></div>
							<p class="ribbon-content ribbon-left">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2 mb-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-right"><span class="bg-dark">Popular</span></div>
							<p class="ribbon-content ribbon-left">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-primary">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					</section>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-danger">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-success">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-warning">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-dark">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
					...
					<section class="col-md-2 mb-2">
						<div class="ribbon-wrapper">
							<div class="ribbon ribbon-left"><span class="bg-info">Popular</span></div>
							<p class="ribbon-content ribbon-right">
								Duis mollis, est non commodo luctus, nisi erat porttitor ligula
							</p>
						</div>
