			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">BlockQuote</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">BlockQuote examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4 <code>blockQuote</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-7">
						<blockquote class="blockquote-info">
							<p>
								<strong>BlockQuote Info</strong>
							</p>
							<p>
								<small>Inquietude simplicity terminated she compliment remarkably few her nay. The weeks are
									ham asked jokes. Neglected perceived shy nay concluded. Not mile draw plan snug next
									all. Houses latter an valley be indeed wished merely in my. Money doubt oh drawn every
									or an china. Visited out friends for expense message set eat.
								</small>
							</p>
						</blockquote>
					</section>
					...
					<section class="col-md-5">
						<blockquote class="blockquote-info pull-right">
							<p>
								<strong>BlockQuote Info Right</strong>
							</p>
							<p>
								<small>Inquietude simplicity terminated she compliment remarkably few her nay. The weeks are
									ham asked jokes. Neglected perceived shy nay concluded. Not mile draw plan snug next
					...
					<section class="col-md-5">
						<blockquote class="blockquote-success">
							<p>
								<strong>BlockQuote Success</strong>
							</p>
							<p>
								<small>Inquietude simplicity terminated she compliment remarkably few her nay. The weeks are
									ham asked jokes. Neglected perceived shy nay concluded. Not mile draw plan snug next
					...
					<section class="col-md-7">
						<blockquote class="blockquote-warning">
							<p>
								<strong>BlockQuote Warning</strong>
							</p>
							<p>
								<small>Inquietude simplicity terminated she compliment remarkably few her nay. The weeks are
									ham asked jokes. Neglected perceived shy nay concluded. Not mile draw plan snug next
					...
					<section class="col-md-12">
						<blockquote class="blockquote-danger">
							<p>
								<strong>BlockQuote Danger</strong>
							</p>
							<p>
								<small>Inquietude simplicity terminated she compliment remarkably few her nay. The weeks are
									ham asked jokes. Neglected perceived shy nay concluded. Not mile draw plan snug next
