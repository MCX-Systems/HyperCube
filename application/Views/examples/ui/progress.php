			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Progress Bar examples</h4>
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4 <code>progress bars</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Default progress bar</h4>
								<h6 class="card-subtitle">Example of a basic progress bar</h6>

								<div class="progress">
									<div class="progress-bar progress-default" style="width: 50%">
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Remove
									<code>.sr-only</code> class to show label
								</h6>

								<div class="progress">
									<div class="progress-bar bg-primary progress-default" style="width: 85%">
						...
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Using
									<code>.progress-striped</code> class
								</h6>

								<div class="progress">
									<div class="progress-bar progress-bar-striped progress-default" style="width: 50%">
										<span class="sr-only">50% Complete</span>
									</div>
								</div>
							</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Rounded progress bar</h4>
								<h6 class="card-subtitle">Using
									<code>.progress-rounded</code> class
								</h6>

								<div class="progress progress-rounded">
									<div class="progress-bar bg-warning progress-default" style="width: 85%">
										<span>85% Complete</span>
									</div>
								</div>
							</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Using
									<code>.progress-striped.progress-bar-animated</code> class
								</h6>

								<div class="progress">
									<div class="progress-bar progress-bar-striped progress-bar-animated progress-default"
									     style="width: 50%">
										<span class="sr-only">50% Complete</span>
									</div>
								</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Stacked progress bars</h4>
								<h6 class="card-subtitle">Multiple bars in the
									<code>.progress</code> block
								</h6>
								...
								<div class="progress">
									...
									<div class="progress-bar progress-bar-info progress-bar-striped progress-bar-animated progress-default"
									     style="width: 40%">
										<span>40%</span>
									</div>
								</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Basic progress bars</h4>
								<h6 class="card-subtitle">Progress bars contextual alternatives</h6>

								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-default" style="width: 15%">
										<span class="sr-only">15% Complete</span>
									</div>
								</div>

								<div class="progress content-group-sm mt-2">
									<div class="progress-bar bg-danger progress-default" style="width: 35%">
										<span class="sr-only">35% Complete (danger)</span>
									</div>
								</div>

								<div class="progress content-group-sm mt-2">
									<div class="progress-bar bg-success progress-default" style="width: 55%">
										<span class="sr-only">55% Complete (success)</span>
									</div>
								</div>

								<div class="progress content-group-sm mt-2">
									<div class="progress-bar bg-warning progress-default" style="width: 75%">
										<span class="sr-only">75% Complete (warning)</span>
									</div>
								</div>

								<div class="progress mt-2">
									<div class="progress-bar bg-info progress-default" style="width: 95%">
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-striped progress-default" style="width: 15%">
										<span class="sr-only">15% Complete</span>
									</div>
								</div>

								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-danger progress-bar-striped progress-default"
									     style="width: 35%">
										<span class="sr-only">35% Complete (danger)</span>
									</div>
								</div>
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-success progress-bar-striped progress-default"
									     style="width: 55%">
										<span class="sr-only">55% Complete (success)</span>
									</div>
								</div>
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-warning progress-bar-striped progress-default"
									     style="width: 75%">
										<span class="sr-only">75% Complete (warning)</span>
									</div>
								</div>
								...
								<div class="progress mt-2">
									<div class="progress-bar progress-bar-info progress-bar-striped progress-default"
									     style="width: 95%">
										<span class="sr-only">95% Complete (info)</span>
									</div>
								</div>
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Animated progress bars</h4>
								<h6 class="card-subtitle">Progress bars contextual alternatives</h6>
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-danger progress-bar-striped progress-bar-animated progress-default"
									     style="width: 35%">
										<span class="sr-only">35% Complete (danger)</span>
									</div>
								</div>
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-success progress-bar-striped progress-bar-animated progress-default"
									     style="width: 55%">
										<span class="sr-only">55% Complete (success)</span>
									</div>
								</div>
								...
								<div class="progress content-group-sm mt-2">
									<div class="progress-bar progress-bar-warning progress-bar-striped progress-bar-animated progress-default"
									     style="width: 75%">
										<span class="sr-only">75% Complete (warning)</span>
									</div>
								</div>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Progress bar sizes</span>
							</div>

							<div class="card-body">
								<p class="content-group">
									Limitless template extends default sizing up to 5 additional height sizing: large,
									small, mini, extra mini and micro. To use, just add
									<code>.progress-lg (*-sm, *-xs, *-xxs, *-micro)</code>class to the container with base
									<code>.progress</code>class. Micro progress bar is the thinest bar with fixed 1px
									height.
								</p>

								<div class="content-group-sm">
									<p class="text-semibold">Large progress bar</p>
								...
								<div class="content-group-sm">
									<p class="text-semibold">Default progress bar</p>
								...
								<div class="content-group-sm">
									<p class="text-semibold">Small progress bar</p>
								...
								<div class="content-group-sm">
									<p class="text-semibold">Mini progress bar</p>
								...
								<div class="content-group-sm">
									<p class="text-semibold">Micro progress bar</p>
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Vertical Progress bars</span>
							</div>

							<div class="card-body text-center">
								<div class="progress progress-vertical">
									<div class="progress-bar bg-info" role="progressbar" aria-valuenow="88"
									     aria-valuemin="0" aria-valuemax="100" style="height:10%;">
								...
								<div class="progress progress-vertical">
									<div class="progress-bar bg-warning" role="progressbar" aria-valuenow="88"
									     aria-valuemin="0" aria-valuemax="100" style="height:30%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical">
									<div class="progress-bar bg-danger" role="progressbar" aria-valuenow="88"
								...
								<div class="progress progress-vertical">
									<div class="progress-bar bg-success" role="progressbar" aria-valuenow="88"
									     aria-valuemin="0" aria-valuemax="100" style="height: 50%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical">
									<div class="progress-bar bg-inverse" role="progressbar" aria-valuenow="88"
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Vertical From bottom</span>
							</div>

							<div class="card-body text-center">
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar progress-bar-info progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height:10%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar bg-primary progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height:20%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar bg-warning progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height:30%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar bg-danger progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height:40%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar bg-success progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height: 50%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
								<div class="progress progress-vertical-bottom">
									<div class="progress-bar bg-inverse progress-bar-striped" role="progressbar"
									     aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="height:70%;">
										<span class="sr-only">88% Complete</span>
									</div>
								</div>
							</div>
					...
					<section class="col-md-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Vertical Striped</span>
							</div>
