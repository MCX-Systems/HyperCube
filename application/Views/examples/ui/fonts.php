			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-md-4">
										<h4 class="card-title">Default site font</h4>
										<h6 class="card-subtitle">You don't need to do enything.</h6>
										<br />
										<h3>Default site font</h3>
									</div>

									<div class="col-md-4">
										<h4 class="card-title">Secondary site font</h4>
										<h6 class="card-subtitle">Use class <code>.secondary-font</code> to get desired text.</h6>
										<br />
										<h3 class="secondary-font">Secondary site font</h3>
									</div>

									<div class="col-md-4">
										<h4 class="card-title">Number font</h4>
										<h6 class="card-subtitle">Use class <code>.number-font</code> to get desired text.</h6>
										<br />
										<h3 class="number-font">1234567890</h3>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Story font</h4>
								<div class="lorem-full story-font"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Digital font</h4>
                                <div class="lorem-full digital-font"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Title font</h4>
								<div class="lorem-full title-font"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Post font</h4>
								<div class="lorem-full post-font"></div>
							</div>
						</div>
					</section>
