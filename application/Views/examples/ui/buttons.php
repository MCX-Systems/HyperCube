				...
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use of <code>extended</code> bootstrap 4 <code>buttons</code>.</h6>
							</div>
						</div>
					</section>
								...
								<script type="text/javascript">
									$(function () {
										window.pagObj = $('#pagination2').twbsPagination({
											totalPages: 35,
											visiblePages: 10,
											paginationClass: 'pagination pagination-sm pagination-rounded justify-content-center',
											pageClass: "page-item info",
											first: '&laquo;',
											prev: '&lsaquo;',
											next: '&rsaquo;',
											last: '&raquo;',
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								<nav aria-label="Page navigation">
									<ul id="pagination5"></ul>
								</nav>
								<script type="text/javascript">
									$(function () {
										window.pagObj = $('#pagination5').twbsPagination({
											totalPages: 35,
											visiblePages: 10,
											paginationClass: 'pagination justify-content-end',
											pageClass: "page-item primary",
											first: '&laquo;',
											prev: '&lsaquo;',
											next: '&rsaquo;',
											last: '&raquo;',
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="btn-group" role="group" aria-label="Basic example">
											<button type="button" class="btn ripple-click-effect btn-secondary">
												Left
											</button>
											<button type="button" class="btn ripple-click-effect btn-secondary">
												Middle
										...
										<div class="btn-group" role="group" aria-label="Basic example">
											<button type="button" class="btn ripple-click-effect btn-info">
										...
										<div class="btn-group" role="group" aria-label="Basic example">
											<button type="button" class="btn ripple-click-effect btn-success">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
											<div class="btn-group mr-2" role="group" aria-label="First group">
												<button type="button" class="btn ripple-click-effect btn-secondary disabled">
													<span>1</span>
												</button>
									...
									<div class="col-md-6 mb-3">
										...
										<h6 class="card-subtitle">Create with code
											<code class="highlighter-rouge">.btn</code> in
											<code class="highlighter-rouge">.btn-group</code>
										</h6>
									...
									<div class="col-md-6 mb-3">
										...
										<h6 class="card-subtitle">Create vertical button with class of
										...
										<div class="btn-group-vertical" role="group" aria-label="Vertical button group">
											<button type="button" class="btn ripple-click-effect btn-secondary">
												<i class="fas fa-check mr-2"></i>Button
											</button>
											<button type="button" class="btn ripple-click-effect btn-secondary">
												<i class="fas fa-check mr-2"></i>Button
											</button>
									...
									<!-- column -->
									<div class="col-md-6 mb-3">
										<h4 class="card-title">Button with js</h4>
										<h6 class="card-subtitle">There are a few easy ways to quickly get started with Bootstrap</h6>
										...
										<button type="button" class="btn btn-secondary btn-outline" data-toggle="button" aria-pressed="true">
											<i class="fas fa-heart text text-dark" aria-hidden="true"></i>
											<i class="fas fa-heart text-active text-danger" aria-hidden="true"></i>
										</button>

										<button type="button" class="btn btn-secondary btn-outline" data-toggle="button" aria-pressed="true">
											<i class="fas fa-thumbs-up text" aria-hidden="true"> 20</i>
											<i class="fas fa-thumbs-up text-active text-danger" aria-hidden="true"> 21</i>
										</button>

										<button type="button" class="btn btn-success" data-toggle="button" aria-pressed="false">
											<i class="fas fa-cog text" aria-hidden="true"></i>
											<span class="text">Upload</span>
											<i class="fas fa-check text-active" aria-hidden="true"></i>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Circle Small buttons</h4>
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-circle btn-sm btn-success</code> to quickly create a small btn.
								</h6>

								<button type="button" class="btn ripple-click-effect btn-secondary btn-circle btn-sm">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-primary btn-circle btn-sm">
									<i class="fas fa-list"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-success btn-circle btn-sm">
									<i class="fas fa-link"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-info btn-circle btn-sm">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-warning btn-circle btn-sm">
									<i class="fas fa-cog"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-danger btn-circle btn-sm">
									<i class="fas fa-heart"></i>
								</button>

								<br />
								<br />
								<h4 class="card-title">Circle Medium buttons</h4>
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-circle btn-md btn-success</code> to quickly create a General btn.
								</h6>
								<button type="button" class="btn ripple-click-effect btn-secondary btn-circle btn-md">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-primary btn-circle btn-md">
									<i class="fas fa-list"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-success btn-circle btn-md">
									<i class="fas fa-link"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-info btn-circle btn-md">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-warning btn-circle btn-md">
									<i class="fas fa-cog"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-danger btn-circle btn-md">
									<i class="fas fa-heart"></i>
								</button>
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-circle btn-lg btn-success</code> to quickly create a large btn.
								</h6>
								<button type="button" class="btn ripple-click-effect btn-secondary btn-circle btn-lg">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-primary btn-circle btn-lg">
									<i class="fas fa-list"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-success btn-circle btn-lg">
									<i class="fas fa-link"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-info btn-circle btn-lg">
									<i class="fas fa-check"></i>
								</button>
								<button type="button" class="btn ripple-click-effect btn-warning btn-circle btn-lg">
									<i class="fas fa-cog"></i>
								</button>
							</div>
						</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Give class to the button
									<code>animated flipInX, flipInY, lightSpeedIn, slideInUp </code> use any animations class
								</h6>
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu animated flipInX">
										...
										<a class="dropdown-item" href="javascript:void(0);">
											<i class="fas fa-cog mr-2"></i>Another action
										</a>
										<a class="dropdown-item" href="javascript:void(0);">
											<i class="fas fa-cog mr-2"></i>Something else here
										</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="javascript:void(0);">
											<i class="fas fa-cog mr-2"></i>Separated link
										</a>
									</div>
								</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									...
									<code>i class ="fas fa-heart"</code> to quickly create a General btn.
								</h6>

								<div class="row button-group">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary">
											<i class="fas fa-check mr-2"></i>Primary
										</button>
										<button type="button" class="btn btn-secondary">
											<i class="fas fa-heart mr-2"></i>Secondary
										</button>
										<button type="button" class="btn btn-success">
											<i class="fas fa-check mr-2"></i>Success
										</button>
										<button type="button" class="btn btn-info">
											<i class="fas fa-heart mr-2"></i>Info
										</button>
										<button type="button" class="btn btn-warning">
											<i class="fas fa-heart mr-2"></i>Warning
										</button>
										<button type="button" class="btn btn-danger">
											<i class="fas fa-heart mr-2"></i>Danger
										</button>
									</div>

									<div class="col-md-6">
										<button class="btn btn-primary ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-envelope mr-2"></i></span>Mail
										</button>
										<button class="btn btn-secondary ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-check mr-2"></i></span>Check
										</button>
										<button class="btn btn-info ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-heart mr-2"></i></span>Heart
										</button>
										<button class="btn btn-warning ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-envelope mr-2"></i></span>Mail
										</button>
										<button class="btn btn-danger ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-heart mr-2"></i></span>Heart
										</button>
									</div>
									...
									<div class="col-md-6 mt-3">
										<button class="btn btn-outline-primary ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-envelope mr-2"></i></span>Mail
										</button>
										<button class="btn btn-outline-secondary ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-check mr-2"></i></span>Check
										</button>
										<button class="btn btn-outline-info ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-heart mr-2"></i></span>Heart
										</button>
										<button class="btn btn-outline-warning ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-envelope mr-2"></i></span>Mail
										</button>
										<button class="btn btn-outline-danger ripple-click-effect" type="button">
											<span class="btn-label"><i class="fas fa-heart mr-2"></i></span>Heart
										</button>
									</div>
									...
									<div class="col-md-6 mt-3">
										...
										<button type="button" class="btn btn-outline-secondary btn-rounded">
											Secondary <i class="fas fa-heart ml-2"></i>
										</button>
									...
									<div class="col-md-6 mt-3">
										...
										<div class="btn-group">
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" href="javascript:void(0);">
													<i class="fas fa-heart mr-2"></i>Action
												</a>
												<a class="dropdown-item" href="javascript:void(0);">
													<i class="fas fa-heart mr-2"></i>Another action
												</a>
												<a class="dropdown-item" href="javascript:void(0);">
													<i class="fas fa-heart mr-2"></i>Something else here
												</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" href="javascript:void(0);">
													<i class="fas fa-heart mr-2"></i>Separated link
												</a>
											</div>
										</div>
									...
									<div class="col-md-12 mt-3 no-button-group">
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-success</code> to quickly create a General btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-primary">Primary</button>
									<button type="button" class="btn ripple-click-effect btn-secondary">Secondary</button>
									<button type="button" class="btn ripple-click-effect btn-success">Success</button>
									<button type="button" class="btn ripple-click-effect btn-info">Info</button>
									<button type="button" class="btn ripple-click-effect btn-warning">Warning</button>
									<button type="button" class="btn ripple-click-effect btn-danger">Danger</button>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-outline-success</code> to quickly create a General btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-outline-primary">
										Primary
									</button>
									<button type="button" class="btn ripple-click-effect btn-outline-secondary">
										Secondary
									</button>
									<button type="button" class="btn ripple-click-effect btn-outline-success">
										Success
									</button>
									<button type="button" class="btn ripple-click-effect btn-outline-info">
										Info
									</button>
									<button type="button" class="btn ripple-click-effect btn-outline-warning">
										Warning
									</button>
									<button type="button" class="btn ripple-click-effect btn-outline-danger">
										Danger
									</button>
								</div>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-rounded btn-success</code> to quickly create a General btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-rounded btn-primary">
										Primary
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-secondary">
										Secondary
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-success">
										Success
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-info">
										Info
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-warning">
										Warning
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-danger">
										Danger
									</button>
								</div>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-rounded btn-outline-success</code> to quickly create a General btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-primary">
										Primary
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-secondary">
										Secondary
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-success">
										Success
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-info">
										Info
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-warning">
										Warning
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-outline-danger">
										Danger
									</button>
								</div>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-lg btn-success</code> to quickly create a General btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-lg btn-primary">
										Large .btn-lg
									</button>
									<button type="button" class="btn ripple-click-effect btn-secondary">
										Normal .btn
									</button>
									<button type="button" class="btn ripple-click-effect btn-sm btn-success">
										Small .btn-sm
									</button>
									<button type="button" class="btn ripple-click-effect btn-xs btn-info">
										Tiny .btn-xs
									</button>
								</div>
							</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-lg btn-rounded btn-success</code> to create a btn.
								</h6>

								<div class="button-group">
									<button type="button" class="btn ripple-click-effect btn-lg btn-rounded btn-primary">
										Large .btn-lg
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-secondary">
										Normal .btn
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-sm btn-success">
										Small .btn-sm
									</button>
									<button type="button" class="btn ripple-click-effect btn-rounded btn-xs btn-info">
										Tiny .btn-xs
									</button>
								</div>
							</div>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-block btn-success</code> to quickly create a General btn.
								</h6>

								<div class="row button-group">
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-info">
											Info
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-success">
											Success
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-primary">
											Primary
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-danger">
											Danger
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-secondary">
											Secondary
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn ripple-click-effect btn-block btn-warning">
											Warning
										</button>
									</div>
								</div>
							...
							<div class="card-body">
								...
								<div class="row button-group">
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-info">
											Info
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-success">
											Success
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
									...
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-danger">
											Danger
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-secondary">
											Secondary
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-warning">
											Warning
										</button>
									</div>
								</div>
							...
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-block btn-outline-success</code> to quickly create a General btn.
								</h6>
							...
							<div class="card-body">
								...
								<div class="row button-group">
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-info">
											Info
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-success">
											Success
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-primary">
											Primary
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-danger">
											Danger
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-secondary">
											Secondary
										</button>
									</div>
									<div class="col-lg-2 col-md-4">
										<button type="button" class="btn btn-rounded btn-block btn-outline-warning">
											Warning
										</button>
									</div>
								</div>
							...
							<div class="card-body">
								...
								<h6 class="card-subtitle">Use a classes
									<code>btn btn-block btn-lg btn-success</code> to quickly create a General btn.
								</h6>
						...
						<div class="card">
							<div class="card-body">
								...
								<a class="btn btn-block btn-social btn-adn">
									<i class="fab fa-adn"></i> Sign in with App.net
								</a>
								...
								<a class="bn btn-block btn-social btn-github">
								...
								<a class="btn btn-block btn-social btn-odnoklassniki">
									<i class="fab fa-odnoklassniki"></i> Sign in with Odnoklassniki
								</a>
								<a class="btn btn-block btn-social btn-openid">
									<i class="fab fa-openid"></i> Sign in with OpenID
								</a>
								<a class="btn btn-block btn-social btn-pinterest">
									<i class="fab fa-pinterest"></i> Sign in with Pinterest
								</a>
								<a class="btn btn-block btn-social btn-reddit">
									<i class="fab fa-reddit"></i> Sign in with Reddit
								</a>
								<a class="btn btn-block btn-social btn-soundcloud">
									<i class="fab fa-soundcloud"></i> Sign in with SoundCloud
								</a>
								...
								<a class="btn btn-block btn-social btn-vimeo">
									<i class="fab fa-vimeo-square"></i> Sign in with Vimeo
								</a>
