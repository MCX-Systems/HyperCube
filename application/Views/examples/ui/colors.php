			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Colors examples</h4>
								<h6 class="card-subtitle">Use of <code>varius color</code> class
									<code>for template</code>.
								</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-sm-4 col-lg-2">
						<div class="card">
							<div class="bg-primary p-4"><span>primary</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-danger p-4"><span>danger</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-success p-4"><span>success</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-warning p-4"><span>warning</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-info p-4"><span>info</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-secondary p-4"><span>secondary</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-dark p-4"><span>dark</span></div>
						</div>
					</section>

					<section class="col-sm-4 col-lg-2">
						<div class="card mb-3">
							<div class="bg-white p-4"><span>white</span></div>
						</div>
					</section>
