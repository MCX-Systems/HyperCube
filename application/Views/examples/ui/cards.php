			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
                                <h4 class="card-title text-warning">Cards examples</h4>
								<h6 class="card-subtitle mb-2 text-muted">Use of
									<code>extended</code> bootstrap 4 <code>cards</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-lg-4 col-xlg-3 col-md-5">
						<div class="card">
							<div class="user-bg">
								<img alt="user" src="<?php echo base_url() ?>uploads/pictures/9.jpg" class="img-fluid">
							</div>
							...
							<div class="card-body">
								...
								<hr />
								<div class="row text-center mt-1">
									<div class="col-md-6 border-right border-warning"><strong>Email ID</strong>
								...
								<div class="row mt-1">
									...
									<div class="col-md-4 col-sm-4 text-center">
										<p class="text-danger"><i class="fab fa-google"></i></p>
										<h1>140</h1>
									</div>
								</div>
							</div>
					...
					<section class="col-lg-8 col-xlg-9 col-md-7">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-md-3 col-xs-6 border-right border-warning">
								...
								<h4 class="card-title pb-1 border-bottom border-warning text-warning">Skill Set</h4>
								<h5 class="mt-3">Wordpress <span class="pull-right">80%</span></h5>
								...
								<h5 class="mt-3">HTML 5 <span class="pull-right">90%</span></h5>
								<div class="progress progress-xs">
								...
								<h5 class="mt-3">jQuery <span class="pull-right">50%</span></h5>
								<div class="progress progress-xs">
								...
								<h5 class="mt-3">Photoshop <span class="pull-right">70%</span></h5>
								<div class="progress progress-xs">
								...
								<!-- Certification -->
								<h4 class="card-title mt-3 pb-1 border-bottom border-warning text-warning">Certification</h4>
								<div class="d-flex no-block">
									<i class="fas fa-check-circle fa-fw text-success"></i>
									<h6 class="ml-1 text-success">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6>
								</div>

								<div class="d-flex no-block">
									<i class="fas fa-check-circle fa-fw text-success"></i>
									<h6 class="ml-1 text-success">Excepteur sint occaecat cupidatat non proident.</h6>
								</div>

								<div class="d-flex no-block">
									<i class="fas fa-check-circle fa-fw text-danger"></i>
									<h6 class="ml-1 text-danger">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6>
								</div>

								<div class="d-flex no-block">
									<i class="fas fa-check-circle fa-fw text-warning"></i>
									<h6 class="ml-1 text-warning">Excepteur sint occaecat cupidatat non proident.</h6>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card-deck">
							<div class="card">
								<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" class="card-img-top" />
								<div class="card-body">
									<h4 class="card-title text-warning">Card title</h4>
									<p class="card-text">
					...
					<section class="col-md-12 mb-3">
						<div class="card bg-secondary">
							<div class="row">
								<div class="col-md-4">
									<img src="<?php echo base_url() ?>uploads/pictures/landscape3.jpg" class="img-fluid h-100" />
								</div>
								<div class="col-md-8">
									<div class="bg-dark p-3 h-100">
										<h4 class="card-title text-warning">Lorem ipsum dolor sit amet</h4>
										<p class="card-text">
					...
					<section class="col-md-12">
						<div class="card bg-info">
							<div class="row">
								...
								<div class="col-md-4">
									<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" class="img-fluid h-100"/>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-4 col-sm-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="mb-2">
									<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" class="img-fluid" />
								</div>
								...
								<a href="#" class="btn btn-primary btn-block">
									<i class="fas fa-eye mr-3"></i>Watch Now
								</a>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<h4 class="card-title text-warning">Special title treatment</h4>
								<p class="card-text">
					...
					<section class="col-md-4 mb-3">
						<div class="card">
							<img class="card-img-top" src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="Card image cap" />
							<div class="card-body">
								<h4 class="card-title text-warning">Card title</h4>
								<p class="card-text">
					...
					<section class="col-md-4 mb-3">
						<div class="card">
							<img class="card-img-top" src="<?php echo base_url() ?>uploads/pictures/post-9.jpg" alt="Card image cap" />
							<div class="card-body">
								<h4 class="card-title text-warning">Card title</h4>
								<p class="card-text">
									Some quick example text to build on the card title and make up the bulk
					...
					<section class="col-md-12">
						<div class="card-deck">
							<div class="card">
								<img src="<?php echo base_url() ?>uploads/pictures/post-8.jpg" class="card-img-top" />
								<div class="card-body">
									<h4 class="card-title text-warning">Card title</h4>
									<p class="card-text">
							...
							<div class="card">
								<img src="<?php echo base_url() ?>uploads/pictures/post-7.jpg" class="card-img-top" />
								<div class="card-body">
									<h4 class="card-title text-warning">Card title</h4>
									<p class="card-text">
										This card has supporting text below as a natural lead-in to
							...
							<div class="card">
								<img src="<?php echo base_url() ?>uploads/pictures/post-6.jpg" class="card-img-top" />
								<div class="card-body">
									<h4 class="card-title text-warning">Card title</h4>
									<p class="card-text">
										This is a wider card with supporting text below as a natural
					...
					<section class="col-md-6">
						<div class="card">
							<img class="card-img-top" src="<?php echo base_url() ?>uploads/pictures/post-3.jpg" alt="Card image cap" />
							<div class="card-body">
								<h4 class="card-title text-warning">Card title</h4>
								<p class="card-text">
					...
					<section class="col-md-6">
						<div class="card">
							...
							<img class="card-img-bottom" src="<?php echo base_url() ?>uploads/pictures/post-4.jpg" alt="Card image cap" />
						</div>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							<img class="card-img-top" src="<?php echo base_url() ?>uploads/pictures/post-10.jpg" alt="Card image cap" />
							<div class="card-body">
								<p class="card-title text-warning pt-3">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<button class="btn btn-primary btn-sm float-right mt-2">Read More</button>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="text-warning text-right">
									<span class="mr-1"><i class="fas fa-calendar mr-2"></i>May 16</span>
									<a class="text-danger ml-1" href="#">
										<i class="fas fa-heart mr-2"></i>38
									</a>
								</div>
								<h4 class="card-title text-warning">Card title</h4>
								<p class="card-text">
								...
								<div class="row">
									<div class="col-md-12 text-center">
										<a class="btn btn-social-icon btn-xs btn-facebook"><i class="fab fa-facebook"></i></a>
										<a class="btn btn-social-icon btn-xs btn-google"><i class="fab fa-google"></i></a>
										<a class="btn btn-social-icon btn-xs btn-microsoft"><i class="fab fa-windows"></i></a>
										<a class="btn btn-social-icon btn-xs btn-twitter"><i class="fab fa-twitter"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-md-6">
						<div class="card">
							<div class="card-header">
								<span class="card-title text-warning">Card columns</span>
							</div>
							<div class="card-body">
								<div class="card-columns">
									<!-- Card 1 -->
									<div class="card">
										<div class="card-header text-warning p-2">Card 1</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
									<div class="card">
										<div class="card-header text-warning p-2">Card 2</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
									<div class="card">
										<div class="card-header text-warning p-2">Card 3</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
									<div class="card">
										<div class="card-header text-warning p-2">Card 4</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
									<div class="card">
										<div class="card-header text-warning p-2">Card 5</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
									<div class="card">
										<div class="card-header text-warning p-2">Card 6</div>
										<div class="card-body">
											<p class="card-text">Text for this card.</p>
										</div>
									</div>
					...
					<section class="col-md-3">
						<div class="card bg-light mb-3">
							...
							<div class="card-body">
								<h5 class="card-title text-dark">Light card title</h5>
									...
									<ul class="icons-list">
										<li>
											<a data-action="collapse">
												<i class="fas fa-chevron-down fa-fw ml-3"></i>
											</a>
										</li>
										<li>
											<a data-action="reload">
												<i class="fas fa-sync fa-fw ml-3"></i>
											</a>
										</li>
										<li>
											<a data-action="close">
												<i class="fas fa-window-close fa-fw ml-3"></i>
											</a>
										</li>
									</ul>
								</div>
									...
									<ul class="icons-list">
										...
										<li>
											<a data-action="expand">
												<i class="fas fa-expand-arrows-alt fa-fw ml-3"></i>
											</a>
										</li>
										<li>
											<a data-action="reload">
