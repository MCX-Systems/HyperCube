			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Switches, checkboxes and radio examples</h4>
								<h6 class="card-subtitle">Use of Switches, checkboxes and radio examples - class.</h6>
							</div>
						</div>
					</section>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="on-off-switch">
											<input name="TestSwitch1" class="on-off-switch-checkbox" id="TestSwitch1" type="checkbox"
											       checked="checked" />
										...
										<div class="on-off-switch">
											<input name="TestSwitch2" class="on-off-switch-checkbox" id="TestSwitch2" type="checkbox" />
									...
									<div class="col-md-6">
										<div class="on-off-switch switch-lg">
											<input name="TestSwitch4" class="on-off-switch-checkbox" id="TestSwitch4" type="checkbox"
											       checked="checked" />
										...
										<div class="on-off-switch switch-lg">
											<input name="TestSwitch5" class="on-off-switch-checkbox" id="TestSwitch5" type="checkbox" />
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<span class="card-title">Checkbox Input</span>
							</div>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-12 col-xl-6 mb-3">
										...
										<div class="border-checkbox-section">
											<div class="border-checkbox-group border-checkbox-group-secondary">
									...
									<div class="col-sm-12 col-xl-6 mb-3">
										...
										<div class="checkbox-fade fade-in-secondary">
											<label>
										...
										<div class="checkbox-fade fade-in-warning">
											<label>
												<input type="checkbox" value="">
												<span class="cr">
                                                <i class="cr-icon fas fa-check text-warning"></i>
                                                </span>
												<span> Warning</span>
											</label>
										</div>
										...
										<div class="checkbox-fade fade-in-disable">
											<label>
												...
												<span class="cr">
                                                <i class="cr-icon fas fa-check text-default"></i>
                                             </span>
												<span>Disabled</span>
											</label>
										</div>
								...
								<div class="row">
									...
									<div class="col-sm-12 col-xl-6 mb-3">
										...
										<div class="checkbox-zoom zoom-secondary">
											<label>
												<input type="checkbox" value="">
												<span class="cr">
                                                <i class="cr-icon fas fa-check text-secondary"></i>
                                             </span>
												<span>Secondary</span>
											</label>
										</div>
					...
					<section class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<span class="card-title">Radio Input</span>
							</div>
							...
							<div class="card-body">
								...
								<div class="form-radio mb-3">
									<form>
										<div class="radio radiofill radio-white radio-inline">
											<label>
												<input type="radio" name="radio" checked="checked">
												<i class="helper"></i>White Color
											</label>
										</div>
								...
								<div class="form-radio mb-3">
									<form>
										<div class="radio radio-material radio-white radio-inline">
											<label>
												<input type="radio" name="radio" checked="checked">
												<i class="helper"></i>White Color
											</label>
										</div>
										<div class="radio radio-material radio-primary radio-inline">
											<label>
												<input type="radio" name="radio" checked="checked">
												<i class="helper"></i>Primary Color
											</label>
