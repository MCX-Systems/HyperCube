			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Forms Wizards</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Forms Wizards examples</h4>
								<h6 class="card-subtitle">
									Use of <code>extended</code> bootstrap 4
									<code> form wizards</code>.
								</h6>
							</div>
						</div>
					</section>
							...
							<div class="card-body">
								...
								<form class="stepy-basic" action="#">
									<fieldset title="1" class="stepy-step">
										<legend class="text-semibold stepy-legend text-warning">Personal data</legend>

										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Select location:
													<select name="location" data-placeholder="Select position" class="select2">
														<option></option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select name="position" data-placeholder="Select position" class="select2">
														<option></option>
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<select name="birth-month" data-placeholder="Month" class="select2">
																<option></option>
													...
													<div class="col-md-4">
														<div class="form-group">
															<select name="birth-day" data-placeholder="Day" class="select2">
																<option></option>
													...
													<div class="col-md-4">
														<div class="form-group">
															<select name="birth-year" data-placeholder="Year" class="select2">
																<option></option>
																<option value="1">1980</option>
																<option value="2">1981</option>
																<option value="3" selected>1982</option>
									...
									<fieldset title="2" class="stepy-step">
										<legend class="text-semibold stepy-legend text-warning">Your education</legend>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Country:</label>
													<select name="university-country" data-placeholder="Choose a Country..." class="select2">
														<option></option>
														<option value="1">United States</option>
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<select name="education-from-month" data-placeholder="Month" class="select2">
																		<option></option>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<select name="education-from-year" data-placeholder="Year" class="select2">
																		<option></option>
													...
													<div class="col-md-6">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<select name="education-to-month" data-placeholder="Month" class="select2">
																		<option></option>
																		<option value="January">January</option>
																		<option value="...">...</option>
																		<option value="December">December</option>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<select name="education-to-year" data-placeholder="Year" class="select2">
																		<option></option>
																		<option value="1995">1995</option>
																		<option value="...">...</option>
																		<option value="1980">1980</option>
									...
									<fieldset title="3" class="stepy-step">
										<legend class="text-semibold stepy-legend">Your experience</legend>
										...
										<div class="row">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<select name="experience-from-month" data-placeholder="Month" class="select2">
																		<option></option>
																		<option value="January">January</option>
																		<option value="...">...</option>
																		<option value="December">December</option>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<select name="experience-from-year" data-placeholder="Year" class="select2">
																		<option></option>
																		<option value="1995">1995</option>
																		<option value="...">...</option>
																		<option value="1980">1980</option>
													...
													<div class="col-md-6">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<select name="experience-to-month" data-placeholder="Month" class="select2">
																		<option></option>
																		<option value="January">January</option>
																		<option value="...">...</option>
																		<option value="December">December</option>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<select name="experience-to-year" data-placeholder="Year" class="select2">
																		<option></option>
																		<option value="1995">1995</option>
																		<option value="...">...</option>
																		<option value="1980">1980</option>
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<input name="recommendations" type="file" class="form-control" />
									...
									<fieldset title="4" class="stepy-step">
										<legend class="text-semibold stepy-legend">Additional info</legend>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select name="source" data-placeholder="Choose an option..." class="select2">
														<option></option>
												...
												<div class="form-group form-radio">
													<div class="radio radiofill radio-primary">
														...
														<label class="mt-2">
															...
															<i class="helper"></i>Immediately
														</label>
														<label>
															<input type="radio" name="availability" />
															<i class="helper"></i>1 - 2 weeks
														</label>
														<label>
															<input type="radio" name="availability" />
															<i class="helper"></i>3 - 4 weeks
														</label>
														<label>
															<input type="radio" name="availability" />
															<i class="helper"></i>More than 1 month
														</label>
													</div>
												</div>
											</div>
									...
									<div class="float-right">
										<button type="submit" class="btn btn-danger stepy-back"><i class="fas fa-arrow-circle-left btn-ic fa-fw float-left mr-2"></i>Previus</button>
										<button type="submit" class="btn btn-info stepy-next">Next<i class="fas fa-arrow-circle-right fa-fw float-right ml-2"></i></button>
										<button type="submit" class="btn btn-success stepy-finish">Submit<i class="fas fa-check-circle fa-fw float-right ml-2"></i></button>
									</div>
								</form>
							</div>
						</div>
					...
					<script type="text/javascript">
						jQuery(document).ready(function ()
						{
							...
							$.fn.stepy.defaults.duration = 500;
							// Basic wizard setup
							$(".stepy-basic").stepy();
						});
					</script>
