			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Animations examples</h4>
					...
					<section class="col-md-12">
						<div class="row">
							<div class="col-md-2 pulse pulse1 text-center">Pulse-1</div>
							<div class="col-md-2 pulse pulse2 text-center">Pulse-2</div>
							<div class="col-md-2 pulse pulse3 text-center">Pulse-3</div>
							<div class="col-md-2 pulse pulse4 text-center">Pulse-4</div>
							<div class="col-md-2 pulse pulse5 text-center">Pulse-5</div>
							<div class="col-md-2 pulse pulse6 text-center">Pulse-6</div>
						</div>

						<script type="text/javascript">
							$(function ()
							{
								$(".pulse1").pulsate({glow:false,color:"#09f"});
								$(".pulse2").pulsate({color:"#09f"});
								$(".pulse3").pulsate({reach:100,color:"#09f"});
								$(".pulse4").pulsate({speed:2500,color:"#09f"});
								$(".pulse5").pulsate({pause:1000,color:"#09f"});
								$(".pulse6").pulsate({onHover:true,color:"#09f"});
							});
						</script>
					</section>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper">
							<div class="sonar-emitter bg-danger">
								<div class="sonar-wave bg-danger"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper">
							<div class="sonar-emitter bg-info">
								<div class="sonar-wave bg-info"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper">
							<div class="sonar-emitter bg-warning">
								<div class="sonar-wave bg-warning"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper">
							<div class="sonar-emitter bg-success">
								<div class="sonar-wave bg-success"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper sonar-lg">
					...
					<section class="col-md-3">
						<div class="sonar-wrapper sonar-sm">
							<div class="sonar-emitter">
								<div class="sonar-wave"></div>
							</div>
						</div>
					...
					<section class="col-md-3">
						<div class="sonar-wrapper sonar-xs">
							<div class="sonar-emitter">
								<div class="sonar-wave"></div>
							</div>
						</div>
					...
					<section class="col-md-6 col-sm-6 mb-3">
						...
						$(document).ready(function () {
							...
							$("#bi").on("click",
								function () {
									...
									$("#bi").addClass("animated bounceIn").one(animationEnd,
										function () {
							...
							$("#bil").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#bil").addClass("animated bounceInLeft").one(animationEnd,
										function () {
							...
							$("#bir").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#bir").addClass("animated bounceInRight").one(animationEnd,
										function () {
							...
							$("#bo").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#bo").addClass("animated bounceOut").one(animationEnd,
										function () {
							...
							$("#pul").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#pul").addClass("animated pulse").one(animationEnd,
										function () {
							...
							$("#tad").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#tad").addClass("animated tada").one(animationEnd,
										function () {
							...
							$("#rubber").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rubber").addClass("animated rubberBand").one(animationEnd,
										function () {
							...
							$("#swing").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#swing").addClass("animated swing").one(animationEnd,
										function () {
							...
							$("#wobble").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#wobble").addClass("animated wobble").one(animationEnd,
										function () {
							...
							$("#fadein").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#fadein").addClass("animated fadeIn").one(animationEnd,
										function () {
							...
							$("#fadeleft").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#fadeleft").addClass("animated fadeInLeft").one(animationEnd,
										function () {
							...
							$("#faderight").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#faderight").addClass("animated fadeInRight").one(animationEnd,
										function () {
							...
							$("#fadeout").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#fadeout").addClass("animated fadeOut").one(animationEnd,
										function () {
							...
							$("#flip").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#flip").addClass("animated flip").one(animationEnd,
										function () {
							...
							$("#flipy").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#flipy").addClass("animated flipInY").one(animationEnd,
										function () {
							...
							$("#flipoutx").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#flipoutx").addClass("animated flipOutX").one(animationEnd,
										function () {
							...
							$("#flipouty").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#flipouty").addClass("animated flipOutY").one(animationEnd,
										function () {
							...
							$("#rotatein").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rotatein").addClass("animated rotateIn").one(animationEnd,
										function () {
							...
							$("#rotatedownright").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rotatedownright").addClass("animated rotateInDownRight").one(animationEnd,
										function () {
							...
							$("#rotateout").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rotateout").addClass("animated rotateOut").one(animationEnd,
										function () {
							...
							$("#rotateoutleft").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rotateoutleft").addClass("animated rotateOutUpLeft").one(animationEnd,
										function () {
							...
							$("#zoomin").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#zoomin").addClass("animated zoomIn").one(animationEnd,
										function () {
							...
							$("#zoominleft").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#zoominleft").addClass("animated zoomInLeft").one(animationEnd,
										function () {
							...
							$("#zoomoutdown").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#zoomoutdown").addClass("animated zoomOutDown").one(animationEnd,
										function () {
							...
							$("#zoomoutright").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#zoomoutright").addClass("animated zoomOutRight").one(animationEnd,
										function () {
							...
							$("#hinge").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#hinge").addClass("animated hinge").one(animationEnd,
										function () {
							...
							$("#rollin").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rollin").addClass("animated rollIn").one(animationEnd,
										function () {
							...
							$("#rollout").on("click",
								function () {
									const animationEnd = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
									$("#rollout").addClass("animated rollOut").one(animationEnd,
										function () {
