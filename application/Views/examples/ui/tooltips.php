			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Tooltips examples</h4>
								<h6 class="card-subtitle">
									Use of tooltips with <code>data-toggle="tooltip" data-placement="*"</code> class.
								</h6>
							</div>
						</div>
					</section>
						...
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Just put this to any tag
									<code>data-toggle="tooltip" title="Default tooltip"</code>
								</h6>
					...
					<section class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Interactive demo</h4>
								<h6 class="card-subtitle">Just put this to any tag
									<code>data-toggle="popover" data-placement="top" data-content="..."</code>
								</h6>

								<div class="button-box">
									<button type="button" class="btn btn-secondary" title="Popover" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
										Popover on top
									</button>
									...
									<button type="button" class="btn btn-secondary" title="Popover" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
										Popover on bottom
									</button>
