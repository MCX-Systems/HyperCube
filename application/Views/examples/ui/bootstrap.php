			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Bootstrap default components examples</h4>
					...
					<section class="col-md-2">
						<img class="img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="No filter: Balham High Road and a rainbow" />
					</section>

					<section class="col-md-2">
						<img class="filter_blur img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="Blur filter: Balham High Road and a rainbow" />
					</section>

					<section class="col-md-2">
						<img class="filter_grayscale img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="Grayscale filter: Balham High Road and a rainbow" />
					</section>

					<section class="col-md-2">
						<img class="filter_saturate img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="Saturate filter: Balham High Road and a rainbow" />
					</section>

					<section class="col-md-2">
						<img class="filter_sepia img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="Sepia filter: Balham High Road and a rainbow" />
					</section>

					<section class="col-md-2">
						<img class="filter_multi img-thumbnail" src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="Blur, invert and opacity filters: Balham High Road and a rainbow" />
					</section>
					...
					<section class="col-lg-6">
						<h5 class="card-title">Carousel with indicators</h5>
						<h6 class="card-subtitle">You can also add the indicators to the carousel, alongside the controls,
							too.</h6>
						<div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner" role="listbox">
								<div class="carousel-item active">
									<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/post-7.jpg"
									     alt="First slide" />
								</div>
								<div class="carousel-item">
									<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/post-8.jpg"
									     alt="Second slide" />
								</div>
								<div class="carousel-item">
									<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/post-9.jpg"
									     alt="Third slide" />
								</div>
							</div>
					...
					<section class="col-lg-6">
						...
						<div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner" role="listbox">
								<div class="carousel-item active">
									<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/post-10.jpg"
									     alt="First slide">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h5 class="card-title">Grids - cols and rows</h5>
								<h6 class="card-subtitle">Add cols and rows easily with the
									<code>.col-*</code>
								</h6>
								...
								<!-- Start -->
								<div class="row">
									<div class="col-sm test">One of three columns
										<hr/>
									</div>
					...
					<section class="col-md-6">
						<h5 class="card-title">Figure with Caption left</h5>

						<figure class="figure">
							<img src="<?php echo base_url() ?>uploads/pictures/8.jpg" class="figure-img img-fluid rounded"
					...
					<section class="col-md-6">
						<h5 class="card-title">Figure with Caption right</h5>

						<figure class="figure">
							<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" class="figure-img img-fluid rounded"
							     alt="A generic square placeholder image with rounded corners in a figure." />
					...
					<section class="col-md-12">
						<span class="border ml-2">Border</span>
						<span class="border-top ml-2">Border Top</span>
						<span class="border-right ml-2">Border-Right</span>
						<span class="border-bottom ml-2">Border-Bottom</span>
						<span class="border-left ml-2">Border-Left</span>
					</section>
					...
					<section class="col-md-12">
						<span class="border-0 ml-2">No Borders</span>
						<span class="border border-top-0 ml-2">No Border Top</span>
						<span class="border border-right-0 ml-2">No Border Right</span>
						<span class="border border-bottom-0 ml-2">No Border Bottom</span>
						<span class="border border-left-0 ml-2">No Border Left</span>
					</section>
					...
					<section class="col-md-12">
						<span class="border border-primary ml-2">Border Primary</span>
						<span class="border border-secondary ml-2">Border Secondary</span>
						<span class="border border-success ml-2">Border Success</span>
						<span class="border border-danger ml-2">Border Danger</span>
						<span class="border border-warning ml-2">Border Warning</span>
						<span class="border border-info ml-2">Border Info</span>
						<span class="border border-light ml-2">Border Light</span>
						<span class="border border-dark ml-2">Border Dark</span>
						<span class="border border-white ml-2">Border White</span>
					</section>
					...
					<section class="col-md-12">
						<img src="<?php echo base_url() ?>uploads/pictures/m3.jpg" alt="Rounded" class="rounded" />
						<img src="<?php echo base_url() ?>uploads/pictures/m4.jpg" alt="Rounded-top" class="rounded-top" />
						<img src="<?php echo base_url() ?>uploads/pictures/m5.jpg" alt="Rounded-right" class="rounded-right" />
						<img src="<?php echo base_url() ?>uploads/pictures/m6.jpg" alt="Rounded-bottom" class="rounded-bottom" />
						<img src="<?php echo base_url() ?>uploads/pictures/m4.jpg" alt="Rounded-left" class="rounded-left" />
						<img src="<?php echo base_url() ?>uploads/pictures/m5.jpg" alt="Rounded-circle" class="rounded-circle" />
						<img src="<?php echo base_url() ?>uploads/pictures/m6.jpg" alt="Rounded-0" class="rounded-0" />
					</section>
					...
					<section class="col-md-12">
						<img src="<?php echo base_url() ?>uploads/pictures/7.jpg" class="img-fluid" alt="Responsive image" />
					</section>
					...
					<section class="col-md-12">
						<img src="<?php echo base_url() ?>uploads/pictures/8.jpg" alt="Image Thumbnail" class="img-thumbnail" />
					</section>
					...
					<section class="col-md-12">
						<div class="jumbotron bg-info">
							...
							<p class="lead">
								...
								ttention to featured content or information.
							</p>
							<hr />
							<p>
