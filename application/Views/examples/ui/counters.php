			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Counters examples</h4>
					...
					<div class="col-md-3 col-sm-6">
						<div class="counter">
							<div class="counter-content">
								<div class="counter-icon fas fa-globe"></div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="counter danger">
							<div class="counter-content">
								<div class="counter-icon fas fa-rocket"></div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="counter info">
							<div class="counter-content">
								<div class="counter-icon fas fa-briefcase"></div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="counter success">
							<div class="counter-content">
								<div class="counter-icon fas fa-mobile"></div>
						...
						<div class="card">
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-3 col-sm-6">
										<div class="counter danger counter-md">
											<div class="counter-content">
												<div class="counter-icon fas fa-rocket"></div>
												<span class="counter-value">952</span>
											</div>
									...
									<div class="col-md-3 col-sm-6">
										<div class="counter info counter-sm">
											<div class="counter-content">
												<div class="counter-icon fas fa-briefcase"></div>
												<span class="counter-value">578</span>
											</div>
									...
									<div class="col-md-3 col-sm-6">
										<div class="counter success counter-xs">
											<div class="counter-content">
												<div class="counter-icon fas fa-mobile"></div>
												<span class="counter-value">1450</span>
											</div>
					...
					<div class="col-md-3 col-sm-6">
						<h3>Example heading <span class="badge badge-success counter-value">3000</span></h3>
						<h3>Example heading <span class="badge badge-info counter-value">10000</span></h3>
					</div>
