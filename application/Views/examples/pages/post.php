								...
								<div class="card mb-1">
									<div class="card-body">
										...
										<div class="post-content">
												...
												<div id="carousel-post" class="carousel slide" data-ride="carousel">
													...
													<div class="carousel-inner" role="listbox">
														<div class="carousel-item active">
															<a href="<?php echo base_url() ?>pages/postsDetails">
																<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/slider-1-cover.jpg"
																     alt="First slide" />
															</a>
														</div>
														...
														<div class="carousel-item">
															<a href="<?php echo base_url() ?>pages/postsDetails">
																<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/slider-2-cover.jpg"
																     alt="Second slide" />
															</a>
														</div>
														...
														<div class="carousel-item">
															<a href="<?php echo base_url() ?>pages/postsDetails">
																<img class="img-fluid" src="<?php echo base_url() ?>uploads/pictures/slider-3-cover.jpg"
																     alt="Third slide" />
															</a>
														</div>
													</div>
											...
											<div class="post-info">
												<h4 class="post-title">
													<a href="<?php echo base_url() ?>pages/postsDetails">Bootstrap Carousel Blog Post</a>
												</h4>
											...
											<div class="post-read-btn-container">
												<a href="<?php echo base_url() ?>pages/postsDetails" class="read-btn">Read More <i class="fas fa-angle-double-right"></i></a>
											</div>
									...
									<div class="card-body">
										...
										<div class="post-content">
											...
											<div class="post-image">
												<a href="<?php echo base_url() ?>pages/postsDetails"><img src="<?php echo base_url() ?>uploads/pictures/slider-1-cover.jpg" alt="" /></a>
											</div>
											<!-- end post-image -->
											...
											<div class="post-info">
												<h4 class="post-title">
													<a href="<?php echo base_url() ?>pages/postsDetails">Demonstration Blog Post</a>
												</h4>
												...
												<div class="post-by">
													...
													<a href="#">Parachute</a>,
													<a href="#">Blue Sky</a>
													<span class="divider">|</span> 12 Comments
												</div>
								...
								<div class="card mb-1">
									<div class="card-body">
										...
										<div class="post-content">
											...
											<div class="post-info">
												<h4 class="post-title">
													<a href="<?php echo base_url() ?>pages/postsDetails">Blog Post Video</a>
												</h4>
												...
												<div class="post-by">
													...
													<a href="#">Minions</a>,
													<a href="#">Trailer</a>
													<span class="divider">|</span> 1,292 Comments
												</div>
									...
									<div class="card-body">
										...
										<div class="post-content">
											...
											<blockquote class="blockquote-info">
												...
												technology and the world of people and human purposes - and you try to bring the two together.'
											</blockquote>
											<!-- end blockquote -->
											...
											<div class="post-info">
												<h4 class="post-title">
													<a href="<?php echo base_url() ?>pages/postsDetails">Blockquote Post</a>
												</h4>
