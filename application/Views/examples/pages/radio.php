			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">FM-Radio</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-5 mt-3">
						<article id="radio1"
						         data-type="radio"
						         data-title="Heart London"
						         data-artist="106.2 From data tag"
						         data-artwork="<?php echo base_url() ?>uploads/img/music2.jpg"
						         data-trackurl="http://208.77.21.33:12310/;"></article>
					</section>

					<section class="col-md-4 mt-3">
						<article id="radio2"></article>
					</section>

					<section class="col-md-3 mt-3">
						<article id="radio3"></article>
					</section>

					<section class="col-md-5 mt-3">
						<article id="radio4"></article>
					</section>

					<section class="col-md-4 mt-3">
						<article id="radio5"></article>
					</section>

					<section class="col-md-3 mt-3">
						<article id="radio6"></article>
					</section>

					<script type="text/javascript">
						$(document).ready(function ()
						{
							$("#radio1").multiAudioPlayer({
								grabRadioRds: true,
								grabLastFmPhoto: true,
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});

							$("#radio2").multiAudioPlayer({
								size: "medium",
								type: "radio",
								grabRadioRds: true,
								...
								title: "Heart London",
								artist: "106.2",
								trackUrl: "http://108.61.30.179:4000/;",
								artwork: global_base_url + "/uploads/img/music2.jpg",
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});

							$("#radio3").multiAudioPlayer({
								size: "small",
								type: "radio",
								grabRadioRds: false,
								grabLastFmPhoto: true,
								title: "Heart London",
								artist: "106.2",
								trackUrl: "http://74.208.71.58:8000/;",
								artwork: global_base_url + "/uploads/img/music2.jpg",
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});

							$("#radio4").multiAudioPlayer({
								type: "radio",
								title: "Heart London",
								artist: "106.2",
								trackUrl: "http://radioscoop.hu:80/live.mp3",
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});

							$("#radio5").multiAudioPlayer({
								size: "medium",
								type: "radio",
								title: "Heart London",
								artist: "106.2",
								trackUrl: "http://us3.internet-radio.com:8007/;stream",
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});

							$("#radio6").multiAudioPlayer({
								size: "small",
								type: "radio",
								title: "FM4",
								artist: "106.2",
								trackUrl: "http://mp3stream1.apasf.apa.at:8000/;",
								pathToAjaxFiles: global_base_url + "/assets/javascript/js/core/level-4/media/"
							});
						});
					</script>
