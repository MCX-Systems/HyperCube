			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd5.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>

								<div class="p-3 bg-info mb-5">
									<div class="p-0">
										<h4>
											<a class="text-light" href="#">Florida 5, Pinecrest, FL</a>
										</h4>
										<h4 class="text-danger"><strong>€</strong> 220,000</h4>
									</div>
								</div>

								<hr />
								<span class="badge widget-property-label badge-dark border-warning">For Rent</span>
								<div class="mt-3">
									<ul class="p-2 list-group text-muted mb-0">
										<li class="list-group-item mb-1">
											<span><i class="fas fa-bath fa-fw text-warning mr-2"></i></span>
											<span>Bathrooms</span>
											<span class="badge badge-info float-right">2</span>
										</li>
										<li class="list-group-item mb-1">
											<span><i class="fas fa-bed fa-fw text-warning mr-2"></i></span>
											<span>Beds</span>
											<span class="badge badge-info float-right">2</span>
										</li>
										<li class="list-group-item mb-1">
											<span><i class="fas fa-car fa-fw text-warning mr-2"></i></span>
											<span>Garages</span>
								...
								<div class="mt-0">
									...
									<div class="p-4 float-left">
										<h5 class="mb-0 text-warning">Janet Richmond</h5>
										<small class="text-muted">5 Properties</small>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd8.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd10.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd2.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd3.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd7.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd11.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
					...
					<section class="col-sm-6 col-md-3 col-lg-3">
						<div class="card mb-3">
							<div class="card-body p-0">
								<div class="widget-property-list-img" style="background: url('<?php echo base_url() ?>uploads/pictures/vd12.jpg') center center / cover no-repeat;">
									<span class="widget-property-label-img">
										<span><i class="fas fa-heart fa-fw fa-2x"></i></span>
									</span>
								</div>
