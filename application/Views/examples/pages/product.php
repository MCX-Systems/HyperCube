			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h3 class="text-danger">Rounded Chair</h3>
								<h6 class="card-subtitle">Globe type chair for rest</h6>
								<div class="row mt-2">
									<div class="col-lg-3 col-md-3 col-sm-6">
										<div class="text-center">
											<img src="<?php echo base_url() ?>uploads/pictures/9.jpg" class="img-fluid" alt="" />
										</div>
									</div>

									<div class="col-lg-9 col-md-9 col-sm-6">
										<h3 class="card-title text-danger">Product description</h3>
										<p>
										...
										<h3 class="text-danger mt-4">Key Highlights</h3>
										<ul class="list-unstyled">
											<li><i class="fas fa-check text-success mr-2"></i>Sturdy structure</li>
											<li><i class="fas fa-check text-success mr-2"></i>Designed to foster easy portability</li>
											<li><i class="fas fa-check text-success mr-2"></i>Perfect furniture to flaunt your wonderful collectibles</li>
										</ul>
									</div>

									<div class="col-lg-12 col-md-12 col-sm-12">
										<h3 class="text-danger mt-4">General Info</h3>
