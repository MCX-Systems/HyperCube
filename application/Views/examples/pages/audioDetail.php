			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Audio Detail</li>
					</ul>
				</div>
				<!-- ============================================================== -->
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row text-center mt-1">
									<div class="col-md-12 border-bottom border-warning mb-3 pb-2">
										<h5 class="card-title text-warning">John Doe</h5>
										<h6>Singer and artist</h6>
									</div>
								...
								<hr />
								<div class="row text-center mt-1">
									<div class="col-md-6 border-right border-warning"><strong>Albums</strong>
										<p>20</p>
									</div>
								...
								<div class="row text-center mt-1">
									<div class="col-md-12">
										...
										<p>Partizanska 34<br />9000, Murska Sobota, Slovenija.</p>
									</div>
								</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<p>
									...
									It has survived not only five centuries It was popularised in the 1960s with the
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<tr>
											...
											<td class="text-warning">The song of ice and fire</td>
											<td>Lord Stark</td>
											<td>04:48</td>
										...
										<tr>
											<td>
												<a href="#" data-toggle="tooltip" data-original-title="Playing"><i class="fas fa-pause-circle text-danger"></i></a>
											</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">Blackwood</td>
											<td>T. Lannister</td>
											<td>03:33</td>
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Download" class="link"><i class="fas fa-download mr-2"></i></a>
										...
										<tr>
											<td>3</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">Shut Up Society</td>
											<td>M. Murdock</td>
											<td>04:22</td>
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Download" class="link"><i class="fas fa-download mr-2"></i></a>
										...
										<tr>
											<td>4</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">The Silent Nature</td>
											<td>The Sourcerer</td>
											<td>02:58</td>
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Download" class="link"><i class="fas fa-download mr-2"></i></a>
										...
										<tr>
											<td>5</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">Suger-Salt</td>
											<td>The Pianist</td>
											<td>03:25</td>
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Download" class="link"><i class="fas fa-download mr-2"></i></a>
										...
										<tr>
											<td>6</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">Pathetic Human</td>
										...
										<tr>
											<td>7</td>
											<td><i class="fas fa-heart" aria-hidden="true"></i></td>
											<td class="text-warning">The Nuke Zoned</td>
											<td>Martian Metal</td>
											<td>06:48</td>
											<td class="text-nowrap">
												<a href="#" data-toggle="tooltip" data-original-title="Download" class="link"><i class="fas fa-download mr-2"></i></a>
								...
								<div class="row mt-3">
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
															</a>
														</li>
													</ul>
												</div>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">The Fallen</h5>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/5.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">The Phobia</h5>
												<small class="text-muted">Sourcerer</small>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/6.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">Area 51</h5>
												<small class="text-muted">Sourcerer</small>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/7.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">Pathetic</h5>
												<small class="text-muted">Sourcerer</small>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/8.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">Ding Dong</h5>
												<small class="text-muted">Sourcerer</small>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/9.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
											...
											<div class="text-left">
												<h5 class="card-title text-warning mb-0">Risen Up</h5>
												<small class="text-muted">Sourcerer</small>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/10.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/11.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/12.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/13.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/14.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
									...
									<div class="col-lg-2 col-md-3">
										<div class="video-card-item">
											<div class="video-card-avatar video-overlay-1 mb-1"><img src="<?php echo base_url() ?>uploads/pictures/15.jpg" alt="user" class="img-thumbnail" />
												<div class="video-overlay">
													<ul class="video-info">
														<li><a href="#">
																<i class="fas fa-play fa-1x fa-fw"></i>
