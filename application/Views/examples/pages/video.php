			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Video Example</h4>
								<h6 class="card-subtitle">Use of <code>single video</code> and <code>video playlist</code>.</h6>
							</div>
						</div>
					</section>
					...
					<section class="col-md-12">
						<button onclick="HyperCube.playCubeMedia('<?php echo base_url('/') ?>uploads/video/ed_hd.mp4', '<?php echo base_url('/') ?>uploads/video/covers/cover1.jpg', 'Video Title 1', '');" type="button" class="btn btn-rounded btn-secondary">
							Play Video
						</button>

						<button onclick="HyperCube.playCubeMedia('<?php echo base_url('/') ?>uploads/video/trailer.mp4', '', 'Video Title 1', '');" type="button" class="btn btn-rounded btn-success">
							Play video no poster
						</button>

						<button onclick="HyperCube.playCubeMedia('', '', '', 'aHR0cHM6Ly9oeXBlcmN1YmUuc2kvdXBsb2Fkcy9wbGF5bGlzdHMvdmlkZW9QbGF5bGlzdC5qc29u');" type="button" class="btn btn-rounded btn-info">
							Play video playlist from json file
						</button>
					</section>
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body">
								<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover1.jpg"
								       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
								...
								<h3 class="card-title mt-3">The Asgardian Hammer By Ground Zero</h3>
								<p>
								...
								<div class="row">
									<div class="col-md-8">
										<ul class="list-inline mb-0">
											<li class="list-inline-item"><i class="fas fa-calendar fa-2x text-primary fa-fw mr-2"></i>Oct. 07, 2017</li>
											<li class="list-inline-item"><i class="fas fa-share-alt fa-2x text-primary fa-fw mr-2"></i>Share</li>
											<li class="list-inline-item"><i class="fas fa-thumbs-up fa-2x text-success fa-fw mr-2"></i>4356</li>
											<li class="list-inline-item"><i class="fas fa-thumbs-down fa-2x text-danger fa-fw mr-2"></i>123</li>
										</ul>
									</div>
									<div class="col-md-4 text-right">
										<span class="ml-auto"><i class="fas fa-eye text-success fa-fw mr-2"></i>10,267 views</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover2.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
									...
									<div class="video-card-content text-left">
										<h5 class="card-title text-warning">Pathetic</h5>
										<small class="text-muted">Sourcerer</small>
										<p class="mt-3">Lorem Ipsum is simply dummy text of the printing and fgdfg</p>
									</div>
								</div>
								<div class="video-info mb-0 clearfix">
									<span class="views float-left text-warning"><i class="fas fa-eye mr-2"></i>2.8M views</span>
									<span class="date float-right text-primary"><i class="fas fa-clock mr-2"></i>5 months ago</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover3.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover4.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover5.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover6.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover7.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover8.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<div class="col-lg-3 col-md-6 mb-3">
						<div class="card">
							<div class="card-body m-0 p-1">
								<div class="video-card-item">
									<div class="video-card-avatar video-overlay-1">
										<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover9.jpg">
										<span class="vd-time badge badge-success badge-pill">03:30</span>
										<div class="video-overlay">
											<ul class="video-info">
												<li><a href="<?php echo base_url() ?>pages/videoDetail">
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid"
						       ...
						       poster="<?php echo base_url() ?>uploads/video/covers/cover2.jpg"
						       data-setup='{"fluid": true,"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="https://livestream.peer5.com/video/kite/index.m3u8" type="application/x-mpegURL">
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid"
						       controls preload="auto"
						       crossorigin="anonymous"
						       poster="<?php echo base_url() ?>uploads/video/covers/cover3.jpg"
						       data-setup='{"fluid": true,"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid"
						       controls preload="auto"
						       crossorigin="anonymous"
						       data-setup='{"fluid": true,"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2], "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://www.youtube.com/watch?v=xjS6SftYQaQ"}]}'>
							<!-- Tracks need an ending tag thanks to IE9 -->
							<p class="vjs-no-js">
								To view this video please enable JavaScript, and consider upgrading to a web browser that
								<a href="https://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover4.jpg"
						       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="<?php echo base_url('/') ?>uploads/video/Big_Buck_Bunny.mp4" type="video/mp4" />
							<source src="<?php echo base_url('/') ?>uploads/video/Big_Buck_Bunny.ogv" type="video/ogv" />
							<source src="<?php echo base_url('/') ?>uploads/video/Big_Buck_Bunny.webm" type="video/webm" />
							<p class="vjs-no-js">
								To view this video please enable JavaScript, and consider upgrading to a web browser that
								<a href="https://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
							</p>
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover5.jpg"
						       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="<?php echo base_url('/') ?>uploads/video/sintel.mp4" type="video/mp4" />
					...
					<section class="col-md-4 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid"
						       controls preload="auto"
						       crossorigin="anonymous"
						       data-setup='{"fluid": true,"nativeControlsForTouch": true, "techOrder": ["vimeo"], "sources": [{ "type": "video/vimeo", "src": "https://vimeo.com/12487929"}], "playbackRates": [1, 1.5, 2]}'>
							<!-- Tracks need an ending tag thanks to IE9 -->
							<p class="vjs-no-js">
								To view this video please enable JavaScript, and consider upgrading to a web browser that
								<a href="https://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
					...
					<section class="col-md-6 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover6.jpg"
						       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="<?php echo base_url('/') ?>uploads/video/oceans.mp4" type="video/mp4" />
					...
					<section class="col-md-6 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover7.jpg"
						       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="<?php echo base_url('/') ?>uploads/video/movie.mp4" type="video/mp4" />
					...
					<section class="col-md-12 mb-3">
						<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover9.jpg"
						       data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
							<source src="<?php echo base_url('/') ?>uploads/video/ed_hd.mp4" type="video/mp4" />

							<!-- Tracks need an ending tag thanks to IE9 -->
							<track kind="captions" src="<?php echo base_url('/') ?>uploads/video/captions.en.vtt"
							       srclang="en" label="English" default />
							<track kind="captions" src="<?php echo base_url('/') ?>uploads/video/captions.sv.vtt"
							       srclang="sv" label="Swedish" />
							<track kind="captions" src="<?php echo base_url('/') ?>uploads/video/captions.ru.vtt"
							       srclang="ru" label="Russian" />
							<track kind="captions" src="<?php echo base_url('/') ?>uploads/video/captions.ja.vtt"
							       srclang="ja" label="Japanese" />
							<track kind="captions" src="<?php echo base_url('/') ?>uploads/video/captions.ar.vtt"
							       srclang="ar" label="Arabic" />

							<track kind="descriptions" src="<?php echo base_url('/') ?>uploads/video/descriptions.en.vtt"
							       srclang="en" label="English" />
							<track kind="chapters" src="<?php echo base_url('/') ?>uploads/video/chapters.en.vtt"
							       srclang="en" label="English" />
					...
					<section class="col-md-6 mt-3 mb-3">
						<div class="main-playlist-player">
							<video id="playlist_example_video_1" class="video-js vjs-default-skin vjs-fluid" controls
							       preload="auto" data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
								<!-- Tracks need an ending tag thanks to IE9 -->
								<p class="vjs-no-js">
							...
							<div class="playlist-container">
								<input id="vjs-playlist-handle-3" type="checkbox" class="vjs-playlist-handle" />
								<label for="vjs-playlist-handle-3" class="vjs-playlist-handle-label"></label>
								<div class="vjs-playlist vjs-playlist-1"></div>
							</div>
						</div>
					</section>
					...
					<section class="col-md-6 mt-3 mb-3">
						<div class="main-playlist-player">
							<video id="playlist_example_video_2" class="video-js vjs-default-skin vjs-fluid" controls
							       preload="auto" data-setup='{"nativeControlsForTouch": true, "playbackRates": [1, 1.5, 2]}'>
								<!-- Tracks need an ending tag thanks to IE9 -->
								<p class="vjs-no-js">
									To view this video please enable JavaScript, and consider upgrading to a web browser
							...
							<div class="playlist-container">
								<input id="vjs-playlist-handle-1" type="checkbox" class="vjs-playlist-handle" />
								<label for="vjs-playlist-handle-1" class="vjs-playlist-handle-label"></label>
								<div class="vjs-playlist vjs-playlist-2"></div>
							</div>
						</div>
					</section>
					...
					<script type="text/javascript">
						...
						{
							var player = videojs("playlist_example_video_1");
							player.playlist([
								{
									...
									sources: [
										{
											src: global_base_url + "uploads/video/oceans.mp4",
											type: "video/mp4"
										},
										{
									...
									poster: global_base_url + "/uploads/video/covers/cover1.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover1.jpg",
											type: "image/png"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover1.jpg"
										}
									]
								},
								{
									...
									duration: 45,
									sources: [
										{src: global_base_url + "/uploads/video/sintel.mp4", type: "video/mp4"}
									],

									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover3.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover3.jpg",
											type: "image/png"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover3.jpg"
										}
									]
								}
							]);
							...
							player.playlistUi({
								playOnSelect: true,
								className: "vjs-playlist-1"
							});

							var player1 = videojs("playlist_example_video_2");
							player1.playlist([
								{
									name: "Movie",
									...
									sources: [
										{
											src: global_base_url + "/uploads/video/sintel.mp4",
											type: "video/mp4"
										}
									],

									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover4.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover4.jpg",
											type: "image/jpeg"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover4.jpg"
										}
									]
								},
								{
									...
									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover5.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover5.jpg",
											type: "image/png"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover5.jpg"
										}
									]
								},
								{
									...
									sources: [
										{
											src: global_base_url + "/uploads/video/movie1.mp4",
											type: "video/mp4"
										}
									],
									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover6.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover6.jpg",
											type: "image/png"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover6.jpg"
										}
									]
								},
								{
									...
									sources: [
										{
											src: global_base_url + "/uploads/video/movie.mp4",
											type: "video/mp4"
										}
									],

									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover7.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover7.jpg",
											type: "image/jpeg"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover7.jpg"
										}
									]
								},
								{
									...
									// you can use <picture> syntax to display responsive images
									poster: global_base_url + "/uploads/video/covers/cover8.jpg",
									thumbnail: [
										{
											srcset: global_base_url + "/uploads/video/covers/cover8.jpg",
											type: "image/jpeg"
										},
										{
											src: global_base_url + "/uploads/video/covers/cover8.jpg"
										}
									]
								}
							]);
							...
							player1.playlist.autoadvance(0);

							// Initialize the playlist-ui plugin with no option (i.e. the defaults).
							player1.playlistUi({
								playOnSelect: true,
								className: "vjs-playlist-2"
							});
						});
					</script>
