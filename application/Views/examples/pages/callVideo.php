						...
						<div class="call-window">
							<div class="call-contents">
								<div class="call-content-wrap">
									<div class="call-user-video">
										<img src="<?php echo base_url() ?>uploads/pictures/video-call.jpg" alt="" />
									</div>

									<div class="call-my-video">
										<ul>
											<li>
												<img src="<?php echo base_url() ?>assets/avatars/avatar1.png" class="img-responsive" alt="" />
											</li>
										</ul>
									</div>
								</div>
									...
									<ul class="call-items">
										...
										<li class="call-item">
											<a href="#" title="Full Screen" data-placement="top" data-toggle="tooltip">
												<i class="fas fa-expand full-screen fa-fw" aria-hidden="true"></i>
											</a>
										</li>
									</ul>
									<div class="end-call">
