			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Sample Project Scrumboard</span>
							</div>

							<div class="card-content">
								<div class="card-body">
									<div class="overflow-hidden">
										<div id="todo-lists-basic"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Custom controls</span>
							</div>
							...
							<div class="card-content">
								<div class="card-body">
									<div class="card-text">
										...
										<div class="overflow-hidden">
											<div id="todo-lists-controls" class="lobilists-wrapper"></div>
										</div>
									</div>
								</div>
							</div>
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-header">
								<span class="card-title">Disabled drag & drop</span>
							</div>
							...
							<div class="card-content">
								<div class="card-body">
									<div class="card-text">
										...
										<div class="overflow-hidden">
											<div id="todo-lists-sorting" class="lobilists-wrapper"></div>
										</div>
									</div>
								</div>
							</div>
