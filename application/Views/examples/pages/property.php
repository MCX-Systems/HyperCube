			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<div class="card">
							<div class="card-body">
								<div id="carousel-example-captions" data-ride="carousel" class="carousel slide">
									...
									<div role="listbox" class="carousel-inner">
										<div class="carousel-item active">
											<img src="<?php echo base_url() ?>uploads/pictures/vd5.jpg" alt="First slide image" class="img-fluid" style="min-height: 640px" />
											<div class="carousel-caption">
												<h3 class="text-white">Model Showing off</h3>
												<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
											</div>
										</div>
										<div class="carousel-item">
											<img src="<?php echo base_url() ?>uploads/pictures/vd7.jpg" alt="Second slide image" class="img-fluid" style="min-height: 640px" />
											<div class="carousel-caption">
												<h3 class="text-white">Mountaing Climbing</h3>
												<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
											</div>
										</div>
										<div class="carousel-item">
											<img src="<?php echo base_url() ?>uploads/pictures/vd9.jpg" alt="Third slide image" class="img-fluid" style="min-height: 640px" />
											<div class="carousel-caption">
												<h3 class="text-white">Fire camp on hill</h3>
												<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
											</div>
										</div>
									</div>
								...
								<h4 class="pt-2 text-warning">Florida 5, Pinecrest, FL</h4>
								<h5>
									<span class="text-muted">
										<i class="fas fa-map-marker text-danger mr-1" aria-hidden="true"></i>
								...
								<p class="text-light pt-2">
									...
									fringilla augue. Rorem psum dolor sit amet, consectetur adipiscing elit. Vestibulum
									tincidunt est vitae ultrices accumsan.
									<br /><br />
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est
									vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere.
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est
									vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere lectus et,
									fringilla augue. Rorem psum dolor sit amet, consectetur adipiscing elit. Vestibulum
									tincidunt est vitae ultrices accumsan.
								...
								<div class="row">
									<div class="col-sm-6">
										<h5 class="card-title text-warning">Amenities</h5>
										<hr/>
										<ul class="list-group list text-warning">
									...
									<div class="col-sm-6">
										<h5 class="card-title text-warning">Room Dimensions</h5>
										<hr />
									...
									<div class="col-sm-12">
										...
										<div class="pl-0 pr-0 pb-1">
											<h4 class="card-title pl-2 text-warning">Location</h4>
											<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2738.200369799402!2d16.169126515598016!3d46.662305079133446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1b2ac09a018b7525!2sMCX-Systems!5e0!3m2!1ssl!2ssi!4v1533648544383" width="100%" height="244" frameborder="0" style="border:0" allowfullscreen></iframe>
										</div>
									</div>
								</div>
							</div>
					...
					<section class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="card mb-3">
							<div class="card-body">
								<h5 class="card-title text-warning">Essential Information</h5>
								<hr />
								<div class="table-responsive pt-1">
									<table class="table">
						...
						<div class="card mb-3">
							<div class="card-body">
								<div class="text-center">
									<div class="avatar avatar-round avatar-lg mb-3">
										<img src="<?php echo base_url() ?>assets/Avatars/avatar2.png" class="img-fluid" alt="Avatar Example" />
									</div>
									<h4 class="text-warning">Jon Doe</h4>
									<h6>Agent of Property</h6>
								</div>

								<hr />
								<div class="text-center">
									<i class="fas fa-phone text-danger mr-2" aria-hidden="true"></i>800-1800-24657
									<br> <i class="fas fa-envelope text-danger mr-2 mt-1" aria-hidden="true"></i>jondoe@mcx-systems.com
								</div>

								<hr />
								<div class="pd-agent-inq">
									<h4 class="card-title text-warning">Request Inquiry</h4>
									<form class="form-horizontal">
										...
										<div class="form-group">
											<div class="col-md-12">
												<button type="submit" class="btn btn-danger btn-rounded">Submit Request</button>
											</div>
										</div>
									</form>
								</div>
						...
						<div class="card">
							<div class="card-body">
								<h5 class="card-title text-warning">Community Information</h5>
								<hr />
