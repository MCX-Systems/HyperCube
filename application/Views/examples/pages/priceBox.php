						...
						<div class="card">
							<div class="card-body">
								<div class="row pricing-plan">
									<div class="col-md-3 col-xs-12 col-sm-6 p-0">
										<div class="pricing-box">
											<div class="pricing-body">
												<div class="pricing-header">
													<h4 class="text-center text-warning">Silver</h4>
													<h2 class="text-center"><span class="price-sign">&euro;</span>24</h2>
													<p class="uppercase">per month</p>
												</div>

												<div class="price-table-content">
													<div class="price-row"><i class="fas fa-user mr-2"></i> 3 Members</div>
													<div class="price-row"><i class="fas fa-desktop mr-2"></i> Single Device</div>
													<div class="price-row"><i class="fas fa-hdd mr-2"></i> 50GB Storage</div>
													<div class="price-row"><i class="fas fa-archive mr-2"></i> Monthly Backups</div>
													<div class="price-row">
														<button class="btn btn-success mt-2">Sign up</button>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-3 col-xs-12 col-sm-6 p-0">
										<div class="pricing-box">
											<div class="pricing-body">
												<div class="pricing-header">
													<h4 class="text-center text-warning">Gold</h4>
													<h2 class="text-center"><span class="price-sign">&euro;</span>34</h2>
													<p class="uppercase">per month</p>
												</div>
										...
										<div class="pricing-box featured-plan">
											<div class="pricing-body">
												<div class="pricing-header">
													...
													<h4 class="text-center text-warning text-bold">Platinum</h4>
													<h2 class="text-center"><span class="price-sign">&euro;</span>45</h2>
													<p class="uppercase">per month</p>
												</div>
												...
												<div class="price-table-content">
													...
													<div class="price-row"><i class="fas fa-archive mr-2"></i> Monthly Backups</div>
													<div class="price-row">
														<button class="btn btn-lg btn-danger mt-2">Sign up</button>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-3 col-xs-12 col-sm-6 p-0">
										<div class="pricing-box">
											<div class="pricing-body">
												<div class="pricing-header">
													<h4 class="text-center text-warning">Diamond</h4>
													<h2 class="text-center"><span class="price-sign">&euro;</span>54</h2>
													<p class="uppercase">per month</p>
												</div>
