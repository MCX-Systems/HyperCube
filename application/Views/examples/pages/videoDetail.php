			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-8">
						<div class="card">
							<div class="card-body">
								<video class="video-js vjs-default-skin vjs-fluid" controls preload="auto" poster="<?php echo base_url('/') ?>uploads/video/covers/cover2.jpg"
								       data-setup='{"nativeControlsForTouch": true}'>
									<source src="<?php echo base_url('/') ?>uploads/video/trailer.mp4" type="video/mp4" />
									<p class="vjs-no-js">
					...
					<section class="col-md-4">
						<div class="card">
							<div class="card-body">
								<h5 class="card-title text-success">COMING UP NEXT</h5>
								<div class="row mt-2">
									<div class="col-4 video-card-item">
										<div class="video-card-avatar video-overlay-1">
											<img alt="user" src="<?php echo base_url('/') ?>uploads/video/covers/cover1.jpg">
									...
									<div class="col-8">
										<h5 class="card-title text-warning">Shut up society</h5>
										<span class="text-muted">Oct 07 | 5:06 | M.Murdock</span>
									</div>
								</div>
								<hr />
							</div>
							<div class="card-body">
								<div class="row">
									...
									<div class="col-8">
										<h5 class="card-title mb-2">Shut up society</h5>
										<span class="text-muted">Oct 07 | 5:06 | M.Murdock</span>
									</div>
								</div>
								<hr class="light" />
