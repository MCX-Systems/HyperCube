				...
				<div class="row">
					...
					<section class="col-md-12 mb-2">
						<div class="widget-file-manager">
							<div class="widget-file-manager-container">
								<div class="widget-file-manager-nav">
									<div>
										<a href="#" class="widget-file-manager-upload-btn">
											<i class="fas fa-upload"></i>
										</a>

										<h6 class="widget-file-manager-nav-heading">Main</h6>
										<ul class="widget-file-manager-menu">
											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-file fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Files</a>
											</li>

											<li class="widget-file-manager-item is-active">
												<i class="widget-file-manager-icon fas fa-camera fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Photos</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-share-alt fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Sharing</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-link fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Links</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-calendar-alt fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Events</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-circle fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Get Started</a>
											</li>
										</ul>

										<hr />
										<h6 class="widget-file-manager-nav-heading">Labels
											<a href="#"><i class="fas fa-plus widget-file-manager-nav-add"></i></a>
										</h6>

										<ul class="widget-file-manager-menu">
											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-globe fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Web</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-mobile fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Mobile</a>
											</li>

											<li class="widget-file-manager-item">
												<i class="widget-file-manager-icon fas fa-paint-brush fa-fw"></i>
												<a href="#" class="widget-file-manager-link">Illustration</a>
											</li>
										</ul>
									</div>

									<div class="widget-file-manager-usage">
										<hr />
										<div class="widget-file-manager-usage-desc">
											<span>728 MB / 2 GB</span>
											<a href="#"><i class="fas fa-plus fa-fw widget-file-manager-nav-add"></i></a>
										</div>
								...
								<div class="widget-file-manager-content">
									<div class="widget-file-manager-content-header">
										<div class="widget-file-manager-content-heading">Home</div>
										<div class="widget-file-manager-content-controls">
											<div class="widget-file-manager-content-files-controls">
												<i class="fas fa-file-upload fa-fw widget-file-manager-content-files-control" data-toggle="tooltip" data-placement="top" title="Upload" data-delay="500"></i>
												<i class="fas fa-folder-plus fa-fw widget-file-manager-content-files-control" data-toggle="tooltip" data-placement="top" title="New Folder" data-delay="500"></i>
												<i class="fas fa-copy fa-fw widget-file-manager-content-files-control is-inactive" data-toggle="tooltip" data-placement="top" title="Copy" data-delay="500"></i>
												<i class="fas fa-trash fa-fw widget-file-manager-content-files-control is-inactive" data-toggle="tooltip" data-placement="top" title="Remove" data-delay="500"></i>
											</div>

											<div class="widget-file-manager-content-view-controls">
												<i class="fas fa-th-large fa-fw widget-file-manager-content-view-control is-active" data-view="grid"></i>
												<i class="fas fa-list fa-fw widget-file-manager-content-view-control" data-view="list"></i>
											</div>
										</div>
									</div>

									<div class="widget-file-manager-content-body">
										<div class="widget-file-manager-content-body-files">
											<div class="widget-file-manager-scroll">
												<div class="widget-file-manager-content-files">
													<div class="widget-file-manager-content-file widget-file-manager-content-file-folder">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>assets/icons/folder.png" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Resources</div>
														<div class="widget-file-manager-content-file-upload-time">&nbsp;</div>
													</div>
													...
													<div class="widget-file-manager-content-file widget-file-manager-content-file-folder">
														...
														<div class="widget-file-manager-content-file-name">Export</div>
														<div class="widget-file-manager-content-file-upload-time">&nbsp;</div>
													</div>

													<div class="widget-file-manager-content-file widget-file-manager-content-file-image is-selected">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Habits.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 min ago</div>
													</div>

													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/3.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Launchbox Crew.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>

													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/7.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>

													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/10.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Habits.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 min ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/12.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Launchbox Crew.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/14.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/17.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name" title="Launchbox Crew Long Name.png">Launchbox Crew Long Name.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>

													<div class="widget-file-manager-content-file widget-file-manager-content-file-image">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/13.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>

													<div class="widget-file-manager-content-file">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/17.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
													...
													<div class="widget-file-manager-content-file">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/20.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/21.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/22.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
													...
													<div class="widget-file-manager-content-file">
														<div class="widget-file-manager-content-file-preview">
															<img src="<?php echo base_url() ?>uploads/pictures/24.jpg" alt="" />
														</div>
														<div class="widget-file-manager-content-file-name">Oil Change.png</div>
														<div class="widget-file-manager-content-file-upload-time">1 hour ago</div>
													</div>
										...
										<div class="widget-file-manager-content-info bg-black">
											<div class="widget-file-manager-content-info-preview">
												<img src="<?php echo base_url() ?>uploads/pictures/m4.jpg" alt="" class="widget-file-manager-content-info-preview-image img-thumbnail embed-responsive" />
												<div class="widget-file-manager-content-info-preview-name">Habits.png</div>
											</div>

                                            <hr />
											<table class="widget-file-manager-content-info-table">
												<tr>
													<td class="text-muted">Created</td>
													<td>May 25, 2019 - 09:57</td>
												</tr>
												<tr>
													<td class="text-muted">Modified</td>
													<td>May 25, 2009 - 12:55</td>
												</tr>
												<tr>
