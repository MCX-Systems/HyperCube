						...
						<div class="card">
							<div class="profile-card">
								...
								<div class="profile-controls">
									<a href="#" class="profile-control-left"><span class="fas fa-info"></span></a>
									<a href="#" class="profile-control-right"><span class="fas fa-phone"></span></a>
								</div>
							</div>

							<div class="card-body">
								<address class="contact-info">
									<p><small class="text-warning bold">Mobile:</small><br />(234) 567-89-12</p>
									<p><small class="text-warning bold">Email:</small><br />john@domain.com</p>
									<p><small class="text-warning bold">Address:</small><br />123 45 Street San Francisco, CA, USA</p>
								</address>
							</div>
						</div>
						<!-- END CONTACT ITEM -->
