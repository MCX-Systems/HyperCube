			...
			<section class="breadcrumb-bar col-md-12 animated zoomIn">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">IP-Camera</li>
					</ul>
				</div>
				<!-- ============================================================== -->
			...
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12 mb-3">
						<div class="card">
							<div class="card-body">
								<img src="<?php echo base_url() ?>assets/images/automation/camera.png" alt="User Avatar" class="img-fluid mr-3 float-right" width="100" height="80" />
							</div>
						</div>
					</section>
							...
							<div class="card-body">
								...
								<script type="text/javascript" language="javascript">
									...
									$(function()
									{
										...
										var address = "rtsp://192.168.255.222:554/stream1";
						...
						<div class="card">
							<div class="card-body">
								<video class="video-js vjs-default-skin vjs-fluid"
								       ...
								       poster="<?php echo base_url() ?>uploads/video/vd10.jpg"
								       data-setup='{"fluid": true,"nativeControlsForTouch": true}'>
