		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-lg-3 col-xlg-3 col-md-4">
						<div class="card text-center">
							<div class="card-body text-center p-0">
								<div class="avatar avatar-round mb-3">
									<img src="<?php echo base_url() ?>assets/Avatars/avatar4.png" class="img-fluid" alt="Avatar Example" />
								</div>

								<h4 class="card-title mt-1 text-warning">Davorin Casar</h4>
								<h6 class="card-subtitle">Developer, MCX-Systems&reg; corp</h6>
								<div class="row text-center justify-content-md-center mt-3">
									<div class="col-4"><a href="#" class="btn btn-link"><i class="fas fa-users fa-fw mr-2"></i>254</a></div>
									<div class="col-4"><a href="#" class="btn btn-link"><i class="fas fa-images fa-fw mr-2"></i>54</a></div>
								</div>

                                <hr />
								<small class="text-muted">Email address</small>
								<h6>webmaster@example.com</h6> <small class="text-muted pt-3">Phone</small>
								<h6>+386 111 111 111</h6> <small class="text-muted pt-3">Address</small>
								<h6>Partizanska ulica 34, 900 Murska Sobota</h6>
								<hr />

								<div class="map-box">
									<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2738.200369799402!2d16.169126515598016!3d46.662305079133446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1b2ac09a018b7525!2sMCX-Systems!5e0!3m2!1ssl!2ssi!4v1533648544383" width="100%" height="150" frameborder="0" style="border:0" allowfullscreen></iframe>
								</div>

								<hr />
								<small class="text-muted pt-3">Social Profile</small>
								<br />

								<button class="btn btn-info btn-circle btn-md m-3" type="button">
									<span class="btn-label"><i class="fab fa-microsoft fa-fw"></i></span>
								</button>

								<button class="btn btn-danger btn-circle btn-md m-3" type="button">
									<span class="btn-label"><i class="fab fa-google fa-fw"></i></span>
								</button>

								<button class="btn btn-primary btn-circle btn-md m-3" type="button">
									<span class="btn-label"><i class="fab fa-facebook-f fa-fw"></i></span>
								</button>
							</div>
						</div>
					</section>

					<section class="col-lg-9 col-xlg-9 col-md-8">
						<div class="card">
							<div class="card-body">
								<!-- Nav tabs -->
								<ul class="nav nav-tabs profile-tab" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#biography" role="tab">Biography</a>
									</li>
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#application-settings" role="tab">Application Settings</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#social-integration-settings" role="tab">Social Integration</a>
									</li>
								</ul>
								...
								<div class="tab-content p-0">
									<div class="tab-pane active" id="timeline" role="tabpanel">
										<div class="profile-timeline">
											<div class="profile-item clearfix mb-2">
												<div class="profile-left">
													<div class="avatar avatar-round avatar-sm mr-4 mt-0">
														<img src="<?php echo base_url() ?>assets/Avatars/avatar4.png" class="img-fluid" alt="Avatar Example" />
													</div>
												</div>

												<div class="mt-2">
													<a href="#" class="btn-link">John Doe</a>
													<span class="profile-date">5 minutes ago</span>
													<p>assign a new task <a href="#">Design weblayout</a></p>

													<div class="row">
														<div class="col-lg-3 col-md-6 mb-2 mt-3">
															<img src="<?php echo base_url() ?>uploads/Pictures/2.jpg" class="img-fluid img-thumbnail" alt="" />
														</div>

														<div class="col-lg-3 col-md-6 mb-2 mt-3">
															<img src="<?php echo base_url() ?>uploads/Pictures/3.jpg" class="img-fluid img-thumbnail" alt="" />
														</div>

														<div class="col-lg-3 col-md-6 mb-2 mt-3">
															<img src="<?php echo base_url() ?>uploads/Pictures/4.jpg" class="img-fluid img-thumbnail" alt="" />
														</div>

														<div class="col-lg-3 col-md-6 mb-2 mt-3">
															<img src="<?php echo base_url() ?>uploads/Pictures/5.jpg" class="img-fluid img-thumbnail" alt="" />
														</div>
													</div>
											...
											<div class="profile-item clearfix mb-2">
												<div class="profile-left">
													<div class="avatar avatar-round avatar-sm mr-4">
														<img src="<?php echo base_url() ?>assets/Avatars/avatar4.png" class="img-fluid" alt="Avatar Example" />
													</div>
												</div>
												...
												<div class="mt-2">
													...
													<div class="row">
														<div class="col-md-3 col-xs-12 mb-2 mt-3 p-0 pr-3">
															<img src="<?php echo base_url() ?>uploads/Pictures/2.jpg" class="img-fluid img-thumbnail" alt="" />
														</div>

														<div class="col-md-9 col-xs-12 mb-2 mt-3">
									...
									<div class="tab-pane" id="biography" role="tabpanel">
										<div class="row pt-4 pb-2 pl-5">
											<div class="col-md-3 col-xs-6">
												<strong class="text-warning">Full Name</strong>
												<br />
												<p class="text-muted">John Doe</p>
											</div>

											<div class="col-md-3 col-xs-6">
												<strong class="text-warning">Mobile</strong>
												<br />
											...
											<div class="col-md-3 col-xs-6">
												<strong class="text-warning">Location</strong>
												<br />
										...
										<h4 class="text-warning mt-3">Skill Set</h4>
										<hr />

										<h5 class="mt-3">Wordpress <span class="float-right">80%</span></h5>
										<div class="progress">
										...
										<h5 class="mt-3">HTML 5 <span class="float-right">90%</span></h5>
										<div class="progress">
										...
										<h5 class="mt-3">jQuery <span class="float-right">50%</span></h5>
										<div class="progress">
										...
										<h5 class="mt-3">Photoshop <span class="float-right">70%</span></h5>
										<div class="progress">
									...
									<div class="tab-pane" id="account-settings" role="tabpanel">
										<div class="card-body">
											<div class="container-block m-0 p-0 pb-4">
												<div class="row">
													<div class="col-lg-10">
														<div class="profile-user">
															<div class="profile-user-wrap">
																...
																<div class="profile-user-info">
																	<span class="profile-user-name">Davorin Casar</span>
																	<span class="profile-user-email">casardavorin@gmail.com</span>
																	<a href="#" class="profile-user-change-avatar">Change Avatar</a>
																</div>
															</div>
															<a href="#" class="profile-user-remove-account">Remove Account</a>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="row">
													<div class="col-lg-5">
														<div class="form-group has-danger">
															<label for="profile-fullname" class="text-warning">Full name <span class="text-danger">is required</span></label>
															<input type="text" class="form-control" id="profile-fullname" placeholder="" value="Davorin Casar">
														</div>
													</div>

													<div class="col-lg-5">
														<div class="form-group">
															<label for="profile-email" class="text-warning">E-mail address</label>
															<input type="text" class="form-control" id="profile-email" placeholder="" value="casardavorin@gmail.com">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="container-block">
												<h4 class="container-block-heading">Target</h4>
												<div class="row">
													<div class="col-lg-5">
														<div class="form-group">
															<label for="profile-target" class="text-warning">My target</label>
															<select id="profile-target" class="form-control" data-placeholder="Occupation">
													...
													<div class="col-lg-5">
														<div class="form-group">
															<label for="profile-specialization" class="text-warning">Specialization</label>
															<select id="profile-specialization" class="form-control" data-placeholder="Specialization">
																<option value=""></option>
																<option selected>JavaScript Developer</option>
															</select>
														</div>
													</div>
												</div>
											...
											<div class="container-block">
												<h4 class="container-block-heading">Address details</h4>
												<div class="row">
													<div class="col-lg-10">
														<div class="form-group">
															<label for="profile-address" class="text-warning">Address</label>
															<input type="text" class="form-control" id="profile-address" placeholder="" value="Partizanska Ulica 34">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-5">
														<div class="form-group">
															<label for="profile-zip" class="text-warning">Zip &amp; City</label>
															<input type="text" class="form-control" id="profile-zip" placeholder="" value="9000 Murska Sobota">
														</div>
													</div>

													<div class="col-lg-5">
														<div class="form-group">
															<label for="profile-country" class="text-warning">Country</label>
															<select id="profile-country" class="form-control" data-placeholder="">
																<option value=""></option>
									...
									<!--profile tab-->
									<div class="tab-pane" id="application-settings">
										<div class="row container-block">
											<div class="col-lg-4">
												<h5 class="container-block-heading">System</h5>
												<div class="profile-global-block-desc">
													Configure external fees and email that will be used as default address for notifications.
												</div>

												<div class="profile-global-block-links">
													<a href="#" class="profile-global-block-link">Lorem Ipsum is simply dummy text?</a>
													<a href="#" class="profile-global-block-link">It is a long established fact that?</a>
												</div>
											</div>

											<div class="col-lg-8">
												<form>
													<h6 class="container-block-heading">General Settings</h6>
													<div class="form-group row">
														<label for="notification-email" class="col-sm-4 col-form-label">Notification Email:</label>
														<div class="col-sm-8">
															<div class="input-group">
																...
																<input type="email" class="form-control" id="notification-email" placeholder="" value="settings@example.com" />
															</div>
														</div>
													</div>

													<div class="form-group row">
														<label class="col-sm-4 col-form-label">Commission Charges:</label>
														<div class="col-sm-8">
															<div class="checkbox-fade fade-in-primary">
																<label>
																	...
																	<span>Take into account App commission charges (30%)</span>
																</label>
															</div>
														</div>
													</div>
													...
													<div class="form-group row">
														<label for="tracking-experience" class="col-sm-4 col-form-label">Tracking Experience:</label>
														<div class="col-sm-4">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="email" class="form-control" id="tracking-experience" placeholder="" value="0.00" />
															</div>
														</div>
														<div class="col-sm-4 form-text-inline mt-1">
															per each install
														</div>
													</div>
										...
										<div class="row container-block">
											<div class="col-lg-4">
												<h5 class="container-block-heading">Upload Files</h5>
												<div class="profile-global-block-desc">
													Last updated Aug 12, 2019 12:32 PM
												</div>
											</div>

											<div class="col-lg-8">
												<form action="#" class="dropzone" id="dropzone_file"></form>
											</div>
										...
										<div class="row container-block">
											<div class="col-lg-4">
												<h5 class="container-block-heading">Ads Accounts</h5>
												<div class="profile-global-block-desc">
													Lorem Ipsum is simply dummy text of the printing and typesetting industry.
												</div>

												<div class="profile-global-block-links">
													<a href="#" class="profile-global-block-link">How to enable or disable ads account?</a>
												</div>
											</div>
															...
															<div class="col-sm-9 form-radio">
																<div class="radio radiofill radio-primary radio-inline">
																	<label>
																		...
																		<i class="helper"></i>Bernard Rhodes
																	</label>
																	<div class="text-muted">Added May 20, 2017</div>
																</div>
															</div>
										...
										<div class="row container-block">
											<div class="col-lg-4">
												<h5 class="container-block-heading">Billing</h5>
												<div class="profile-global-block-desc">
													Setup your billing data and payment details.
												</div>
											</div>

											<div class="col-lg-8">
												<form>
													<h6 class="container-block-heading">Billing Information</h6>
													<div class="form-group row">
														<label for="billing-fullname" class="col-sm-2 col-form-label">Full Name:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="text" class="form-control" id="billing-fullname" placeholder="" value="Davorin Casar" />
															</div>
														</div>
													</div>

													<div class="form-group row">
														<label for="billing-phone" class="col-sm-2 col-form-label">Phone:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="text" class="form-control" id="billing-phone" placeholder="" value="+1 (222) 555-555-5555" />
															</div>
														</div>
													</div>

													<div class="form-group row">
														<label for="billing-zipcode" class="col-sm-2 col-form-label">Zip Code:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="text" class="form-control" id="billing-zipcode" placeholder="Enter Zip Code" value="" />
															</div>
														</div>
													</div>
										...
										<div class="row container-block">
											<div class="col-lg-4">
												<h5 class="container-block-heading">Security Settings</h5>
												<div class="profile-global-block-desc">
													Do not use simple password. It must contains at least 6 characters.
												</div>
											</div>

											<div class="col-lg-8">
												<form>
													<h6 class="container-block-heading">Password</h6>
													<div class="form-group row">
														<label for="security-old-password" class="col-sm-4 col-form-label">Old Password:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="password" class="form-control" id="security-old-password" placeholder="Enter password" value="" />
															</div>
														</div>
													</div>

													<div class="form-group row">
														<label for="security-new-password" class="col-sm-4 col-form-label">New Password:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="password" class="form-control" id="security-new-password" placeholder="At least 6 charachers" value="" />
															</div>
														</div>
													</div>

													<div class="form-group row">
														<label for="security-confirm-new-password" class="col-sm-4 col-form-label">Confirm Password:</label>
														<div class="col-sm-6">
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																...
																<input type="password" class="form-control" id="security-confirm-new-password" placeholder="Re-enter the new above" value="" />
															</div>
														</div>
													</div>
									...
									<!--profile tab-->
									<div class="tab-pane" id="social-integration-settings">
										<div class="container-block">
											<h4 class="container-block-heading">Add social integration</h4>
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon fab fa-google-plus fa-fw"></i>
															<div>
																<span class="profile-social-item-name">Google Plus</span>
																<span class="profile-social-item-desc">Google Data Source</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch1" class="on-off-switch-checkbox" id="TestSwitch1" type="checkbox" checked="checked" />
																<label class="on-off-switch-label" for="TestSwitch1">
										...
										<div class="container-block">
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon fab fa-facebook fa-fw"></i>
															<div>
																<span class="profile-social-item-name">Facebook</span>
																<span class="profile-social-item-desc">Social Media Data</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch2" class="on-off-switch-checkbox" id="TestSwitch2" type="checkbox" checked="checked" />
																<label class="on-off-switch-label" for="TestSwitch2">
																	<span class="on-off-switch-inner"></span>
																	<span class="on-off-switch-switch"></span>
																</label>
															</div>
										...
										<div class="container-block">
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon fab fa-twitter fa-fw"></i>
															<div>
																<span class="profile-social-item-name">Twitter</span>
																<span class="profile-social-item-desc">Social Media Data</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch3" class="on-off-switch-checkbox" id="TestSwitch3" type="checkbox" />
																<label class="on-off-switch-label" for="TestSwitch3">
																	<span class="on-off-switch-inner"></span>
																	<span class="on-off-switch-switch"></span>
																</label>
															</div>
										...
										<div class="container-block">
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon fab fa-instagram fa-fw"></i>
															<div>
																<span class="profile-social-item-name">Instagram</span>
																<span class="profile-social-item-desc">Social Media Data</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch4" class="on-off-switch-checkbox" id="TestSwitch4" type="checkbox" checked="checked" />
																<label class="on-off-switch-label" for="TestSwitch4">
																	<span class="on-off-switch-inner"></span>
																	<span class="on-off-switch-switch"></span>
																</label>
															</div>
										...
										<div class="container-block">
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon iconfont fab fa-youtube fa-fw"></i>
															<div>
																<span class="profile-social-item-name">YouTube</span>
																<span class="profile-social-item-desc">Social Media Data</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch5" class="on-off-switch-checkbox" id="TestSwitch5" type="checkbox" checked="checked" />
																<label class="on-off-switch-label" for="TestSwitch5">
																	<span class="on-off-switch-inner"></span>
																	<span class="on-off-switch-switch"></span>
																</label>
															</div>
										...
										<div class="container-block">
											<div class="row">
												<div class="col-lg-11">
													<div class="profile-social-item">
														<div class="profile-social-info">
															<i class="profile-social-icon fab fa-vimeo fa-fw"></i>
															<div>
																<span class="profile-social-item-name">Vimeo</span>
																<span class="profile-social-item-desc">Social Media Data</span>
															</div>
														</div>
														<div class="float-right">
															<div class="on-off-switch switch-lg">
																<input name="TestSwitch6" class="on-off-switch-checkbox" id="TestSwitch6" type="checkbox" />
																<label class="on-off-switch-label" for="TestSwitch6">
																	<span class="on-off-switch-inner"></span>
																	<span class="on-off-switch-switch"></span>
																</label>
															</div>
