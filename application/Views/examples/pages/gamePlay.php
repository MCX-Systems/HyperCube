			...
			<section class="breadcrumb-bar col-md-12">
				<div id="breadcrumb">
					...
					<ul class="breadcrumb float-right align-middle">
						...
						<li class="breadcrumb-item active">Play Flash game</li>
					</ul>
				</div>
				<!-- ============================================================== -->
				...
				<div class="row">
					...
					<section class="col-md-12">
						...
						<script type="text/javascript">
							...
							attributes.id = "FlashGame";
							swfobject.embedSWF(HyperCube.getMediaUrl("game"), "flashGameContent", "100%", $("#main-wrapper-content").innerHeight() - 20, "10.0.0", "<?php echo base_url() ?>assets/javascript/js/core/level-1/swfObject/expressInstall.swf", flashvars, params, attributes);
						</script>
					</section>
