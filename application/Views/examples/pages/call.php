							...
							<div class="call-contents">
								<div class="call-content-wrap">
									<div class="voice-call-avatar">
										<img src="<?php echo base_url() ?>assets/avatars/avatar1.png" alt="Caller Avatar" class="call-avatar" />
										<span class="username">John Doe</span>
										<span class="call-timing-count text-warning">00:59</span>
									</div>
									...
									<div class="call-users">
										<ul>
											<li>
												<a href="#">
													<img src="<?php echo base_url() ?>assets/avatars/avatar4.png" class="img-responsive" alt="">
													<span class="call-mute"><i class="fas fa-microphone-slash" aria-hidden="true"></i></span>
												</a>
											</li>
											<li>
												<a href="#">
													<img src="<?php echo base_url() ?>assets/avatars/avatar5.png" class="img-responsive" alt="">
													<span class="call-mute"><i class="fas fa-microphone-slash" aria-hidden="true"></i></span>
												</a>
											</li>
											<li>
												<a href="#">
													<img src="<?php echo base_url() ?>assets/avatars/avatar6.png" class="img-responsive" alt="">
													<span class="call-mute"><i class="fas fa-microphone-slash" aria-hidden="true"></i></span>
												</a>
											</li>
										</ul>
									...
									<ul class="call-items">
										<li class="call-item">
											<a href="#" title="Enable Video" data-placement="top" data-toggle="tooltip">
												<i class="fas fa-video camera fa-fw" aria-hidden="true"></i>
											</a>
										</li>
										<li class="call-item">
											<a href="#" title="Mute" data-placement="top" data-toggle="tooltip">
												<i class="fas fa-microphone microphone fa-fw" aria-hidden="true"></i>
											</a>
										</li>
										<li class="call-item">
