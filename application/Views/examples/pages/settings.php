		...
		<div class="main-scroller">
			<div class="main-content-box">
				<div class="row">
					...
					<section class="col-md-12">
						<div class="card">
							<div class="card-body p-0 pl-3 pt-1">
								<div class="row">
									<section class="col-md-2 p-0 m-0">
										<div id="slide-menu">
											<ul class="nav nav-tabs" role="tablist">
												<li>
													<div class="slide-menu-item-header">
														<i class="fas fa-cogs mr-3"></i>Site Settings
													</div>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-0" role="tab">
														<i class="fas fa-cog fa-fw mr-3"></i>Settings
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-1" role="tab">
														<i class="fas fa-mail-bulk fa-fw mr-3"></i>Email Settings
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-2" role="tab">
														<i class="fas fa-certificate fa-fw mr-3"></i>Certificates
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-3" role="tab">
														<i class="fas fa-database fa-fw mr-3"></i>Database
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-4" role="tab">
														<i class="fas fa-language fa-fw mr-3"></i>Languages
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-5" role="tab">
														<i class="fas fa-images fa-fw mr-3"></i>Images
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-6" role="tab">
														<i class="fas fa-music fa-fw mr-3"></i>Audio
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-7" role="tab">
														<i class="fas fa-video fa-fw mr-3"></i>Video
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-8" role="tab">
														<i class="fas fa-gamepad fa-fw mr-3"></i>Games
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-9" role="tab">
														<i class="fas fa-plug fa-fw mr-3"></i>Plugins
													</a>
												</li>
												<li>
													<div class="slide-menu-item-header">
														<i class="fas fa-box fa-fw mr-3"></i>Site Content
													</div>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-10" role="tab">
														<i class="fas fa-newspaper fa-fw mr-3"></i>News
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-11" role="tab">
														<i class="fas fa-vote-yea fa-fw mr-3"></i>Polls
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-12" role="tab">
														<i class="fas fa-rss fa-fw mr-3"></i>Rss
													</a>
												</li>
												<li>
													<div class="slide-menu-item-header">
														<i class="fas fa-box fa-fw mr-3"></i>Templates
													</div>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-13" role="tab">
														<i class="fas fa-file fa-fw mr-3"></i>Static Templates
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-14" role="tab">
														<i class="fas fa-file fa-fw mr-3"></i>Email Templates
													</a>
												</li>
												<li>
													<div class="slide-menu-item-header">
														<i class="fas fa-id-card fa-fw mr-3"></i>Accounts
													</div>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-15" role="tab">
														<i class="fas fa-user fa-fw mr-3"></i>Users
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-16" role="tab">
														<i class="fas fa-users fa-fw mr-3"></i>Roles & Permissions
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-17" role="tab">
														<i class="fas fa-share-alt-square fa-fw mr-3"></i>Social Network
													</a>
												</li>
												<li>
													<div class="slide-menu-item-header">
														<i class="fas fa-cubes fa-fw mr-3"></i>Tools
													</div>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-18" role="tab">
														<i class="fas fa-pastafarianism fa-fw mr-3"></i>Antivirus
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-19" role="tab">
														<i class="fas fa-broom fa-fw mr-3"></i>Clean
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-20" role="tab">
														<i class="fas fa-atlas fa-fw mr-3"></i>Logs
													</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a data-toggle="tab" href="#setting-tab-21" role="tab">
														<i class="fas fa-building fa-fw mr-3"></i>Company
													</a>
												</li>
											</ul>
										</div>
									...
									<section class="col-md-10 p-0 m-0 border-left border-left-warning tab-content">
										<!----------------------------------------------------------------------------->

										<div class="tab-pane active p-2 pr-4">
											<div class="row">
												<div class="col-md-12">
													<h3 class="mb-0 text-warning">Site Settings</h3>
													<hr />
												</div>
													...
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-cog fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Settings</h3>
																	<h6 class="text-muted mb-0">Manage Site Settings</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-certificate fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Certificates</h3>
																	<h6 class="text-muted mb-0">Manage site certificate</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-database fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Database</h3>
																	<h6 class="text-muted mb-0">Manage MYSQL Database</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-language fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Languages</h3>
																	<h6 class="text-muted mb-0">Manage site language</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-images fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Images</h3>
																	<h6 class="text-muted mb-0">Image and thumbnail settings</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-music fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Audio</h3>
																	<h6 class="text-muted mb-0">Manage audio player</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-video fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Video</h3>
																	<h6 class="text-muted mb-0">Manage video player</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-gamepad fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Games</h3>
																	<h6 class="text-muted mb-0">Manage games</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-plug fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Plugins</h3>
																	<h6 class="text-muted mb-0">Manage loaded plugins</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-md-12">
													<h3 class="mb-0 text-warning">Site Content</h3>
													<hr />
												</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-newspaper fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">News</h3>
																	<h6 class="text-muted mb-0">News output settings</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-vote-yea fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Polls</h3>
																	<h6 class="text-muted mb-0">Create and edit polls on website</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-rss fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Rss</h3>
																	<h6 class="text-muted mb-0">Configure RSS News Feed</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-md-12">
													<h3 class="mb-0 text-warning">Site Templates</h3>
													<hr />
												</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-file fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Static templates</h3>
																	<h6 class="text-muted mb-0">Create and edit pages that have a permanent address</h6>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																...
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Email Template</h3>
																	<h6 class="text-muted mb-0">Create and edit pages that have a permanent address</h6>
																</div>
															</div>
														</div>
												...
												<div class="col-md-12">
													<h3 class="mb-0 text-warning">Site Accounts</h3>
													<hr />
												</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-user fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Users</h3>
																	<h6 class="text-muted mb-0">Add, edit and delete users.</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-users fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">User Groups</h3>
																	<h6 class="text-muted mb-0">Add, edit and delete User Groups.</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-share-alt-square fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Social</h3>
																	<h6 class="text-muted mb-0">Manage social sharing</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-md-12">
													<h3 class="mb-0 text-warning">Site Tools</h3>
													<hr />
												</div>
												...
												<div class="col-lg-4 col-md-6">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-pastafarianism fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Antivirus</h3>
																	<h6 class="text-muted mb-0">Check website for viruses</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-broom fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Clean</h3>
																	<h6 class="text-muted mb-0">Clean website</h6>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-4 col-md-6 mb-3">
													<div class="card">
														<div class="card-body">
															<div class="d-flex flex-row">
																<div class="mr-3 mt-1">
																	<i class="fas fa-atlas fa-fw fa-3x text-danger"></i>
																</div>
																<div class="ml-1">
																	<h3 class="mb-0 text-warning">Logs</h3>
																	<h6 class="text-muted mb-0">Site logs</h6>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-0" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-cog fa-fw text-danger mr-2"></i>Settings
											</h4>
											<hr />

											<form class="form">
												<h3 class="container-block-heading mt-2">Localization</h3>
												<div class="container-block">
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="website-name" class="text-warning ml-1">Website Name</label>
																<input id="website-name" name="website_name" class="form-control" value="HyperCube" type="text" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>

														<div class="col-sm-6">
															<div class="form-group">
																<label for="default-language" class="text-warning ml-1">Default Language</label>
																...
																<small class="form-text text-muted">Default language used when you create a new user, To change your language, visit your
																	<a href="#" class="color-info">personal settings</a>.
																</small>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="site-timezone" class="text-warning ml-1">Timezone</label>
																<select name="site_timezone" id="site-timezone" class="form-control">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<label for="date-format" class="text-warning ml-1">Date Format</label>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="currency-code" class="text-warning ml-1">Currency Code</label>
																<select name="currency_code" id="currency-code" class="form-control">
																	<option>POUND</option>
																	<option>EURO</option>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<label for="currency-symbol" class="text-warning ml-1">Currency Symbol</label>
																<input id="currency-symbol" name="currency_symbol" class="form-control" readonly value="€" type="text" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
													</div>
												...
												<h3 class="container-block-heading mt-2">Notifications</h3>
												<div class="container-block">
													<div class="row">
														<div class="col-md-12">
															<div class="card">
																<ul class="list-group">
																	<li class="list-group-item">
																		...
																		<div class="float-right">
																			<div class="on-off-switch mt-1">
																				<input name="TestSwitch20" class="on-off-switch-checkbox" id="TestSwitch20" type="checkbox"
																				       checked="checked" />
																				<label class="on-off-switch-label" for="TestSwitch20">
																	...
																	<li class="list-group-item">
																		<span class="text-warning">Holidays</span>
																		<div class="float-right">
																			<div class="on-off-switch mt-1">
																				<input name="TestSwitch20" class="on-off-switch-checkbox" id="TestSwitch20" type="checkbox" />
																				<label class="on-off-switch-label" for="TestSwitch20">
																	...
																	<li class="list-group-item">
																		<span class="text-warning">Leave Request</span>
																		<div class="float-right">
																			<div class="on-off-switch mt-1">
																				<input name="TestSwitch20" class="on-off-switch-checkbox" id="TestSwitch20" type="checkbox"
																				       checked="checked" />
												...
												<h3 class="container-block-heading mt-2">Privacy</h3>
												<div class="container-block">
													<div class="form-group row">
														<label for="account-file-sharing" class="col-sm-2 col-form-label">File Sharing</label>
														<div class="col-sm-10">
															<div class="row">
																<div class="col-lg-6">
																	<select name="account_language" id="account-file-sharing" class="form-control">
																		<option value="es">Everything is sharing</option>
																	</select>
																</div>
															</div>
															...
															<div class="mt-3">
																<div class="checkbox-zoom zoom-info">
																	<label>
																		...
																		<span class="cr">
                                                                           <i class="cr-icon fas fa-check text-info"></i>
                                                                        </span>
																		<span>Bcc emails can be automatically attached to leads of other users if no leads were found for the sending the email.</span>
																	</label>
																</div>
															</div>
															...
															<div class="form-group mt-3">
																<div class="input-control">
																	<label>
																		<select name="advanced_settings" class="form-control">
																			<option value="es">Get more advanced privacy settings</option>
																		</select>
																	</label>
																	<a href="#" class="ml-2"><i class="fas fa-plus-circle fa-2x fa-fw"></i></a>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<label for="account-file-sharing" class="col-sm-2 col-form-label">Client folders sharing</label>
														<div class="col-sm-10">
															<div class="form-group row">
																<div class="col-lg-6">
																	<label>
																		<select id="account-client-sharing" name="account_client_sharing" class="form-control">
																			<option value="es">Client Folders are shared between all users</option>
																		</select>
																	</label>
																</div>
															</div>
															...
															<div class="form-group mt-3">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		<input type="checkbox" value="" />
																		<span class="cr">
                                                                           <i class="cr-icon fas fa-check text-primary"></i>
                                                                        </span>
																		<span>Hide users directory</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
															...
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Allow app support team to access this account for a better customer support experience.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
												...
												<h3 class="container-block-heading mt-2">Lead and prospecting list assignment</h3>
												<div class="container-block">
													<div class="form-group row">
														<label for="account-file-sharing" class="col-sm-2 col-form-label">&nbsp;</label>
														<div class="col-sm-8">
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Only admins can assign unassigned leads.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Only admins can reassign or prospecting list.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
												...
												<h3 class="container-block-heading mt-2">Other</h3>
												<div class="container-block">
													<div class="form-group row">
														<label for="account-file-sharing" class="col-sm-2 col-form-label">&nbsp;</label>
														<div class="col-sm-8">
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>When a leads status changes to WON, automatically move it the last step.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Prevent BCC emails from being automatically attached to closed (won, lost, canceled) leads.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Automatically add missing default fields when creating a lead from an email or a business card.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
															<div class="form-group">
																<div class="checkbox-zoom zoom-primary">
																	<label>
																		...
																		<span>Remove the cents on the leads amounts.</span>
																	</label>
																</div>
																<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
															</div>
												...
												<div class="row">
													<div class="col-sm-12 mt-2">
														<button type="button" class="btn btn-primary btn-md float-right">Save &amp; Update</button>
													</div>
												</div>
											</form>
										</div>
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-1" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-mail-bulk fa-fw text-danger mr-2"></i>Email Settings
											</h4>
											<hr />

											<form class="form">
												<h3 class="container-block-heading mt-2">SMTP Email Settings</h3>
												<div class="container-block p-0 m-0">
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-host" class="text-warning ml-1">SMTP HOST</label>
																<input id="smtp-host" name="smtp_host" class="form-control" type="text" placeholder="mail.mcx-systems.net" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-port" class="text-warning ml-1">SMTP PORT</label>
																<input id="smtp-port" name="smtp_port" class="form-control" type="number" value="25" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-security" class="text-warning ml-1">SMTP Security</label>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-domain" class="text-warning ml-1">SMTP Authentication Domain</label>
																<input id="smtp-domain" name="smtp_domain" class="form-control" type="text" placeholder="mcx-systems.net" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-user" class="text-warning ml-1">SMTP User</label>
																<input id="smtp-user" name="smtp_user" class="form-control" type="text" placeholder="SMTP User" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<label for="smtp-password" class="text-warning ml-1">SMTP Password</label>
																<input id="smtp-password" name="smtp_password" class="form-control" type="password" placeholder="SMTP Password" />
																<small class="form-text text-muted">The timezone is important for reminders and calendar synchronization.</small>
															</div>
														</div>
													</div>
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-2" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-certificate fa-fw text-danger mr-2"></i>Certificates
											</h4>
											<hr />
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-3" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-database fa-fw text-danger mr-2"></i>Database
											</h4>
											<hr />
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-4" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-database fa-fw text-danger mr-2"></i>Languages
											</h4>
											<hr />
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-16" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-users fa-fw text-danger mr-2"></i>Roles and Permissions</h4>
											<hr />

											<div class="row">
												<div class="col-sm-3">
													<a href="#" class="btn btn-info btn-block">
														<i class="fas fa-plus mr-2"></i>Add Roles
													</a>
												</div>
												...
												<div class="col-sm-9">
													<div class="card">
														<div class="card-body">
															<h5 class="card-title text-warning mb-2">Module Access</h5>
															<ul class="list-group">
																<li class="list-group-item">
																	Employee
																	<div class="float-right">
																		<div class="on-off-switch mt-1">
																			<input name="TestSwitch10" class="on-off-switch-checkbox" id="TestSwitch10" type="checkbox"
																			       checked="checked" />
																			<label class="on-off-switch-label" for="TestSwitch10">
																				<span class="on-off-switch-inner"></span>
																				<span class="on-off-switch-switch"></span>
																			</label>
																		</div>
																...
																<li class="list-group-item">
																	...
																	<div class="float-right">
																		<div class="on-off-switch mt-1">
																			<input name="TestSwitch11" class="on-off-switch-checkbox" id="TestSwitch11" type="checkbox"
																			       checked="checked" />
																			<label class="on-off-switch-label" for="TestSwitch11">
																				<span class="on-off-switch-inner"></span>
																				<span class="on-off-switch-switch"></span>
																			</label>
																		</div>
																...
																<li class="list-group-item">
																	...
																	<div class="float-right">
																		<div class="on-off-switch mt-1">
																			<input name="TestSwitch12" class="on-off-switch-checkbox" id="TestSwitch12" type="checkbox" />
																			<label class="on-off-switch-label" for="TestSwitch12">
																				<span class="on-off-switch-inner"></span>
																				<span class="on-off-switch-switch"></span>
																			</label>
																		</div>
																...
																<li class="list-group-item">
																	...
																	<div class="float-right">
																		<div class="on-off-switch mt-1">
																			<input name="TestSwitch13" class="on-off-switch-checkbox" id="TestSwitch13" type="checkbox" />
																			<label class="on-off-switch-label" for="TestSwitch13">
																				<span class="on-off-switch-inner"></span>
																				<span class="on-off-switch-switch"></span>
																			</label>
																		</div>
																...
																<li class="list-group-item">
																	...
																	<div class="float-right">
																		<div class="on-off-switch mt-1">
																			<input name="TestSwitch14" class="on-off-switch-checkbox" id="TestSwitch14" type="checkbox" />
																			<label class="on-off-switch-label" for="TestSwitch14">
																				<span class="on-off-switch-inner"></span>
																				<span class="on-off-switch-switch"></span>
																			</label>
																		</div>
															...
															<div class="table-responsive">
																<table class="table table-striped custom-table">
																	<thead>
																	<tr>
																		<th class="text-warning">Module Permission</th>
																		<th class="text-center text-warning">Read</th>
																		<th class="text-center text-warning">Write</th>
																		<th class="text-center text-warning">Create</th>
																		<th class="text-center text-warning">Delete</th>
																		<th class="text-center text-warning">Import</th>
																		<th class="text-center text-warning">Export</th>
																	</tr>
																	</thead>
																	<tbody>
																	<tr>
																		<td class="text-warning">Employee</td>
																		<td class="text-center pb-0">
																			<div class="checkbox-zoom zoom-success pt-1">
																				<label>
																					<input type="checkbox" value="" checked />
																					<span class="cr">
                                                                                        <i class="cr-icon fas fa-check text-success"></i>
																					</span>
																				</label>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="text-warning">Holidays</td>
																		<td class="text-center pb-0">
																			<div class="checkbox-zoom zoom-danger pt-1">
																				<label>
																					<input type="checkbox" value="" />
																					<span class="cr">
                                                                                        <i class="cr-icon fas fa-check text-danger"></i>
																					</span>
																				</label>
																			</div>
																		</td>
																	...
																	<tr>
																		<td class="text-warning">Leave Request</td>
																		<td class="text-center pb-0">
																			<div class="checkbox-zoom zoom-info pt-1">
																				<label>
																					<input type="checkbox" value="" />
																					<span class="cr">
                                                                                        <i class="cr-icon fas fa-check text-info"></i>
																	...
																	<tr>
																		<td class="text-warning">Events</td>
																		<td class="text-center pb-0">
																			<div class="checkbox-zoom zoom-info pt-1">
																				<label>
																					<input type="checkbox" value="" checked />
										...
										<div class="tab-pane p-2 pr-4" id="setting-tab-21" role="tabpanel">
											<h4 class="text-warning">
												<i class="fas fa-building fa-fw text-danger mr-2"></i>Company
											</h4>
											<hr />
											...
											<form class="form">
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-name" class="text-warning ml-1">Company Name <span class="text-danger">*</span></label>
															<input id="company-name" name="company_name" class="form-control" type="text" value="MCX-Systems" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-contact" class="text-warning ml-1">Contact Person</label>
															<input id="company-contact" name="company_contact" class="form-control" value="Davorin Casar" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group">
															<label for="company-address" class="text-warning ml-1">Address</label>
															<input id="company-address" name="company_address" class="form-control" value="Partizanska 34, 9000 Murska Sobota, Slovenija" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6 col-md-6 col-lg-3">
														<div class="form-group">
															<label for="company-country" class="text-warning ml-1">Country</label>
															<select id="company-country" name="company_country" class="form-control">
																<option value="">Choose a Language</option>
													...
													<div class="col-sm-6 col-md-6 col-lg-3">
														<div class="form-group">
															<label for="company-city" class="text-warning ml-1">City</label>
															<input id="company-city" name="company_city" class="form-control" value="Murska Sobota" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6 col-md-6 col-lg-3">
														<div class="form-group">
															<label for="company-state" class="text-warning ml-1">State/Province</label>
															<select id="company-state" name="company_state" class="form-control">
																<option selected>Prekmurje</option>
															</select>
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6 col-md-6 col-lg-3">
														<div class="form-group">
															<label for="company-postal" class="text-warning ml-1">Postal Code</label>
															<input id="company-postal" name="company_postal" class="form-control" value="9000" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-email" class="text-warning ml-1">Email</label>
															<input id="company-email" name="company_email" class="form-control" value="casardavorin@gmail.com" type="email" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-phone" class="text-warning ml-1">Phone Number</label>
															<input id="company-phone" name="company_phone" class="form-control" value="000-000-000" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-mobile" class="text-warning ml-1">Mobile Number</label>
															<input id="company-mobile" name="company_mobile" class="form-control" value="051-260-360" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group">
															<label for="company-fax" class="text-warning ml-1">Fax</label>
															<input id="company-fax" name="company_fax" class="form-control" value="000-000-0000" type="text">
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group">
															<label for="company-site" class="text-warning ml-1">Website Url</label>
															<input id="company-site" name="company_site" class="form-control" value="https://www.mcx-systems.com" type="text" />
															<small class="form-text text-muted">Only avalilable if privacy mode is set to: Only admins can see others leads.</small>
														</div>
													</div>
												</div>
...
<!-- ============================================================== -->
<aside id="right" class="d-none d-sm-none d-md-block d-lg-block d-xl-block">
	<!-- Right-Sidebar Hidden Section -->
	<article class="sidebar-right-inner-player-controls collapse">
		<section class="row sidebar-right-top">
			<div class="col-md-12 slim-scroll-sidebarR">
				<div class="sidebar-right-middle ml-2 mr-2">
					<!-- Right-Sidebar Header -->
					<div class="sidebar-title mb-2">
                            <span>
                                <i class="fas fa-video fa-lg mr-2 ml-1 mt-2"></i>
                                <b class="playerWheelMediaTitle text-warning mb-2"></b>
                            </span>
					</div>
					<!-- Right-Sidebar Item -->
					<div class="sidebar-settings-item">
						...
						<div id="videoControls" class="row">
							<div class="col-md-2">
								<button id="videoMute" type="button" class="btn btn-dark btn-sm mb-1">
							...
							<div class="col-md-2">
								<button id="videoSubs" type="button" class="btn btn-info btn-sm mb-1" disabled>
		...
		<section class="row sidebar-right-bottom-player-control">
			<div class="col-md-12">
				<!-- Start Nav Structure -->
				<div id="playerWheelControls"></div>
				...
				<div class="sidebar-right-middle">
					...
					<div class="sidebar-title">
						<h3>
							...
							<b class="text-warning" data-i18next="nav.category.main">Settings</b>
						</h3>
						<small>Quick access to some controls.</small>
					</div>
					<hr />
					<!-- Right-Sidebar Item -->
					<div class="sidebar-settings-item">
					...
					<!-- Right-Sidebar Item -->
					<div class="sidebar-settings-item mt-2">
					...
					<div class="sidebar-settings-item mt-2">
						...
						<div class="sidebar-switch">
							<div class="on-off-switch">
								<input name="Setting7" class="on-off-switch-checkbox" id="Setting7" type="checkbox" />
								<label class="on-off-switch-label" for="Setting7">
									<span class="on-off-switch-inner"></span>
									<span class="on-off-switch-switch"></span>
								</label>
							</div>
					...
					<div class="sidebar-right-content">
						...
						<div class="well lorem-two small"></div>
					</div>
				</div>
			</div>
		</section>
