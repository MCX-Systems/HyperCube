					...
					<section class="col-md-9">
						<div class="card mb-3">
							<div class="card-body">
								...
								<div class="post-info">
									<h4 class="post-title">
										<a href="<?php echo base_url() ?>examples/postDetail">Bootstrap Carousel Blog Post</a>
									</h4>

									<div class="post-by">
										Posted By <a href="#">admin</a>
										<span class="divider">|</span> 10 June 2015
									...
									<div class="post-image">
										<img src="<?php echo base_url() ?>uploads/pictures/slider-1-cover.jpg" alt="" />
									</div>
									<!-- end post-image -->
									...
									<!-- begin post-image -->
									<div class="post-image">
										<img src="<?php echo base_url() ?>uploads/pictures/slider-2-cover.jpg" alt="" />
									</div>
									<!-- end post-image -->
									...
									<!-- begin post-image -->
									<div class="post-image">
										<img src="<?php echo base_url() ?>uploads/pictures/slider-3-cover.jpg" alt="" />
									</div>
									<!-- end post-image -->
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<ul class="list list-icons">
												...
												<li>
													<i class="fas fa-check text-success"></i>
													<b class="text-warning">Furniture furnished or on strangers</b>
												</li>
												<li>
													<i class="fas fa-check text-success"></i>
						...
						<div class="card mb-3">
							<div class="card-header">
							   <span class="card-title">All Comments (3)</span>
							</div>
										...
										<div class="comment-container">
											<div class="comment-author">
												...
												<span class="comment-date">on
													<span class="underline">June 6, 2015</span> at
													<span class="underline">6:17 pm</span>
                                                </span>
											</div>
											...
											<div class="comment-rating">
												Like or Dislike:
												<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-up text-success"></i> 154</a>
												<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-down text-danger"></i> 112</a>
											</div>
												...
												<li>
													...
													<div class="comment-container">
														<div class="comment-author">
															...
															<span class="comment-date">on
																<span class="underline">June 6, 2015</span> at
																<span class="underline">8:17 pm</span>
                                                            </span>
														</div>
														...
														<div class="comment-rating">
															Like or Dislike:
															<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-up text-success"></i> 5</a>
															<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-down text-danger"></i> 0</a>
														</div>
													</div>
									...
									<li>
										...
										<div class="comment-container">
											<div class="comment-author">
												...
												<span class="comment-date">on
													<span class="underline">June 6, 2015</span> at
													<span class="underline">11:23 pm</span>
                                                </span>
											</div>
											...
											<div class="comment-rating">
												Like or Dislike:
												<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-up text-success"></i> 2</a>
												<a href="#" class="ml-1 text-inverse"><i class="fas fa-thumbs-down text-danger"></i> 0</a>
											</div>
										</div>
										<!-- end comment-container -->
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form class="form-horizontal" action="" method="POST">
									...
									<div class="form-group">
										<label class="control-label col-md-2">Comment <span class="text-danger">*</span></label>
										<div class="col-md-10">
											<label>
												<textarea class="form-control" rows="10" cols="60"></textarea>
											</label>
										</div>
									</div>
									<div class="form-group">
						...
						<div class="card mb-3 bg-black">
							...
							<div class="card-body">
								<ul class="sidebar-post-list">
									...
									<li>
										<a href="#">
											<span class="text-muted float-right">26</span>
									...
									<li>
										<a href="#">
											<span class="text-muted float-right">97</span>
							...
							<div class="card-body">
								<ul class="list-inline list-inline-condensed mb-0">
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-primary badge-striped">Audio</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-danger badge-striped">Gallery</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-success badge-striped">Image</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-primary badge-striped">Music</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-info badge-striped">Blog</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-danger badge-striped">Learn</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-primary badge-striped">Youtube</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-success badge-striped">Twitter</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-secondary badge-striped">Eugene</span>
										</a>
									</li>
									<li class="list-inline-item p-2">
										<a href="#">
											<span class="badge badge-border-left-info badge-striped">MCX-Systems</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="card mb-3 bg-black">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/1.jpg" alt="" class="img-thumbnail mb-3" />
										</a>

										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/4.jpg" alt="" class="img-thumbnail mb-3" />
										</a>

										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/8.jpg" alt="" class="img-thumbnail mb-3" />
										</a>
									</div>
									<div class="col-md-6">
										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/12.jpg" alt="" class="img-thumbnail mb-3" />
										</a>

										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/14.jpg" alt="" class="img-thumbnail mb-3" />
										</a>

										<a href="#">
											<img src="<?php echo base_url() ?>uploads/pictures/16.jpg" alt="" class="img-thumbnail mb-3" />
										</a>
									</div>
								</div>
							</div>
